...
function(t, e) {
    ...
    j.d = (t, e) => {
        for (var i in e)
            j.o(e, i) && !j.o(t, i) && Object.defineProperty(t, i, {
                enumerable: !0,
                get: e[i]
            })
    }
    ...
    (d = v || (v = {})).SVG_NS = "http://www.w3.org/2000/svg",
    d.product = "Highcharts",
    d.version = "12.5.0",
    d.win = "u" > typeof window ? window : {},
    d.doc = d.win.document,
    d.svg = !!d.doc?.createElementNS?.(d.SVG_NS, "svg")?.createSVGRect,
    d.pageLang = d.doc?.documentElement?.closest("[lang]")?.lang,
    d.userAgent = d.win.navigator?.userAgent || "",
    d.isChrome = d.win.chrome,
    ...
    d.supportsPassiveEvents = function() {
        ...
        if (!d.isMS) {
            ...
            d.win.addEventListener && d.win.removeEventListener && (d.win.addEventListener("testPassive", d.noop, e),
 ...
 - ${i}: ${e}`,
    ...
    function tf(t, e, i, s) {
        if (i = i || {},
        _?.createEvent && (t.dispatchEvent || t.fireEvent && t !== V)) {
    ...
    let tm = (a = Math.random().toString(36).substring(2, 9) + "-",
    n = 0,
    function() {
    ...
    Z.jQuery && (Z.jQuery.fn.highcharts = function() {
        ...
        if (this[0])
            return t[0] ? (new V[J(t[0]) ? t.shift() : "Chart"](this[0],t[0],t[1]),
            this) : $[tr(this[0], "data-highcharts-chart")]
    }
    );
    let tx = {
        ...
        getNestedProperty: function(t, e) {
            ...
            for (; i.length && to(e); ) {
                ...
                if ("this" === t) {
                    let t;
                    return tt(e) && (t = e["@this"]),
                    t ?? e
                }
                let s = e[t.replace(/[\\'"]/g, "")];
                if (!to(s) || "function" == typeof s || "number" == typeof s.nodeType || s === Z)
                    return;
                e = s
            }
            return e
      ...
      , {pageLang: ty, win: tb} = V
      , {defined: tv, error: tk, extend: tM, isNumber: tw, isObject: tS, isString: tA, merge: tT, objectEach: tC, pad: tP, splat: tO, timeUnits: tE, ucfirst: tL} = tx
      , tB = V.isSafari && tb.Intl && !tb.Intl.DateTimeFormat.prototype.formatRange
      , tD = class {
        constructor(t, e) {
            this.options = {
                timezone: "UTC"
        ...
        update(t={}) {
            this.dTLCache = {},
            this.options = t = tT(!0, this.options, t);
        ...
        dateTimeFormat(t, e, i=this.options.locale || ty) {
            ...
            if (!o) {
                ...
                try {
                    ...
                    /Invalid time zone/i.test(e.message) ? (tk(34),
                    t.timeZone = "UTC",
                    o = new Intl.DateTimeFormat(i,t)) : tk(e.message, !1)
                }
            }
      ...
      , {defined: tI, extend: tz, timeUnits: tR} = tx
      , tN = class extends tD {
        getTimeTicks(t, e, i, s) {
            let o = this, r = [], a = {}, {count: n=1, unitRange: h} = t, [l,d,c,p,u,g] = o.toParts(e), f = (e || 0) % 1e3, m;
            if (s ?? (s = 1),
            tI(e)) {
                if (f = h >= tR.second ? 0 : n * Math.floor(f / n),
                h >= tR.second && (g = h >= tR.minute ? 0 : n * Math.floor(g / n)),
                h >= tR.minute && (u = h >= tR.hour ? 0 : n * Math.floor(u / n)),
                h >= tR.hour && (p = h >= tR.day ? 0 : n * Math.floor(p / n)),
                h >= tR.day && (c = h >= tR.month ? 1 : Math.max(1, n * Math.floor(c / n))),
                ...
                e = o.makeTime(l, d, c, p, u, g, f),
                o.variableTimezone && tI(i) && (m = i - e > 4 * tR.month || o.getTimezoneOffset(e) !== o.getTimezoneOffset(i));
                let t = e
                  , x = 1;
                for (; t < i; )
                    r.push(t),
                    h === tR.year ? t = o.makeTime(l + x * n, 0) : h === tR.month ? t = o.makeTime(l, d + x * n) : m && (h === tR.day || h === tR.week) ? t = o.makeTime(l, d, c + x * n * (h === tR.day ? 1 : 7)) : m && h === tR.hour && n > 1 ? t = o.makeTime(l, d, c, p + x * n) : t += h * n,
                    x++;
                r.push(t),
                h <= tR.hour && r.length < 1e4 && r.forEach(t => {
      ...
      , tY = {
        ...
        setOptions: function(t) {
            ...
            tX(!0, tH, t),
            t.time && tF.update(tH.time),
            t.lang && "locale"in t.lang && tF.update({
      ...
      , {win: tj} = V
      , {isNumber: tU, isString: tV, merge: t$, pInt: t_, defined: tZ} = tx
      , tq = (t, e, i) => `color-mix(in srgb,${t},${e} ${100 * i}%)`
      , tK = t => tV(t) && !!t && "none" !== t;
    class tJ {
        static parse(t) {
        ...
        constructor(t) {
            ...
            if ("object" == typeof t && void 0 !== t.stops)
                this.stops = t.stops.map(t => new tJ(t[1]));
            else if ("string" == typeof t)
                for (this.input = t = tJ.names[t.toLowerCase()] || t,
                s = tJ.parsers.length; s-- && !i; )
                    (e = (o = tJ.parsers[s]).regex.exec(t)) && (i = o.parse(e));
            i && (this.rgba = i)
        }
        get(t) {
            let e = this.input
        ...
        brighten(t) {
            ...
            if (this.stops)
                ...
                if (tU(e[0]))
                    ...
                    tJ.useColorMix && tK(this.input) && (this.output = tq(this.input, t > 0 ? "white" : "black", Math.abs(t)));
            return this
        }
        setOpacity(t) {
        ...
        tweenTo(t, e) {
            let i = this.rgba
              , s = t.rgba;
            if (!tU(i[0]) || !tU(s[0]))
                return tJ.useColorMix && tK(this.input) && tK(t.input) && e < .99 ? tq(this.input, t.input, e) : t.input || "none";
            let o = 1 !== s[3] || 1 !== i[3]
              , r = (t, s) => t + (i[s] - t) * (1 - e)
    ...
    tJ.parsers = [{
        ...
        parse: function(t) {
            return [t_(t[1]), t_(t[2]), t_(t[3]), parseFloat(t[4], 10)]
        }
    }, {
        regex: /rgb\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)/,
        parse: function(t) {
            return [t_(t[1]), t_(t[2]), t_(t[3]), 1]
        }
    }, {
        regex: /^#([a-f0-9])([a-f0-9])([a-f0-9])([a-f0-9])?$/i,
        parse: function(t) {
            return [t_(t[1] + t[1], 16), t_(t[2] + t[2], 16), t_(t[3] + t[3], 16), tZ(t[4]) ? t_(t[4] + t[4], 16) / 255 : 1]
        }
    }, {
        regex: /^#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?$/i,
        parse: function(t) {
            return [t_(t[1], 16), t_(t[2], 16), t_(t[3], 16), tZ(t[4]) ? t_(t[4], 16) / 255 : 1]
        }
    }],
    tJ.useColorMix = tj.CSS?.supports("color", "color-mix(in srgb,red,blue 9%)"),
    tJ.None = new tJ("");
    let {parse: tQ} = tJ
      , {win: t0} = V
      , {isNumber: t1, objectEach: t2} = tx;
    class t3 {
        constructor(t, e, i) {
            this.pos = NaN,
            this.options = e,
        ...
        run(t, e, i) {
            let s = this
              ...
              , n = function() {
                for (let t = 0; t < t3.timers.length; t++)
                    t3.timers[t]() || t3.timers.splice(t--, 1);
            ...
            r.elem = this.elem,
            r.prop = this.prop,
            r() && 1 === t3.timers.push(r) && a(n)) : (delete o.curAnim[this.prop],
        ...
        initPath(t, e, i) {
            ...
            return u.length && t1(l) && (d = r.length + l * n,
            p ? (g(u, r),
            f(r)) : (g(r, u),
            f(u))),
            [u, r]
    ...
    function es(t, e) {
        ...
        for (; i--; )
            t3.timers[i].elem !== t || e && e !== t3.timers[i].prop || (t3.timers[i].stopped = !0)
    }
    let eo = {
        animate: function(t, e, i) {
            ...
            et(e, function(n, h) {
                ...
                a = new t3(t,i,h),
                r = void 0,
                "d" === h && t9(e.d) ? (a.paths = a.initPath(t, t.pathArray, e.d),
                a.toD = e.d,
                s = 0,
                r = 1) : t.attr ? s = t.attr(h) : (s = parseFloat(t6(t, h)) || 0,
                "opacity" !== h && (o = "px")),
                r || (r = n),
        ...
        getDeferredAnimation: function(t, e, i) {
            ...
            return o.forEach(t => {
                ...
                r = t8(e) && t5(e.defer) ? s.defer : Math.max(r, i.duration + i.defer),
      ...
      , {SVG_NS: er, win: ea} = V
      , {attr: en, createElement: eh, css: el, error: ed, isFunction: ec, isString: ep, objectEach: eu, splat: eg} = tx
      , {trustedTypes: ef} = ea
      , em = ef && ec(ef.createPolicy) && ef.createPolicy("highcharts", {
        createHTML: t => t
    })
      , ex = em ? em.createHTML("") : "";
    class ey {
        static filterUserAttributes(t) {
            return eu(t, (e, i) => {
                let s = !0;
                -1 === ey.allowedAttributes.indexOf(i) && (s = !1),
                -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) && (s = ep(e) && ey.allowedReferences.some(t => 0 === e.indexOf(t))),
                s || (ed(33, !1, void 0, {
                    "Invalid attribute in config": `${i}`
                }),
                delete t[i]),
                ep(e) && t[i] && (t[i] = e.replace(/</g, "&lt;"))
            }
            ),
            t
        }
        ...
        static setElementHTML(t, e) {
            t.innerHTML = ey.emptyHTML,
            e && new ey(e).addToDOM(t)
        }
        constructor(t) {
                ...
                return eg(e).forEach(function(e) {
                    ...
                    if (r)
                        if ("#text" === r)
                            ...
                            let s = "svg" === r ? er : i.namespaceURI || er
                              , h = V.doc.createElementNS(s, r)
                              , l = e.attributes || {};
                            eu(e, function(t, e) {
                                "tagName" !== e && "attributes" !== e && "children" !== e && "style" !== e && "textContent" !== e && (l[e] = t)
                            }),
                            en(h, n ? l : ey.filterUserAttributes(l)),
                            e.style && el(h, e.style),
                            a && h.appendChild(a),
                            t(e.children || [], h),
                            o = h
                        } else
    ...
    ey.allowedReferences = ["https://", "http://", "mailto:", "/", "../", "./", "#"],
    ey.allowedTags = ["#text", "a", "abbr", "b", "br", "button", "caption", "circle", "clipPath", "code", "dd", "defs", "div", "dl", "dt", "em", "feComponentTransfer", "feComposite", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feMerge", "feMergeNode", "feMorphology", "feOffset", "filter", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "i", "img", "li", "linearGradient", "marker", "ol", "p", "path", "pattern", "pre", "rect", "small", "span", "stop", "strong", "style", "sub", "sup", "svg", "table", "tbody", "td", "text", "textPath", "th", "thead", "title", "tr", "tspan", "u", "ul"],
    ey.emptyHTML = ex,
    ey.bypassHTMLFiltering = !1;
    let {defaultOptions: eb, defaultTime: ev} = tY
      , {pageLang: ek} = V
      , {extend: eM, getNestedProperty: ew, isArray: eS, isNumber: eA, isObject: eT, isString: eC, pick: eP, ucfirst: eO} = tx
      , eE = {
        add: (t, e) => t + e,
        divide: (t, e) => 0 !== e ? t / e : "",
        eq: (t, e) => t == e,
      ...
      , eL = {};
    function eB(t="", e, i) {
        let s = RegExp("\\{([\\p{L}\\d:\\.,;\\-\\/<>\\[\\]%_@+\"'’= #\\(\\)]+)\\}", "gu"), o = RegExp("\\(([\\p{L}\\d:\\.,;\\-\\/<>\\[\\]%_@+\"'= ]+)\\)", "gu"), r = [], a = /f$/, n = /\.(\d)/, h = i?.options?.lang || eb.lang, l = i?.time || ev, d = i?.numberFormatter || eD.bind(i), c = (t="") => {
            let i;
        ...
        for (; null !== (p = s.exec(t)); ) {
            ...
            if (u.isBlock && u.fn && (p[1] === `/${u.fn}` || n))
                if (g)
                    ...
                    void 0 === u.body ? (u.body = i,
                    u.startInner = p.index + p[0].length) : u.elseBody = i,
                    u.find += i + p[0],
                    n || (r.push(u),
                    u = void 0)
                }
        ...
        return r.forEach(s => {
            ...
            if (m) {
                ...
                for (p = eE[m].length; p--; )
                    t.unshift(c(o[p + 1]));
                r = eE[m].apply(e, t),
                s.isBlock && "boolean" == typeof r && (r = eB(r ? u : g, e, i))
            } else {
    ...
    function eD(t, e, i, s) {
        ...
        i ?? (i = h.decimalPoint),
        s ?? (s = h.thousandsSep),
        -1 === e ? e = Math.min(l, 20) : eA(e) ? e && n < 0 && ((r = e + n) >= 0 ? (a = +a.toExponential(r).split("e")[0],
        e = r) : (a = Math.floor(a),
        t = e < 20 ? +(a * Math.pow(10, n)).toFixed(e) : 0,
        n = 0)) : e = 2,
        n && (e ?? (e = 2),
        t = a),
        eA(e) && e >= 0 && (c.minimumFractionDigits = e,
        c.maximumFractionDigits = e),
        "" === s && (c.useGrouping = !1);
        let p = s || i
          , u = p ? "en" : this?.locale || h.locale || ek
          , g = JSON.stringify(c) + u;
        return o = (eL[g] ?? (eL[g] = new Intl.NumberFormat(u,c))).format(t),
    ...
    (c = k || (k = {})).rendererTypes = {},
    c.getRendererType = function(t=h) {
    ...
    ;
    let ez = k
      , {clamp: eR, pick: eN, pushUnique: eW, stableSort: eG} = tx;
    (M || (M = {})).distribute = function t(e, i, s) {
        ...
        for (c = h; c--; )
            x += e[c].size;
        if (x > r) {
            for (eG(e, (t, e) => (e.rank || 0) - (t.rank || 0)),
            u = (y = e[0].rank === e[e.length - 1].rank) ? h / 2 : -1,
            p = y ? u : h - 1; u && x > r; )
                f = e[c = Math.floor(p)],
                eW(l, c) && (x -= f.size),
                p += u,
        ...
        e = e.map(t => ({
            ...
            for (c = e.length; c--; )
                ...
                f.pos = eR(m - f.size * f.align, 0, i - f.size);
            for (c = e.length,
            g = !1; c--; )
    ...
    ;
    let eX = M
      , {animate: eH, animObject: eF, stop: eY} = eo
      , {deg2rad: ej, doc: eU, svg: eV, SVG_NS: e$, win: e_, isFirefox: eZ} = V
      , {addEvent: eq, attr: eK, createElement: eJ, crisp: eQ, css: e0, defined: e1, erase: e2, extend: e3, fireEvent: e5, getAlignFactor: e6, isArray: e9, isFunction: e4, isNumber: e8, isObject: e7, isString: it, merge: ie, objectEach: ii, pick: is, pInt: io, pushUnique: ir, replaceNested: ia, syncTimeout: ih, uniqueKey: il} = tx;
    class id {
        _defaultGetter(t) {
        ...
        align(t, e, i, s=!0) {
            ...
            i = void 0);
            let h = is(i, o[n], o)
              , l = (h.x || 0) + (t.x || 0) + ((h.width || 0) - (t.width || 0)) * e6(t.align)
              , d = (h.y || 0) + (t.y || 0) + ((h.height || 0) - (t.height || 0)) * e6(t.verticalAlign)
              , c = {};
            return t.align && (c["text-align"] = t.align),
        ...
        animate(t, e, i) {
            let s = eF(is(e, this.renderer.globalAnimation, !0))
              , o = s.defer;
            return eU.hidden && (s.duration = 0),
        ...
        attr(t, e, i, s) {
            ...
            (t = {})[a] = e),
            "string" == typeof t ? h = (this[t + "Getter"] || this._defaultGetter).call(this, t, o) : (ii(t, function(e, i) {
                l = !1,
                s || eY(this, i),
        ...
        crisp(t, e) {
            ...
            e1(t.strokeWidth) && (t.strokeWidth = e),
            t
        }
        complexColor(t, e, i) {
            ...
            e5(this.renderer, "complexColor", {
                ...
                r) {
                    ...
                    "radialGradient" === r && p && !e1(a.gradientUnits) && (n = a,
                    a = ie(a, s.getRadialAttr(p, n), {
                        gradientUnits: "userSpaceOnUse"
                    })),
                    ii(a, function(t, e) {
                        "id" !== e && g.push(e, t)
                    ...
                    h[g = g.join(",")])
                        ...
                        l.forEach(function(e) {
                            0 === e[1].indexOf("rgba") ? (d = (o = tJ.parse(e[1])).get("rgb"),
                            c = o.get("a")) : (d = e[1],
                            c = 1);
        ...
        css(t) {
            ...
            r) {
                e && (t = e3(e, i)),
                null === t.width || "auto" === t.width ? delete this.textWidth : "text" === s.nodeName.toLowerCase() && t.width && (o = this.textWidth = io(t.width)),
                e3(this.styles, t),
                o && !eV && this.renderer.forExport && delete t.width;
        ...
        destroy() {
            ...
            for (t.safeRemoveChild(e); r?.div && 0 === r.div.childNodes.length; )
                a = r.parentGroup,
                t.safeRemoveChild(r.div),
                delete r.div,
                r = a;
            t.alignOptions && e2(i.alignedObjects, t),
            ii(t, (e, i) => {
        ...
        dSetter(t, e, i) {
            e9(t) && ("string" == typeof t[0] && (t = this.renderer.pathToSegments(t)),
            this.pathArray = t,
        ...
        getBBox(t, e) {
            let i, s, o, {element: r, renderer: a, styles: n, textStr: h} = this, {cache: l, cacheKeys: d} = a, c = r.namespaceURI === this.SVG_NS, p = is(e, this.rotation, 0), u = a.styledMode ? r && id.prototype.getStyle.call(r, "font-size") : n.fontSize, g = this.getBBoxCacheKey([a.rootFontSize, this.textWidth, this.alignValue, n.fontWeight, n.lineClamp, n.textOverflow, u, p]);
            if (g && !t && (i = l[g]),
            !i || i.polygon) {
                if (c || a.forExport) {
                    try {
        ...
        getRotatedBox(t, e) {
            let {x: i, y: s, width: o, height: r} = t
              ...
              , B = Math.min(S, A, T, C)
              , D = Math.min(P, O, E, L)
              , I = Math.max(S, A, T, C) - B
              , z = Math.max(P, O, E, L) - D;
            return {
                x: B,
                y: D,
                width: I,
                height: z,
                polygon: [[S, P], [A, O], [T, E], [C, L]]
            }
        }
        getStyle(t) {
        ...
        constructor(t, e) {
            ...
            this.opacity = 1,
            this.SVG_NS = e$,
            this.element = "span" === e || "body" === e ? eJ(e) : eU.createElementNS(this.SVG_NS, e),
            this.renderer = t,
            this.styles = {},
            e5(this, "afterInit")
        }
        ...
        shadow(t) {
            let {renderer: e} = this
              , i = ie(this.parentGroup?.rotation === 90 ? {
                offsetX: -1,
                offsetY: -1
            } : {}, e7(t) ? t : {})
        ...
        titleSetter(t) {
            let e = this.element
              , i = e.getElementsByTagName("title")[0] || eU.createElementNS(this.SVG_NS, "title");
            e.insertBefore ? e.insertBefore(i, e.firstChild) : e.appendChild(i),
            i.textContent = ia(is(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">")
        }
        toFront() {
            let t = this.element;
        ...
        updateTransform(t="transform") {
            let {element: e, foreignObject: i, matrix: s, padding: o, rotation: r=0, rotationOriginX: a, rotationOriginY: n, scaleX: h, scaleY: l, text: d, translateX: c=0, translateY: p=0} = this
              , u = [`translate(${c},${p})`];
            e1(s) && u.push("matrix(" + s.join(",") + ")"),
            r && (u.push("rotate(" + r + " " + (a ?? e.getAttribute("x") ?? this.x ?? 0) + " " + (n ?? e.getAttribute("y") ?? this.y ?? 0) + ")"),
            d?.element.tagName !== "SPAN" || d?.foreignObject || d.attr({
                rotation: r,
                rotationOriginX: (a || 0) - o,
                rotationOriginY: (n || 0) - o
            })),
            (e1(h) || e1(l)) && u.push(`scale(${h ?? 1} ${l ?? 1})`),
            u.length && !(d || this).textPath && (i?.element || e).setAttribute(t, u.join(" "))
        }
        ...
        zIndexSetter(t, e) {
            ...
            if (e1(t) ? (r.setAttribute("data-z-index", t),
            t *= 1,
            this[e] === t && (p = !1)) : e1(this[e]) && r.removeAttribute("data-z-index"),
            this[e] = t,
            p) {
                for ((t = this.zIndex) && s && (s.handleZ = !0),
                u = (n = o.childNodes).length - 1; u >= 0 && !d; u--)
                    c = !e1(l = (h = n[u]).getAttribute("data-z-index")),
                    h !== r && (t < 0 && c && !a && !u ? (o.insertBefore(r, n[u]),
                    d = !0) : (io(l) <= t || c && (!e1(t) || t >= 0)) && (o.insertBefore(r, n[u + 1]),
                    d = !0));
    ...
    id.symbolCustomAttribs = ["anchorX", "anchorY", "clockwise", "end", "height", "innerR", "r", "start", "width", "x", "y"],
    id.prototype.strokeSetter = id.prototype.fillSetter,
    id.prototype.yGetter = id.prototype.xGetter,
    id.prototype.matrixSetter = id.prototype.rotationOriginXSetter = id.prototype.rotationOriginYSetter = id.prototype.rotationSetter = id.prototype.scaleXSetter = id.prototype.scaleYSetter = id.prototype.translateXSetter = id.prototype.translateYSetter = id.prototype.verticalAlignSetter = function(t, e) {
        this[e] = t,
        this.doTransform = !0
    }
    ;
    let ic = id
      , {defined: ip, extend: iu, getAlignFactor: ig, isNumber: im, merge: ix, pick: iy, removeEvent: ib} = tx;
    class iv extends ic {
        ...
        alignSetter(t) {
            ...
            this.bBox && im(this.xSetting) && this.attr({
                x: this.xSetting
            }),
        ...
        css(t) {
            if (t) {
                let e = {};
                t = ix(t),
                iv.textProps.forEach(i => {
                    void 0 !== t[i] && (e[i] = t[i],
                    delete t[i])
                }
                ),
                this.text.css(e),
                "fontSize"in e || "fontWeight"in e || "width"in e ? this.updateTextPadding() : "textOverflow"in e && this.updateBoxSize()
            }
            return ic.prototype.css.call(this, t)
        }
        destroy() {
            ib(this.element, "mouseenter"),
            ib(this.element, "mouseleave"),
        ...
        updateBoxSize() {
            ...
            this.needsBox && !e.textPath) {
                ...
                this.box.attr(iu(i, this.deferredAttr)),
                this.deferredAttr = {}
            }
        }
        updateTextPadding() {
            ...
            if (!t.textPath) {
                ...
                let i = this.baseline ? 0 : this.baselineOffset
                  , s = (this.paddingLeft ?? this.padding) + ig(e) * (this.widthSetting ?? this.bBox.width);
                (s !== t.x || i !== t.y) && (t.attr({
                    align: e,
                    x: s
                }),
        ...
        widthSetter(t) {
            this.widthSetting = im(t) ? t : void 0,
            this.doUpdate = !0
        }
        getPaddedWidth() {
            let t = this.padding
              , e = iy(this.paddingLeft, t)
              , i = iy(this.paddingRight, t);
    ...
    function iS(t, e, i, s, o) {
        ...
        if (o) {
            ...
            let p = o.innerR
              ...
              , m = Math.cos(n)
              , x = Math.sin(n)
              , y = iw(o.longArc, n - a - Math.PI < d ? 0 : 1)
              , b = ["A", h, l, 0, y, iw(o.clockwise, 1), t + h * m, e + l * x];
            b.params = {
                start: a,
                end: n,
                cx: t,
            ...
            r.push(["M", t + h * g, e + l * f], b),
            ik(p) && ((b = ["A", p, p, 0, y, ik(o.clockwise) ? 1 - o.clockwise : 0, t + p * g, e + p * f]).params = {
                start: n,
                end: a,
                cx: t,
                cy: e
            },
            r.push(u ? ["M", t + p * m, e + p * x] : ["L", t + p * m, e + p * x], b)),
            u || r.push(["Z"])
        }
        return r
    }
    function iA(t, e, i, s, o) {
        return o?.r ? iT(t, e, i, s, o) : [["M", t, e], ["L", t + i, e], ["L", t + i, e + s], ["L", t, e + s], ["Z"]]
    }
    ...
    let iC = {
      ...
      , {doc: iP, SVG_NS: iO, win: iE} = V
      , {attr: iL, extend: iB, fireEvent: iD, isString: iI, objectEach: iz, pick: iR} = tx
      , iN = (t, e) => t.substring(0, e) + "…"
      , iW = class {
        constructor(t) {
            const e = t.styles;
        ...
        buildSVG() {
            ...
            if (n !== t.textCache) {
                ...
                if (o || this.ellipsis || this.width || t.textPath || -1 !== s.indexOf(" ") && (!this.noWrap || /<br.*?>/g.test(s))) {
                    ...
                    e.appendChild(iP.createTextNode(this.unescapeEntities(s)));
                ...
                if (n) {
                    ...
                    for (; a.length; )
                        ...
                        this.lineClamp && d >= this.lineClamp) {
                            a.length && (this.truncate(t, t.textContent || "", void 0, 0, s, l, iN),
                    ...
                    this.ellipsis && r && this.truncate(t, r, void 0, 0, s, l, iN)
            }
              , r = t => {
                [].slice.call(t.childNodes).forEach(i => {
                    i.nodeType === iE.Node.TEXT_NODE ? o(i, t) : (-1 !== i.className.baseVal.indexOf("highcharts-br") && (e.actualWidth = 0),
                    r(i))
                }
                )
            }
        ...
        truncate(t, e, i, s, o, r, a) {
            ...
            s + (h = f(t.textContent.length)) > o) {
                ...
                0 === u ? t.textContent = "" : e && u === e.length - 1 || (t.textContent = n || a(e || i, g)),
                this.ellipsis && h > o && this.truncate(t, t.textContent || "", void 0, 0, o, r, iN)
            }
            i && i.splice(0, g),
            l.actualWidth = h,
            l.rotation = d
      ...
      , {defaultOptions: iG} = tY
      , {charts: iX, deg2rad: iH, doc: iF, isFirefox: iY, isMS: ij, isWebKit: iU, noop: iV, SVG_NS: i$, symbolSizes: i_, win: iZ} = V
      , {addEvent: iq, attr: iK, createElement: iJ, crisp: iQ, css: i0, defined: i1, destroyObjectProperties: i2, extend: i3, isArray: i5, isNumber: i6, isObject: i9, isString: i4, merge: i8, pick: i7, pInt: st, replaceNested: se, uniqueKey: si} = tx;
    class ss {
        constructor(t, e, i, s, o, r, a) {
            ...
            this.createElement("desc").add().element.appendChild(iF.createTextNode("Created with Highcharts 12.5.0")),
            ...
            this.setSize(e, i, !1),
            iY && t.getBoundingClientRect && ((n = function() {
                i0(t, {
                    left: 0,
                    top: 0
                }),
        ...
        definition(t) {
            return new ey([t]).addToDOM(this.defs.element)
        }
        getReferenceURL() {
            if ((iY || iU) && iF.getElementsByTagName("base").length) {
                if (!i1(e)) {
                    ...
                    e = s?.id === "hitme",
                    iF.body.removeChild(i)
                }
                if (e)
                    return se(iZ.location.href.split("#")[0], [/<[^>]*>/g, ""], [/([\('\)])/g, "\\$1"], [/ /g, "%20"])
            }
            return ""
        }
        getStyle(t) {
        ...
        button(t, e, i, s, o={}, r, a, n, h, l) {
            ...
            delete o.states,
            delete o.style;
            let m = [ey.filterUserAttributes(o)]
              , x = [f];
            return c || ["hover", "select", "disabled"].forEach( (t, e) => {
                m.push(i8(m[0], ey.filterUserAttributes(p[e + 5] || g[t] || {}))),
                x.push(m[e + 1].style),
                delete m[e + 1].style
            }
            ),
        ...
        crispLine(t, e) {
            let[i,s] = t;
            return i1(i[1]) && i[1] === s[1] && (i[1] = s[1] = iQ(i[1], e)),
            i1(i[2]) && i[2] === s[2] && (i[2] = s[2] = iQ(i[2], e)),
            t
        }
        path(t) {
        ...
        symbol(t, e, i, s, o, r) {
            ...
            if (g)
                ...
                s.imgwidth = i7(r?.width, i_[h]?.width),
                s.imgheight = i7(r?.height, i_[h]?.height),
                l = t => t.attr({
                    width: t.width,
                    height: t.height
                }),
                ...
                s.isImg = !0,
                s.symbolUrl = t,
                i1(s.imgwidth) && i1(s.imgheight) ? l(s) : (s.attr({
                    width: 0,
                    height: 0
                }),
                iJ("img", {
        ...
        fontMetrics(t) {
            let e = i6(t) ? t : st(ic.prototype.getStyle.call(t, "font-size") || 0)
        ...
        pathToSegments(t) {
            ...
            for (let o = 0; o < t.length; o++)
                i4(i[0]) && i6(t[o]) && i.length === s[i[0].toUpperCase()] && t.splice(o, 0, i[0].replace("M", "L").replace("m", "l")),
    ...
    let {composed: so, isFirefox: sr} = V
      , {attr: sa, css: sn, createElement: sh, defined: sl, extend: sd, getAlignFactor: sc, isNumber: sp, pInt: su, pushUnique: sg} = tx;
    function sf(t, e, i) {
        let s = this.div?.style;
        ic.prototype[`${e}Setter`].call(this, t, e, i),
        s && (i.style[e] = s[e] = t)
    }
    let sm = (t, e) => {
        if (!t.div) {
            let i = sa(t.element, "class")
              , s = t.css
              , o = sh("div", i ? {
                className: i
            } : void 0, {
            ...
            ,
            t.opacitySetter = t.visibilitySetter = sf,
            t.css = e => (s.call(t, e),
    ...
    class sx extends ic {
        ...
        constructor(t, e) {
            super(t, e),
            sx.useForeignObject ? this.foreignObject = t.createElement("foreignObject").attr({
                zIndex: 2
            }) : this.css({
                position: "absolute",
                ...t.styledMode ? {} : {
        ...
        css(t) {
            ...
            t.overflow = "hidden"),
            sp(Number(t?.fontSize)) && (t.fontSize += "px"),
            sd(this.styles, t),
            sn(i, t),
        ...
        updateTransform() {
            ...
            let {element: t, foreignObject: e, oldTextWidth: i, renderer: s, rotation: o, rotationOriginX: r, rotationOriginY: a, scaleX: n, scaleY: h, styles: {display: l="inline-block", whiteSpace: d}, textAlign: c="left", textWidth: p, translateX: u=0, translateY: g=0, x: f=0, y: m=0} = this
              , x = () => this.textPxLength ? this.textPxLength : (sn(t, {
                width: "",
                whiteSpace: d || "nowrap"
            }),
            t.offsetWidth);
            ...
            "SPAN" === t.tagName) {
                let u, g = [o, c, t.innerHTML, p, this.textAlign].join(","), y = -(this.parentGroup?.padding * 1) || 0;
                if (p !== i) {
                    let e = x()
                      , r = p || 0
        ...
        textSetter(t) {
            ...
            ey.setElementHTML(this.element, t ?? ""),
            this.textStr = t,
            this.doTransform = !0)
        }
        alignSetter(t) {
    ...
    let sy = sx.prototype;
    sy.visibilitySetter = sy.opacitySetter = sf,
    sy.ySetter = sy.rotationSetter = sy.rotationOriginXSetter = sy.rotationOriginYSetter = sy.xSetter,
    (p = w || (w = {})).xAxis = {
        alignTicks: !0,
    ...
    let sb = w
      , {addEvent: sv, isFunction: sk, objectEach: sM, removeEvent: sw} = tx;
    (S || (S = {})).registerEventOptions = function(t, e) {
        t.eventOptions = t.eventOptions || {},
        sM(e.events, function(e, i) {
            t.eventOptions[i] !== e && (t.eventOptions[i] && (sw(t, i, t.eventOptions[i]),
            delete t.eventOptions[i]),
            sk(e) && (t.eventOptions[i] = e,
            sv(t, i, e, {
                order: 0
            })))
        })
    ...
    let sS = S
      , {deg2rad: sA} = V
      , {clamp: sT, correctFloat: sC, defined: sP, destroyObjectProperties: sO, extend: sE, fireEvent: sL, getAlignFactor: sB, isNumber: sD, merge: sI, objectEach: sz, pick: sR} = tx
      , sN = class {
        ...
        addLabel() {
            ...
            r && sD(y) && (y = sC(r.lin2log(y))),
            e.dateTime && (u ? f = (m = s.time.resolveDTLFormat(i.dateTimeLabelFormats[!i.grid?.enabled && u.higherRanks[n] || u.unitName])).main : sD(y) && (f = e.dateTime.getXDateFormat(y, i.dateTimeLabelFormats || {}))),
            t.isFirst = d,
            t.isLast = c;
            let b = {
                axis: e,
            ...
            eI.format(h.format, t, s)) : e.defaultLabelFormatter.call(t)
              , k = v.call(b, b)
              , M = m?.list;
            M ? t.shortenLabel = function() {
                for (x = 0; x < M.length; x++)
                    ...
                    g.getBBox().width < e.getSlotWidth(t) - 2 * (h.padding || 0))
                        return;
                g.attr({
                    text: ""
                })
            ...
            sP(g) || t.movedLabel ? g && g.textStr !== k && !p && (!g.textWidth || h.style.width || g.styles.width || g.css({
                width: null
            }),
            g.attr({
                text: k
            }),
            g.textPxLength = g.getBBox().width) : (t.label = g = t.createLabel(k, h),
            t.rotation = 0)
        }
        createLabel(t, e, i) {
            let s = this.axis
              ...
              , n = sP(t) && e.enabled ? o.text(t, i?.x, i?.y, e.useHTML).add(s.labelGroup) : void 0;
            return n && (r || n.css(sI(e.style)),
        ...
        getLabelPosition(t, e, i, s, o, r, a, n) {
            ...
            return h = 0 === d.side ? i.rotation ? -m : -i.getBBox().height : 2 === d.side ? g.y + m : Math.cos(i.rotation * sA) * (g.y - i.getBBox(!1, 0).height / 2),
            sP(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
            t = t + sR(o.x, [0, 1, 0, -1][d.side] * m) + f + g.x - (r && s ? r * c * (p ? -1 : 1) : 0),
        ...
        handleOverflow(t) {
            ...
            l || "justify" !== i.overflow ? l < 0 && s - d * c < a ? f = Math.round(s / Math.cos(l * sA) - a) : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * sA))) : (s - d * c < a ? u = t.x + u * (1 - d) - a : s + (1 - d) * c > n && (u = n - t.x + u * d,
            g = -1),
            (u = Math.min(p, u)) < p && "center" === e.labelAlign && (t.x += g * (p - u - d * (p - Math.min(c, u)))),
            (c > u || e.autoRotation && h?.styles?.width) && (f = u)),
            f && h && (this.shortenLabel ? this.shortenLabel() : h.css(sE({}, {
        ...
        moveLabel(t, e) {
            ...
            r = !0,
            delete i.label) : sz(o.ticks, function(e) {
        ...
        render(t, e, i) {
            let s = this.axis
              ...
              , c = d + s.len
              , p = o ? h : l
              , u = sR(i, this.label?.newOpacity, 1);
            !s.chart.polar && (sC(p) < d || p > c) && (i = 0),
            i ?? (i = 1),
            this.isActive = !0,
        ...
        renderMark(t, e) {
            let i = this.axis
              ...
              , n = t.x
              , h = t.y
              , l = sR(s["minor" !== r ? "tickWidth" : "minorTickWidth"], !r && i.isXAxis ? 1 : 0)
        ...
        renderLabel(t, e, i, s) {
            let o = this.axis
              ...
              , p = t.y
              , u = !0;
            n && sD(c) && (n.xy = t = this.getLabelPosition(c, p, n, r, h, d, s, l),
            (!this.isFirst || this.isLast || a.showFirstLabel) && (!this.isLast || this.isFirst || a.showLastLabel) ? !r || h.step || h.rotation || e || 0 === i || this.handleOverflow(t) : u = !1,
            l && s % l && (u = !1),
            u && sD(t.y) ? (t.opacity = i,
    ...
    class oo {
        ...
        init(t, e, i=this.coll) {
            ...
            this.opposite = s8(e.opposite, this.opposite),
            this.side = s8(e.side, this.side, o ? 2 * !this.opposite : this.opposite ? 1 : 3),
            this.setOptions(e);
            let r = this.options
              , a = r.labels;
            this.type ?? (this.type = r.type || "linear"),
            this.uniqueNames ?? (this.uniqueNames = r.uniqueNames ?? !0),
            sQ(this, "afterSetType"),
            this.userOptions = e,
            this.minPixelPadding = 0,
            this.reversed = s8(r.reversed, this.reversed),
            this.visible = r.visible,
            this.zoomEnabled = r.zoomEnabled,
            this.hasNames = "category" === this.type || !0 === r.categories,
            this.categories = s2(r.categories) && r.categories || (this.hasNames ? [] : void 0),
            this.names || (this.names = [],
            this.names.keys = {}),
            this.plotLinesAndBandsGroups = {},
            this.positiveValuesOnly = !!this.logarithmic,
            this.isLinked = s_(r.linkedTo),
            this.ticks = {},
            this.labelEdge = [],
            this.minorTicks = {},
            ...
            t.inverted && !this.isZAxis && s && !s_(this.reversed) && (this.reversed = !0),
            this.labelRotation = s3(a.rotation) ? a.rotation : void 0,
            sF(this, r),
            sQ(this, "afterInit")
        }
        setOptions(t) {
                ...
                e.series.forEach(i => {
                    if (i.reserveSpace()) {
                        ...
                        e.isXAxis)
                            ...
                            n = t.max,
                            s3(a) || a instanceof Date || (o = o.filter(s3),
                            a = (t = i.getXExtremes(o)).min,
                            n = t.max),
                            o.length && (e.dataMin = Math.min(s8(e.dataMin, a), a),
                            e.dataMax = Math.max(s8(e.dataMax, n), n)));
                        else {
                            let t = i.applyExtremes();
                            s3(t.dataMin) && (a = t.dataMin,
                            e.dataMin = Math.min(s8(e.dataMin, a), a)),
                            s3(t.dataMax) && (n = t.dataMax,
                            e.dataMax = Math.max(s8(e.dataMax, n), n)),
                            s_(r) && (e.threshold = r),
        ...
        translate(t, e, i, s, o, r) {
            ...
            c -= d * (a.sector || a.len)),
            e ? (u = (t = t * d + c - h) / p + n,
            l && (u = a.lin2val(u))) : (l && (t = a.val2lin(t)),
            u = d * (t - n) * p + c + d * h + (s3(r) ? p * r : 0),
            a.isRadial || (u = s$(u))),
            u
        }
        toPixels(t, e) {
        ...
        getPlotLinePath(t) {
            ...
            function y(t, e, i) {
                return "pass" !== p && (t < e || t > i) && (p ? t = sV(t, e, i) : x = !0),
                t
            }
            let b = {
                value: a,
            ...
            return sQ(this, "getPlotLinePath", b, function(t) {
                u = f = (c = sV(c = s8(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d,
                g = m = h - c - d,
                s3(c) ? e.horiz ? (g = o,
                m = h - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0),
                u = f = y(u, s, s + e.width)) : (u = s,
                f = l - e.right + (i.scrollablePixelsX || 0),
                g = m = y(g, o, o + e.height)) : (x = !0,
                p = !1),
                t.path = x && !p ? void 0 : i.renderer.crispLine([["M", u, g], ["L", f, m]], n || 1)
            }),
            b.path
        }
        ...
        adjustForMinRange() {
            ...
            s3(s) && s3(o) && s3(r) && s - o < r && (n = this.dataMax - this.dataMin >= r,
            a = (r - s + o) / 2,
            h = [o - a, i.parse(t.min) ?? o - a],
            n && (h[2] = e ? e.log2lin(this.dataMin) : this.dataMin),
            l = [(o = sj(h)) + r, i.parse(t.max) ?? o + r],
        ...
        nameToX(t) {
            ...
            s_(s) || (s = this.uniqueNames && i ? e ? i.indexOf(t.name) : s8(i.keys[t.name], -1) : t.series.autoIncrement()),
            -1 === s ? !e && i && (o = i.length) : s3(s) && (o = s),
        ...
        setAxisTranslation() {
            ...
            h = i.pointRangePadding) : t.series.forEach(function(e) {
                let i = s ? 1 : o ? s8(e.options.pointRange, a, 0) : t.axisPointRange || 0
                  , l = e.options.pointPlacement;
                if (r = Math.max(r, i),
                !t.single || s) {
                    let t = e.is("xrange") ? !o : o;
                    n = Math.max(n, t && s5(l) ? 0 : i / 2),
            ...
            sQ(this, "afterSetAxisTranslation")
        }
        minFromRange() {
        ...
        setTickInterval(t) {
            ...
            C = s8(this.userMin, d.parse(h.min)),
            P = s8(this.userMax, d.parse(h.max)),
            y ? (this.linkedParent = y,
            w = y.getExtremes(),
            this.min = s8(w.min, w.dataMin),
            this.max = s8(w.max, w.dataMax),
            this.type !== y.type && sK(11, !0, i)) : (l && s_(c) && s3(s) && s3(o) && (o >= c ? (A = c,
            k = 0) : s <= c && (T = c,
            v = 0)),
            this.min = s8(C, A, o),
            this.max = s8(P, T, s)),
            s3(this.max) && s3(this.min) && (n && (this.positiveValuesOnly && !t && 0 >= Math.min(this.min, s8(o, this.min)) && sK(10, !0, i),
            this.min = s$(n.log2lin(this.min), 16),
            this.max = s$(n.log2lin(this.max), 16)),
            this.range && s3(o) && (this.userMin = this.min = C = Math.max(o, this.minFromRange() || 0),
            this.userMax = P = this.max,
            this.range = void 0)),
            sQ(this, "foundExtremes"),
            this.adjustForMinRange(),
            s3(this.min) && s3(this.max)) {
                if (!s3(this.userMin) && s3(x) && x < this.min && (this.min = C = x),
                !s3(this.userMax) && s3(m) && m > this.max && (this.max = P = m),
                e || this.axisPointRange || this.stacking?.usePercentage || y || (M = this.max - this.min) && (!s_(C) && k && (this.min -= M * k),
                !s_(P) && v && (this.max += M * v)),
                !s3(this.userMin) && s3(g) && (this.min = Math.max(this.min, g)),
                !s3(this.userMax) && s3(u) && (this.max = Math.min(this.max, u)),
                l && s3(o) && s3(s)) {
                    let t = c || 0;
                ...
                !i.polar && this.min > this.max && (s_(h.min) ? this.max = this.min : s_(h.max) && (this.min = this.max)),
                M = this.max - this.min
            }
            if (this.min !== this.max && s3(this.min) && s3(this.max) ? y && !S && b === y.options.tickPixelInterval ? this.tickInterval = S = y.tickInterval : this.tickInterval = s8(S, this.tickAmount ? M / Math.max(this.tickAmount - 1, 1) : void 0, e ? 1 : M * b / Math.max(this.len, b)) : this.tickInterval = 1,
            a && !t) {
            ...
            sQ(this, "initialAxisTranslation"),
            ...
            r || n || S || (this.tickInterval = os(this, this.tickInterval)),
        ...
        setTickPositions() {
            ...
            this.single = this.min === this.max && s_(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals),
            e)
                n = e.slice();
                ...
                if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                    ...
                    for (; e <= 2 * t; )
                        ...
                        this.tickAmount && n.length > this.tickAmount)
                            this.tickInterval = os(this, e *= 1.1);
                        else
                            break
                }
            ...
            !this.isLinked && s3(this.min) && s3(this.max) && (this.single && n.length < 2 && !this.categories && !this.series.some(t => t.is("heatmap") && "between" === t.options.pointPlacement) && (this.min -= .5,
            this.max += .5),
            e || h || this.adjustTickAmount()),
            sQ(this, "afterSetTickPositions")
        }
        trimTicks(t, e, i) {
            let s = t[0]
              , o = t[t.length - 1]
              , r = !this.isOrdinal && this.minPointOffset || 0;
            if (sQ(this, "trimTicks"),
        ...
        getThresholdAlignment(t) {
            if ((!s3(this.dataMin) || this !== t && this.series.some(t => t.isDirty || t.isDirtyData || t.xAxis?.isDirty)) && this.getSeriesExtremes(),
            s3(this.threshold)) {
        ...
        getTickAmount() {
            let t = this.options
              ...
              , i = t.tickAmount;
            s_(t.tickInterval) || i || !(this.len < e) || this.isRadial || this.logarithmic || !t.startOnTick || !t.endOnTick || (i = 2),
        ...
        adjustTickAmount() {
            ...
            if (s3(n) && (u = 0 === n ? 0 : 1 === n ? a - 1 : Math.round(sV(n * (a - 1), 1, a - 2)),
            o.reversed && (u = a - 1 - u)),
            t.hasData() && s3(s) && s3(i)) {
                let n = () => {
                    t.transA *= (h - 1) / (a - 1),
        ...
        setAxisSize() {
            let t = this.chart
              ...
              , i = e.offsets || [0, 0, 0, 0]
              , s = this.horiz
              , o = this.width = Math.round(s7(s8(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth))
              , r = this.height = Math.round(s7(s8(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight))
              , a = this.top = Math.round(s7(s8(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop))
              , n = this.left = Math.round(s7(s8(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft));
        ...
        tickSize(t) {
            ...
            return sQ(this, "afterTickSize", r),
            r.tickSize
        }
        labelMetrics() {
        ...
        unsquish() {
            ...
            if (i) {
                if (!t.staggerLines && (s3(r) ? p = [r] : o < t.autoRotationLimit && (p = t.autoRotation)),
                p) {
                    let t, e;
                    for (let i of p)
                        (i === r || i && i >= -90 && i <= 90) && (e = (t = h(Math.abs(a / Math.sin(sY * i)))) + Math.abs(i / 360)) < c && (c = e,
                        d = i,
                        l = t)
                }
            } else
            ...
            this.labelRotation = s8(d, s3(r) ? r : 0),
            t.step ? s : l
        }
        getSlotWidth(t) {
            let e = this.chart
        ...
        renderUnsquish() {
            ...
            s5(o.rotation) || (l.rotation = o.rotation || 0),
            ...
            this.autoRotation ? g > h && g > d.h ? l.rotation = this.labelRotation : this.labelRotation = 0 : n && (p = h),
            ...
            i.forEach(function(t) {
                let e = s[t]
                  ...
                  , a = {};
                i && (i.attr(l),
                e.shortenLabel ? e.shortenLabel() : p && !o && "nowrap" !== r.whiteSpace && (p < (i.textPxLength || 0) || "SPAN" === i.element.tagName) ? i.css(sJ(a, {
                    width: `${p}px`,
                    lineClamp: u
        ...
        addTitle(t) {
            ...
            a || this.axisTitle.css(s6(r.style)),
        ...
        getOffset() {
            let t = this, {chart: e, horiz: i, options: s, side: o, ticks: r, tickPositions: a, coll: n} = t, h = e.inverted && !t.isZAxis ? [1, 0, 3, 2][o] : o, l = t.hasData(), d = s.title, c = s.labels, p = s3(s.crossing), u = e.axisOffset, g = e.clipOffset, f = [-1, 1, 1, -1][o], m, x = 0, y, b = 0, v = 0, k, M;
            ...
            s8(c.reserveSpace, !p && null, "center" === t.labelAlign || null, t.reserveSpaceDefault) && a.forEach(function(t) {
                v = Math.max(r[t].getLabelSize(), v)
            }),
            t.staggerLines && (v *= t.staggerLines),
            t.labelOffset = v * (t.opposite ? -1 : 1)) : s4(r, function(t, e) {
                t.destroy(),
                delete r[e]
            }),
            d?.text && !1 !== d.enabled && (t.addTitle(m),
            m && !p && !1 !== d.reserveSpace && (t.titleOffset = x = t.axisTitle.getBBox()[i ? "height" : "width"],
            b = s_(y = d.offset) ? 0 : s8(d.margin, i ? 5 : 10))),
            t.renderLine(),
            t.offset = f * s8(s.offset, u[o] ? u[o] + (s.margin || 0) : 0),
            t.tickRotCorr = t.tickRotCorr || {
                x: 0,
                y: 0
            },
            M = 0 === o ? -t.labelMetrics().h : 2 === o ? t.tickRotCorr.y : 0,
            k = Math.abs(v) + b,
            v && (k -= M,
            k += f * (i ? s8(c.y, t.tickRotCorr.y + f * c.distance) : s8(c.x, f * c.distance))),
            t.axisTitleMargin = s8(y, k),
        ...
        renderTick(t, e, i) {
            let s = this.isLinked
              , o = this.ticks;
            (!s || t >= this.min && t <= this.max || this.grid?.isColumn) && (o[t] || (o[t] = new sN(this,t)),
        ...
        render() {
            ...
            if (i.hasData() || n) {
                ...
                m && (0 === i.min || i.single) && (d[-1] || (d[-1] = new sN(i,-1,null,!0)),
                d[-1].render(-1))),
                g && h.forEach(function(r, a) {
                    e = void 0 !== h[a + 1] ? h[a + 1] + m : i.max - m,
                    a % 2 == 0 && r < i.max && e <= i.max + (s.polar ? -m : m) && (p[r] || (p[r] = new V.PlotLineOrBand(i,{})),
                    t = r + m,
                    p[r].options = {
        ...
        drawCrosshair(t, e) {
            ...
            t || (t = this.cross?.e),
            i && !1 !== (s_(e) || !s)) {
                if (s ? s_(e) && (a = s8("colorAxis" !== this.coll ? e.crosshairPos : null, this.isXAxis ? e.plotX : this.len - e.plotY)) : a = t && (this.horiz ? t.chartX - this.pos : this.len - t.chartY + this.pos),
                s_(a) && (l = {
        ...
        hideCrosshair() {
            ...
            sQ(this, "afterHideCrosshair")
        }
        update(t, e) {
            let i = this.chart;
            t = s6(this.userOptions, t),
            this.destroy(!0),
            this.init(i, t),
            i.isDirtyBox = !0,
            s8(e, !0) && i.redraw()
    ...
    !function(t) {
        ...
        class s {
            ...
            normalizeTimeTickInterval(t, e) {
                let i = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], s = i[i.length - 1], o = oh[s[0]], r = s[1], a;
                for (a = 0; a < i.length && (o = oh[(s = i[a])[0]],
                r = s[1],
                !i[a + 1] || !(t <= (o * r[r.length - 1] + oh[i[a + 1][0]]) / 2)); a++)
                    ;
                o === oh.year && t < 5 * o && (r = [1, 2, 5]);
    ...
    let ol = A
      , {addEvent: od, normalizeTickInterval: oc, pick: op} = tx;
    !function(t) {
        function e() {
        ...
        class s {
            ...
            getLogTickPositions(t, e, i, s) {
                ...
                t >= .5)
                    ...
                    t = oc(t = op("auto" === d ? null : d, this.minorAutoInterval, (l - h) * c / (p || 1))),
    ...
    let ou = T
      , {erase: og, extend: of, isNumber: om} = tx;
    !function(t) {
        let e;
        function i(t) {
    ...
    let ox = C
      , {addEvent: oy, arrayMax: ob, arrayMin: ov, defined: ok, destroyObjectProperties: oM, erase: ow, fireEvent: oS, merge: oA, objectEach: oT, pick: oC} = tx;
    class oP {
        static compose(t, e) {
        ...
        render() {
            ...
            M["stroke-width"] = oC(e.width, 1),
            e.dashStyle && (M.dashstyle = e.dashStyle)) : b && (M.fill = o || "#e6e9ff",
            u && (M.stroke = e.borderColor,
            M["stroke-width"] = u))),
            l.zIndex = a,
            w += "-" + a,
            (y = t.plotLinesAndBandsGroups[w]) || (t.plotLinesAndBandsGroups[w] = y = n.g("plot-" + w).attr(l).add()),
            m || (this.svgElem = m = n.path().attr(M).add(y)),
            ok(p))
                x = t.getPlotLinePath({
                    value: s?.log2lin(p) ?? p,
            ...
            g && (ok(g.text) || ok(g.formatter)) && x?.length && t.width > 0 && t.height > 0 && !x.isFlat ? (g = oA({
            ...
            this.renderLabel(g, x, b, a)) : f && f.hide(),
            this
        }
        renderLabel(t, e, i, s) {
            let o = this.axis
            ...
            (!n.alignValue || "left" === n.alignValue || ok(a)) && n.css({
        ...
        destroy() {
            ow(this.axis.plotLinesAndBands, this),
            delete this.axis,
            oM(this)
        }
    }
    let {animObject: oO} = eo
      , {format: oE} = eI
      , {composed: oL, dateFormats: oB, doc: oD, isSafari: oI} = V
      , {distribute: oz} = eX
      , {addEvent: oR, clamp: oN, css: oW, clearTimeout: oG, discardElement: oX, extend: oH, fireEvent: oF, getAlignFactor: oY, isArray: oj, isNumber: oU, isObject: oV, isString: o$, merge: o_, pick: oZ, pushUnique: oq, splat: oK, syncTimeout: oJ} = tx;
    class oQ {
        constructor(t, e, i) {
            this.allowShared = !0,
            this.crosshairs = [],
        ...
        getClassName(t, e, i) {
            let s = this.options
              , o = t.series
              , r = o.options;
            return [s.className, "highcharts-label", i && "highcharts-tooltip-header", e ? "highcharts-tooltip-box" : "highcharts-tooltip", !i && "highcharts-color-" + oZ(t.colorIndex, o.colorIndex), r?.className].filter(o$).join(" ")
        }
        getLabel({anchorX: t, anchorY: e}={
            ...
            if (!this.label) {
                if (this.outside) {
                    let t = this.chart
                      ...
                      , i = ez.getRendererType();
                    this.container = a = V.doc.createElement("div"),
            ...
            return a && !a.parentElement && V.doc.body.appendChild(a),
            this.label
        }
        getPlayingField() {
            let {body: t, documentElement: e} = oD
        ...
        getPosition(t, e, i) {
            let {distance: s, chart: o, outside: r, pointer: a} = this, {inverted: n, plotLeft: h, plotTop: l, polar: d} = o, {plotX: c=0, plotY: p=0} = i, u = {}, g = n && i.h || 0, {height: f, width: m} = this.getPlayingField(), x = a.getChartPosition(), y = i => {
                let a = "x" === i;
                return [i, a ? m : f, a ? t : e].concat(r ? [a ? t * x.scaleX : e * x.scaleY, a ? x.left - s + (c + h) * x.scaleX : x.top - s + (p + l) * x.scaleY, 0, a ? m : f] : [a ? t : e, a ? c + h : p + l, a ? h : l, a ? h + o.plotWidth : l + o.plotHeight])
            }
            , b = y("y"), v = y("x"), k, M = !!i.negative;
            !d && o.hoverSeries?.yAxis?.reversed && (M = !M);
            let w = !this.followPointer && oZ(i.ttBelow, !d && !n === M)
              ...
              , C = () => {
                !1 !== S.apply(0, b) ? !1 !== A.apply(0, v) || k || (T(!0),
                C()) : k ? u.x = u.y = 0 : (T(!0),
                C())
            }
            ;
            return (n && !d || this.len > 1) && T(),
            C(),
            u
        }
        ...
        hide(t) {
            let e = this;
            oG(this.hideTimer),
            t = oZ(t, this.options.hideDelay),
            this.isHidden || (this.hideTimer = oJ(function() {
                let i = e.getLabel();
                e.getLabel().animate({
                    opacity: 0
                }, {
        ...
        init(t, e) {
            ...
            this.outside = oZ(e.outside, !!(t.scrollablePixelsX || t.scrollablePixelsY))
        }
        ...
        move(t, e, i, s) {
            let {followPointer: o, options: r} = this
              , a = oO(!o && !this.isHidden && !r.fixed && r.animation)
              , n = o || (this.len || 0) > 1
              , h = {
                x: t,
                y: e
        ...
        refresh(t, e) {
            ...
            if (!s.enabled || !n.series)
                return;
            oG(this.hideTimer),
            this.allowShared = !(!oj(t) && t.series && t.series.noSharedTooltip),
            ...
            n.points = void 0;
            let m = n.series;
            if (this.distance = oZ(m.tooltipOptions.distance, 16),
            !1 === f)
                this.hide();
            else {
        ...
        renderSplit(t, e) {
            let i = this
              , {chart: s, chart: {chartWidth: o, chartHeight: r, plotHeight: a, plotLeft: n, plotTop: h, scrollablePixelsY: l=0, scrollablePixelsX: d, styledMode: c}, distance: p, options: u, options: {fixed: g, position: f, positioner: m}, pointer: x} = i
              , {scrollLeft: y=0, scrollTop: b=0} = s.scrollablePlotArea?.scrollingContainer || {}
              , v = i.outside && "number" != typeof d ? oD.documentElement.getBoundingClientRect() : {
                left: y,
                right: y + o,
                top: b,
                bottom: b + r
              ...
              , P = 0
              , O = a - l
              , E = function(t, e, s, o=[0, 0], r=!0) {
                let a, n;
                if (s.isHeader)
                    n = w ? 0 : O,
                    a = oN(o[0] - t / 2, v.left, v.right - t - (i.outside ? S : 0));
                else if (g && s) {
                    ...
                    n = o[1] - C,
                    a = oN(a = r ? o[0] - t - p : o[0] + p, r ? a : v.left, v.right);
                return {
                    x: a,
                    y: n
                }
                    ...
                    let r = e[o - 1] || {
                      ...
                      , f = d.tt = function(t, e, s) {
                        ...
                        if (!o) {
                            ...
                            t["stroke-width"] = n.borderWidth ?? (g && !r ? 0 : 1)),
                            o = M.label("", 0, 0, n[r ? "headerShape" : "shape"] || (g && !r ? "rect" : "callout"), void 0, void 0, n.useHTML).addClass(i.getClassName(e, !0, r)).attr(t).add(k)
                        }
                        return o.isActive = !0,
                        o.attr({
                            text: s
            ...
            !T && L.some(t => {
                ...
                let {x: e, y: i} = E.call(this, t.boxWidth, t.size, t.point, [t.anchorX, t.anchorY], !1);
                return oH(t, {
                    target: i,
                    x: e
                })
            ...
            L.forEach(function(t) {
                ...
                !o && (i.outside && S + e < B.left && (B.left = S + e),
                !o && i.outside && B.left + s > B.right && (B.right = S + e))
            }),
            L.forEach(function(t) {
        ...
        drawTracker() {
            ...
            o.x = Math.min(0, r[0]),
            o.y = Math.min(0, r[1]),
            o.width = r[0] < 0 ? Math.max(Math.abs(r[0]), a.width - r[0]) : Math.max(Math.abs(r[0]), a.width),
            o.height = r[1] < 0 ? Math.max(Math.abs(r[1]), a.height - Math.abs(r[1])) : Math.max(Math.abs(r[1]), a.height),
            t.tracker ? t.tracker.attr(o) : (t.tracker = i.renderer.rect(o).addClass("highcharts-tracker").add(i),
            oR(t.tracker.element, "mouseenter", () => {
                oG(t.hideTimer)
            }
            ),
        ...
        headerFooterFormatter(t, e) {
            ...
            return oF(this, "headerFormatter", a, function(e) {
                if (r && !n && oU(t.key) && (n = r.getXDateFormat(t.key, s.dateTimeLabelFormats)),
                r && n) {
                    if (oV(n)) {
                        let t = n;
                        oB[0] = e => i.chart.time.dateFormat(t, e),
                        n = "%0"
                    }
                ...
                e.text = oE(h, t, this.chart)
            }),
            a.text || ""
        }
        update(t) {
            this.destroy(),
            this.init(this.chart, o_(!0, this.options, t))
        }
        updatePosition(t) {
            ...
            if (a && i) {
                ...
                a.setSize(oN(h + b, 0, m.documentElement.clientWidth) - 1, n + b, !1),
                (1 !== u || 1 !== g) && (oW(i, {
                    transform: `scale(${u}, ${g})`
                }),
                x *= u,
    ...
    let o0 = oQ
      , {animObject: o1} = eo
      , {defaultOptions: o2} = tY
      , {format: o3} = eI
      , {addEvent: o5, crisp: o6, erase: o9, extend: o4, fireEvent: o8, getNestedProperty: o7, isArray: rt, isFunction: re, isNumber: ri, isObject: rs, merge: ro, pick: rr, syncTimeout: ra, removeEvent: rn, uniqueKey: rh} = tx;
    class rl {
        constructor(t, e, i) {
        ...
        applyOptions(t, e) {
            ...
            return o4(this, t = rl.prototype.optionsToObject.call(this, t)),
            this.options = this.options ? o4(this.options, t) : t,
            t.group && delete this.group,
            t.dataLabels && delete this.dataLabels,
            s && (this.y = rl.prototype.getNestedProperty.call(this, s)),
            this.selected && (this.state = "select"),
            "name"in this && void 0 === e && i.xAxis && i.xAxis.hasNames && (this.x = i.xAxis.nameToX(this)),
            void 0 === this.x && i ? this.x = e ?? i.autoIncrement() : ri(t.x) && i.options.relativeXValue ? this.x = i.autoIncrement(t.x) : "string" == typeof this.x && (e ?? (e = i.chart.time.parse(this.x)),
            ri(e) && (this.x = e)),
        ...
        destroy() {
            if (!this.destroyed) {
                let t = this
                  ...
                  , o = i.hoverPoints
                  , r = o1(t.series.chart.renderer.globalAnimation)
                  , a = () => {
                    for (let e in (t.graphic || t.graphics || t.dataLabel || t.dataLabels) && (rn(t),
                    t.destroyElements()),
                    t)
                        delete t[e]
                }
        ...
        getNestedProperty(t) {
            if (t)
                return 0 === t.indexOf("custom.") ? o7(t, this.options) : this[t]
        }
        getZone() {
        ...
        optionsToObject(t) {
            ...
            if (ri(t) || null === t)
                ...
                n++); h < o; )
                    i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? rl.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]),
                    n++,
                    h++;
            else
                "object" == typeof t && (r = t,
        ...
        resolveColor() {
            ...
            a = t.colorIndex),
            this.colorIndex = rr(this.options.colorIndex, a),
            this.color = rr(this.options.color, s)
        }
        setNestedProperty(t, e, i) {
            return i.split(".").reduce(function(t, i, s, o) {
                let r = o.length - 1 === s;
                return t[i] = r ? e : rs(t[i], !0) ? t[i] : {},
                t[i]
            }, t),
            t
        }
        ...
        update(t, e, i, s) {
            ...
            function d() {
                ...
                rs(t, !0) && (n?.element && t && t.marker && void 0 !== t.marker.symbol && (r.graphic = n.destroy()),
                ...
                l.data[o] = rs(l.data[o], !0) || rs(t, !0) ? r.options : rr(t, l.data[o]),
        ...
        manageEvent(t) {
            let e = ro(this.series.options.point, this.options)
              , i = e.events?.[t];
            re(i) && (!this.hcEvents?.[t] || this.hcEvents?.[t]?.map(t => t.fn).indexOf(i) === -1) ? (this.importedUserEvent?.(),
            this.importedUserEvent = o5(this, t, i),
            this.hcEvents && (this.hcEvents[t].userEvent = !0)) : this.importedUserEvent && !i && this.hcEvents?.[t] && this.hcEvents?.[t].userEvent && (rn(this, t),
        ...
        setState(t, e) {
            ...
            this.graphic && !this.hasMockGraphic) {
                ...
                !d.styledMode) {
                    g = i.pointAttribs(this, t),
                    f = rr(d.options.chart.animation, o.animation);
                    let e = g.opacity;
                ...
                u && this.graphic.animate(u, rr(d.options.chart.animation, n.animation, r.animation)),
                m && m.hide()
            } else
                t && n && (x = l.symbol || i.symbol,
                m && m.currentSymbol !== x && (m = m.destroy()),
                u && (m ? m[e ? "animate" : "attr"]({
                    x: u.x,
                    y: u.y
                }) : x && (i.stateMarkerGraphic = m = d.renderer.symbol(x, u.x, u.y, u.width, u.height, ro(r, n)).add(i.markerGroup),
                m.currentSymbol = x)),
    ...
    let rd = rl
      , {parse: rc} = tJ
      , {charts: rp, composed: ru, isTouchDevice: rg} = V
      , {addEvent: rf, attr: rm, css: rx, extend: ry, find: rb, fireEvent: rv, isNumber: rk, isObject: rM, objectEach: rw, offset: rS, pick: rA, pushUnique: rT, splat: rC} = tx;
    class rP {
        ...
        destroy() {
            ...
            this.eventsToUnbind = [],
            !V.chartCount && (rP.unbindDocumentMouseUp.forEach(t => t.unbind()),
            rP.unbindDocumentMouseUp.length = 0,
            rP.unbindDocumentTouchEnd && (rP.unbindDocumentTouchEnd = rP.unbindDocumentTouchEnd())),
            rw(t, function(e, i) {
                t[i] = void 0
            })
        }
        ...
        drag(t) {
            ...
            if ((!m || !m.touch) && (u < n ? u = n : u > n + l && (u = n + l),
            g < h ? g = h : g > h + d && (g = h + d),
        ...
        getSelectionBox(t) {
            ...
            return rv(this, "getSelectionBox", e),
            e.result
        }
        drop(t) {
        ...
        findNearestKDPoint(t, e, i) {
            ...
            return t.forEach(function(t) {
                ...
                rM(l, !0) && l.series && (!rM(s, !0) || (r = (o = s).distX - l.distX,
                a = o.dist - l.dist,
                n = l.series.group?.zIndex - o.series.group?.zIndex,
                (0 !== r && e ? r : 0 !== a ? a : 0 !== n ? n : o.series.index > l.series.index ? -1 : 1) > 0)) && (s = l)
            }),
            s
        }
        getChartCoordinatesFromPoint(t, e) {
            ...
            if (i && s) {
                let r = t.clientX ?? t.plotX ?? 0
                  , a = t.plotY || 0;
                return t.isNode && o && rk(o.x) && rk(o.y) && (r = o.x,
                a = o.y),
                e ? {
        ...
        getHoverData(t, e, i, s, o, r) {
            ...
            c && (o && !h.noSharedTooltip ? (l = i.filter(function(t) {
                ...
                let e = t.options?.nullInteraction
                  , i = rb(t.points, function(t) {
                    return t.x === c.x && (!t.isNull || !!e)
                });
                rM(i) && (t.boosted && t.boost && (i = t.boost.getPoint(i)),
                a.push(i))
            }) : a.push(c)),
            rv(this, "afterGetHoverData", d = {
                hoverPoint: c
            }),
            {
        ...
        normalize(t, e) {
            let i = t.touches
              , s = i ? i.length ? i.item(0) : rA(i.changedTouches, t.changedTouches)[0] : t;
        ...
        onContainerClick(t) {
            ...
            e.hoverPoint && i.firePointEvent("click", s)) : (ry(s, this.getCoordinates(s)),
        ...
        onContainerMouseDown(t) {
            ...
            t = this.normalize(t),
            V.isFirefox && 0 !== t.button && this.onContainerMouseMove(t),
        ...
        onDocumentMouseUp(t) {
            ...
            rp[rA(rP.hoverChartIndex, -1)]?.pointer?.drop(t)
        }
        pinch(t) {
            let e = this
        ...
        runPointActions(t, e, i) {
            ...
            this.unDocMouseMove || (this.unDocMouseMove = rf(s.container.ownerDocument, "mousemove", t => rp[rP.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)),
            this.eventsToUnbind.push(this.unDocMouseMove)),
            s.axes.forEach(function(e) {
                let i, o = e.crosshair?.snap ?? !0;
                o && ((i = s.hoverPoint) && i.series[e.coll] === e || (i = rb(c, t => t.series?.[e.coll] === e))),
        ...
        setDOMEvents() {
            ...
            this.eventsToUnbind.push(rf(t, "mouseenter", this.onContainerMouseEnter.bind(this)), rf(t, "mouseleave", this.onContainerMouseLeave.bind(this))),
            rP.unbindDocumentMouseUp.some(t => t.doc === e) || rP.unbindDocumentMouseUp.push({
                doc: e,
                unbind: rf(e, "mouseup", this.onDocumentMouseUp.bind(this))
            });
            let s = i(this.chart.renderTo);
            for (; s && "BODY" !== s.tagName; )
                this.eventsToUnbind.push(rf(s, "scroll", () => {
                    delete this.chartPosition
                }
                )),
                s = i(s);
            ...
            rf(this.chart, "redraw", this.setPointerCapture.bind(this))
        }
        setPointerCapture() {
            if (!rg)
                return;
            let t = this.pointerCaptureEventsToUnbind
              , e = this.chart
              , i = e.container
              , s = rA(e.options.tooltip?.followTouchMove, !0) && e.series.some(t => t.options.findNearestPointBy.indexOf("y") > -1);
        ...
        setHoverChartIndex(t) {
            let e = this.chart
              , i = V.charts[rA(rP.hoverChartIndex, -1)];
            if (i && i !== e) {
                let s = {
        ...
        touch(t, e) {
            ...
            "touchmove" === t.type && (this.hasPinchMoved = i = !!o[0] && Math.pow(o[0].chartX - t.chartX, 2) + Math.pow(o[0].chartY - t.chartY, 2) >= 16),
            rA(i, !0) && this.pinch(t)) : e && this.reset() : 2 === t.touches.length && this.pinch(t)
        }
        touchSelect(t) {
        ...
        zoomOption(t) {
            ...
            /touch/.test(t.type) && (s = rA(e.zooming.pinchType, s)),
    ...
    rP.unbindDocumentMouseUp = [],
    (g = rP || (rP = {})).compose = function(t) {
    ...
    ;
    let {setLength: rE, splice: rL} = P
      , {fireEvent: rB, objectEach: rD, uniqueKey: rI} = tx
      , rz = class {
        constructor(t={}) {
            this.autoId = !t.id,
            this.columns = {},
        ...
        setColumns(t, e, i) {
            ...
            i?.silent || (rB(this, "afterSetColumns"),
            this.versionTag = rI())
        }
        setRow(t, e=this.rowCount, i, s) {
            ...
            rD(o, (a, n) => {
                a || s?.addColumns === !1 || (a = Array(r)),
                a && (i ? a = rL(a, e, 0, !0, [t[n] ?? null]).array : a[e] = t[n] ?? null,
                o[n] = a)
            }
            ),
            r > this.rowCount && this.applyRowCount(r),
            s?.silent || (rB(this, "afterSetRows"),
            this.versionTag = rI())
        }
        getModified() {
    ...
    function rX(t, e, i) {
        ...
        if (o.styledMode || (g["stroke-width"] = Math.min(r.lineWidth || 0, 24),
        r.dashStyle ? g.dashstyle = r.dashStyle : "square" !== r.linecap && (g["stroke-linecap"] = "round")),
        ...
        if (m && !1 !== m.enabled && n) {
            ...
            t = 0),
            s.symbol = f = c.symbol(l, n / 2 - t, u - t, 2 * t, 2 * t, rR({
                context: "legend"
    ...
    ;
    let rH = O
      , {defaultOptions: rF} = tY
      , {extend: rY, extendClass: rj, merge: rU} = tx;
    var rV = E || (E = {});
    function r$(t, e) {
        let i = rF.plotOptions || {}
          , s = e.defaultOptions
          , o = e.prototype;
        return o.type = t,
        o.pointClass || (o.pointClass = rd),
        !rV.seriesTypes[t] && (s && (i[t] = s),
        rV.seriesTypes[t] = e,
        !0)
    }
    rV.seriesTypes = V.seriesTypes,
    rV.registerSeriesType = r$,
    rV.seriesType = function(t, e, i, s, o) {
        let r = rF.plotOptions || {};
        if (e = e || "",
        r[t] = rU(r[e], i),
        delete rV.seriesTypes[t],
        r$(t, rj(rV.seriesTypes[e] || V.Series, s)),
        rV.seriesTypes[t].prototype.type = t,
        o) {
            class e extends rd {
            }
            rY(e.prototype, o),
            rV.seriesTypes[t].prototype.pointClass = e
        }
        return rV.seriesTypes[t]
    }
    ;
    let r_ = E
      , {animObject: rZ, setAnimation: rq} = eo
      , {defaultOptions: rK} = tY
      , {registerEventOptions: rJ} = sS
      , {svg: rQ, win: r0} = V
      , {seriesTypes: r1} = r_
      , {format: r2} = eI
      , {arrayMax: r3, arrayMin: r5, clamp: r6, correctFloat: r9, crisp: r4, defined: r8, destroyObjectProperties: r7, diffObjects: at, erase: ae, error: ai, extend: as, find: ao, fireEvent: ar, getClosestDistance: aa, getNestedProperty: an, insertItem: ah, isArray: al, isNumber: ad, isString: ac, merge: ap, objectEach: au, pick: ag, removeEvent: af, syncTimeout: am} = tx;
    class ax {
        constructor() {
            this.zoneAxis = "y"
        }
            ...
            ar(this, "bindAxes", null, function() {
                (e.axisTypes || []).forEach(function(o) {
                    (s[o] || []).forEach(function(s) {
                        t = s.options,
                        (ag(i[o], 0) === s.index || void 0 !== i[o] && i[o] === t.id) && (ah(e, s.series),
                        e[o] = s,
                        s.isDirty = !0)
                    }),
        ...
        autoIncrement(t) {
            ...
            if (this.pointInterval = e = ag(this.pointInterval, i.pointInterval, 1),
            o && ad(t) && (e *= t),
            s) {
                let t = r.toParts(a);
            ...
            return o && ad(t) ? a + e : (this.xIncrement = a + e,
            a)
        }
        ...
        setOptions(t) {
            ...
            let h = n.plotOptions[this.type]
              , l = o.plotOptions || {}
              , d = l.series || {}
              , c = rK.plotOptions[this.type] || {}
              , p = l[this.type] || {};
            h.dataLabels = this.mergeArrays(c.dataLabels, h.dataLabels),
            this.userOptions = n.userOptions;
            let u = ap(h, s.series, p, r);
            this.tooltipOptions = ap(rK.tooltip, rK.plotOptions.series?.tooltip, c?.tooltip, i.userOptions.tooltip, l.series?.tooltip, p.tooltip, r.tooltip),
            this.stickyTracking = ag(r.stickyTracking, p.stickyTracking, d.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || u.stickyTracking),
            null === h.marker && delete u.marker,
            this.zoneAxis = u.zoneAxis || "y";
            ...
            a || (e.color = u.negativeColor,
            e.fillColor = u.negativeFillColor),
            g.push(e)),
            g.length && r8(g[g.length - 1].value) && g.push(a ? {} : {
                color: this.color,
        ...
        getCyclic(t, e, i) {
            ...
            !e && (r8(o = ag("color" === t ? this.options.colorIndex : void 0, this[a])) ? s = o : (r.series.length || (r[n] = 0),
            s = r[n] % h,
            r[n] += 1),
            i && (e = i[s])),
            void 0 !== s && (this[a] = s),
        ...
        findPointIndex(t, e) {
            ...
            void 0 === o && ad(a) && (o = this.getColumn("x").indexOf(a, e)),
            -1 !== o && void 0 !== o && this.cropped && (o = o >= l ? o - l : o),
            !s && ad(o) && n[o]?.touched && (o = void 0),
            o
        }
        updateData(t, e) {
            ...
            t.forEach( (t, e) => {
                ...
                c || ad(u) ? (-1 === (h = this.findPointIndex(d, p)) || void 0 === h ? a.push(t) : r[h] && t !== i.data?.[h] ? (r[h].update(t, !1, void 0, !1),
                r[h].touched = !0,
                s && (p = h + 1)) : r[h] && (r[h].touched = !0),
                (!n || e !== h || o?.enabled || this.hasDerivedData) && (l = !0)) : a.push(t)
            }
            , this),
            l)
                for (d = r.length; d--; )
                    (c = r[d]) && !c.touched && c.remove?.(!1, e);
            else
            ...
            return null !== h && null === this.xIncrement && g.length && (this.xIncrement = r3(g),
            this.autoIncrement()),
            !0
        }
        dataColumnKeys() {
        ...
        setData(t, e=!0, i, s) {
            ...
            !x) {
                ...
                for (ac(this.getColumn("y")[0]) && ai(14, !0, n),
                this.data = [],
        ...
        getProcessedData(t) {
            ...
            return r && (g = (u = r.getExtremes()).min,
            f = u.max,
            y = !!(r.categories && !r.names.length),
            s && e.sorted && !n && (!a || l > a || e.forceCrop) && (m[l - 1] < g || m[0] > f ? x = new rz : e.getColumn(e.pointValKey || "y").length && (m[0] < g || m[l - 1] > f) && (x = (d = this.cropData(i, g, f)).modified,
            p = d.start,
            c = !0))),
            m = x.getColumn("x") || [],
            {
                ...
                cropped: c,
                cropStart: p,
                closestPointRange: aa([h ? m.map(h.log2lin) : m], () => e.requireSorting && !y && ai(15, !1, e.chart))
            }
        }
        processData(t) {
            let e = this.xAxis
        ...
        generatePoints() {
            let t = this.options, e = this.processedData || t.data, i = this.dataTable.getModified(), s = this.getColumn("x", !0), o = this.pointClass, r = i.rowCount, a = this.cropStart || 0, n = this.hasGroupedData, h = t.keys, l = [], d = t.dataGrouping?.groupAll ? a : 0, c = this.pointArrayMap || ["y"], p = this.dataColumnKeys(), u, g, f, m, x = this.data, y;
            if (!x && !n) {
                let t = [];
                t.length = e?.length || 0,
                x = this.data = t
            ...
            m = 0; m < r; m++)
                g = a + m,
                n ? ((f = new o(this,i.getRow(m, p) || [])).dataGroup = this.groupMap?.[d + m],
                f.dataGroup?.options && (f.options = f.dataGroup.options,
                as(f, f.dataGroup.options),
                delete f.dataLabels,
                f.key = f.name ?? f.category)) : (f = x[g],
                y = e ? e[g] : i.getRow(m, c),
                f || void 0 === y ? f && (f.category = this.xAxis?.categories?.[f.x] ?? f.x,
                f.key = f.name ?? f.category) : x[g] = f = new o(this,y,s[m])),
                f && (f.index = n ? d + m : g,
                l[m] = f);
            ...
            x && (r !== (u = x.length) || n))
                for (m = 0; m < u; m++)
                    m !== a || n || (m += r),
                    x[m] && (x[m].destroyElements(),
                    x[m].plotX = void 0);
            this.data = x,
            this.points = l,
            ar(this, "afterGeneratePoints")
        }
        getXExtremes(t) {
            return {
                min: r5(t),
        ...
        getExtremes(t, e) {
            ...
            for (i && (x = (g = i.getExtremes()).min,
            y = g.max),
            m = 0; m < a; m++)
                if (f = l[m],
                u || (l[m + c] || f) >= x && (l[m - c] || f) <= y)
                    for (let t of h) {
                        let e = t[m];
                        ad(e) && (e > 0 || !p) && d.push(e)
                    }
        ...
        translate() {
            ...
            for (p = 0; p < a; p++) {
                ...
                a.plotX = ad(u = i.translate(y, !1, !1, !1, !0, n)) ? r9(x(u)) : void 0,
                e && this.visible && w && w[y] && (f = this.getStackIndicator(f, y, this.index),
                !a.isNull && f.key && (v = (b = w[y]).points[f.key]),
                b && al(v) && (M = v[0],
                k = v[1],
                M === d && f.key === w[y].base && (M = ag(ad(l) ? l : o.min)),
                o.positiveValuesOnly && r8(M) && M <= 0 && (M = void 0),
                a.total = a.stackTotal = ag(b.total),
                a.percentage = r8(a.y) && b.total ? a.y / b.total * 100 : void 0,
                a.stackY = k,
                this.irregularWidths || b.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis))),
                a.yBottom = r8(M) ? x(o.translate(M, !1, !0, !1, !0)) : void 0,
                this.dataModify && (k = this.dataModify.modifyValue(k, p)),
                ad(k) && void 0 !== a.plotX ? t = ad(t = o.translate(k, !1, !0, !1, !0)) ? x(t) : void 0 : !ad(k) && c && (t = c),
                a.plotY = t,
                a.isInside = this.isPointInside(a),
                a.clientX = h ? r9(i.translate(y, !1, !1, !1, !0, n)) : u,
        ...
        afterAnimate() {
            this.setClip(),
            au(this.chart.sharedClips, (t, e, i) => {
            ...
            if (!1 !== p.enabled || this._hasPointMarkers)
                for (e = 0; e < t.length; e++) {
                    ...
                    if ((m && !r8(r.enabled) || r.enabled) && (!c || u) && !1 !== i.visible) {
                        ...
                        let e = !1 !== i.isInside;
                        if (!s && e && ((n.width || 0) > 0 || i.hasImage) && (i.graphic = s = h.renderer.symbol(t, n.x, n.y, n.width, n.height, a ? r : p).add(g),
        ...
        markerAttribs(t, e) {
            ...
            l = ag(h?.radius, n?.radius, l && l + (n?.radiusPlus || 0))),
            t.hasImage = r && 0 === r.indexOf("url"),
            t.hasImage && (l = 0);
            let d = t.pos();
            return ad(l) && d && (i.crisp && (d[0] = r4(d[0], t.hasImage ? 0 : "rect" === r ? s?.lineWidth || 0 : 1)),
            a.x = d[0] - l,
            a.y = d[1] - l),
        ...
        pointAttribs(t, e) {
            ...
            e = e || "normal",
            l = s.states[e] || {},
            g = ag((d = r.states && r.states[e] || {}).lineWidth, l.lineWidth, g + ag(d.lineWidthPlus, l.lineWidthPlus, 0)),
        ...
        destroy(t) {
            ...
            for (let t of s.zones)
                r7(t, void 0, !0);
            tx.clearTimeout(s.animationTimeout),
            au(s, function(t, e) {
        ...
        applyZones() {
            ...
            if (s.length && (i || t) && d && ad(d.min)) {
                ...
                if (s.forEach(t => {
                    t.lineClip = [],
                    t.translated = r6(d.toPixels(ag(t.value, e), !0) || 0, 0, p)
                }
                ),
        ...
        plotGroup(t, e, i, s, o) {
            ...
            return r8(this.opacity) && !this.chart.styledMode && "inactive" !== this.state && (n.opacity = this.opacity),
            r || (this[t] = r = this.chart.renderer.g().add(o)),
            r.addClass("highcharts-" + e + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (r8(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (r.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0),
        ...
        searchKDTree(t, e, i, s, o) {
            ...
            this.kdTree)
                return function t(e, i, s, o) {
                    ...
                    l = e[a],
                    u = b[a],
                    g = r8(l) && r8(u) ? l - u : null,
                    f = e[n],
                    m = b[n],
                    x = r8(f) && r8(m) ? f - m : 0,
                    y = d && b.marker?.radius || 0,
                    b.dist = Math.sqrt((g && g * g || 0) + x * x) - y,
                    b.distX = r8(g) ? Math.abs(g) - y : Number.MAX_VALUE;
                    let w = (e[v] || 0) - (b[v] || 0) + (d && b.marker?.radius || 0)
                      , S = w < 0 ? "left" : "right"
                      , A = w < 0 ? "right" : "left";
                    return i[S] && ([k,M] = c(b, t(e, i[S], s + 1, o), h)),
        ...
        pointPlacementToXValue() {
            ...
            ad(i) ? i * (t.pointRange || e.pointRange) : 0
        }
        isPointInside(t) {
        ...
        drawTracker() {
            let t = this
              ...
              , l = "rgba(192,192,192," + (rQ ? 1e-4 : .002) + ")"
              , d = t.tracker;
            d ? d.attr({
                d: s
        ...
        addPoint(t, e, i, s, o) {
            ...
            i && (l[0] && l[0].remove ? l[0].remove(!1) : ([l, u].filter(r8).forEach(t => {
                t.shift()
            }
            ),
            d.deleteRows(0))),
            !1 !== o && ar(this, "addPoint", {
                point: f
            }),
            this.isDirty = !0,
            this.isDirtyData = !0,
        ...
        removePoint(t, e, i) {
            let s = this
              ...
              , h = r[t]
              , l = function() {
                [a?.length === r.length ? a : void 0, r, s.options.data].filter(r8).forEach(e => {
                    e.splice(t, 1)
                }
                ),
                n.deleteRows(t),
        ...
        update(t, e) {
            ...
            let i = this, s = i.chart, o = i.userOptions, r = i.initialType || i.type, a = s.options.plotOptions, n = r1[r].prototype, h = i.finishedAnimating && {
                animation: !1
            }, l = {}, d, c, p = ax.keepProps.slice(), u = t.type || o.type || s.options.chart.type, g = !(this.hasDerivedData || u && u !== this.type || void 0 !== t.keys || void 0 !== t.pointStart || void 0 !== t.pointInterval || void 0 !== t.relativeXValue || t.joinBy || t.mapData || ["dataGrouping", "pointStart", "pointInterval", "pointIntervalUnit", "keys"].some(t => i.hasOptionChanged(t)));
            u = u || r,
            g ? (p.push.apply(p, ax.keepPropsForPoints),
            !1 !== t.visible && p.push("area", "graph"),
            i.parallelArrays.forEach(function(t) {
                p.push(t + "Data")
            }),
            t.data && (t.dataSorting && as(i.options.dataSorting, t.dataSorting),
            this.setData(t.data, !1))) : this.dataTable.modified = this.dataTable,
            t.dataLabels && o.dataLabels && (t.dataLabels = this.mergeArrays(o.dataLabels, t.dataLabels)),
            t = ap(o, {
            ...
            (p = ["dataLabelsGroup", "dataLabelsGroups", "dataLabelsParentGroups", "group", "markerGroup", "transformGroup"].concat(p)).forEach(function(t) {
                p[t] = i[t],
                delete i[t]
            });
            let f = !1;
            if (r1[u]) {
                ...
                f)
                    ...
                    Object.setPrototypeOf)
                        Object.setPrototypeOf(i, r1[u].prototype);
                    else {
        ...
        onMouseOut() {
            ...
            e.hoverSeries = null,
            s && s.onMouseOut(),
            this && t.events.mouseOut && ar(this, "mouseOut"),
        ...
        setState(t, e) {
            let i = this
              ...
              , n = ag(a?.[t || "normal"]?.animation, i.chart.options.chart.animation)
              , {lineWidth: h, opacity: l} = o;
            if (t = t || "",
            i.state !== t && ([i.group, i.markerGroup, ...i.dataLabelsGroups || []].forEach(function(e) {
            ...
            !i.chart.styledMode)) {
                ...
                r || [i.group, i.markerGroup, ...i.dataLabelsGroups || [], i.labelBySeries].forEach(function(t) {
                    t?.animate({
                        opacity: l
                    }, n)
                })
    ...
    ax.registerType = r_.registerSeriesType,
    ax.keepProps = ["colorIndex", "eventOptions", "navigatorSeries", "symbolIndex", "baseSeries"],
    ax.keepPropsForPoints = ["data", "isDirtyData", "isDirtyCanvas", "points", "dataTable", "processedData", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX", "transformGroups"],
    as(ax.prototype, {
    ...
    r_.series = ax;
    let ay = ax
      , {animObject: ab, setAnimation: av} = eo
      , {registerEventOptions: ak} = sS
      , {composed: aM, marginNames: aw} = V
      , {distribute: aS} = eX
      , {format: aA} = eI
      , {addEvent: aT, createElement: aC, css: aP, defined: aO, discardElement: aE, find: aL, fireEvent: aB, isNumber: aD, merge: aI, pick: az, pushUnique: aR, relativeLength: aN, stableSort: aW, syncTimeout: aG} = tx;
    class aX {
        constructor(t, e) {
            this.allItems = [],
            this.initialItemY = 0,
            ...
            ak(this, e),
            aT(this.chart, "endResize", function() {
        ...
        update(t, e) {
            let i = this.chart;
            this.setOptions(aI(!0, this.options, t)),
            "events"in this.options && ak(this, this.options),
            this.destroy(),
        ...
        colorizeItem(t, e) {
            ...
            if ((t instanceof ay || t instanceof rd) && (t.color = t.options?.legendSymbolColor || i),
        ...
        renderItem(t) {
            ...
            i.styledMode || y.css(aI(t.visible ? h : l)),
            y.attr({
                align: c ? "left" : "right",
                zIndex: 2
            }).add(e.group),
            ...
            this.symbolHeight = az(o.symbolHeight, this.fontMetrics.f),
            o.squareSymbol && (this.symbolWidth = az(o.symbolWidth, Math.max(this.symbolHeight, 16)),
        ...
        adjustMargins(t, e) {
            ...
            o && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach( (r, a) => {
                r.test(o) && !aO(t[a]) && (i[aw[a]] = Math.max(i[aw[a]], i.legend[(a + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][a] * s[a % 2 ? "x" : "y"] + (s.margin ?? 12) + e[a] + (i.titleOffset[a] || 0)))
            }
            )
        }
        proximatePositions() {
            ...
            for (let o of (this.allItems.forEach(function(t) {
                ...
                t.points && (o = aL(a ? t.points : t.points.slice(0).reverse(), function(t) {
                    return aD(t.plotY)
                })),
            ...
            aS(i, e.plotHeight)))
                t = o.item.legendItem || {},
                aD(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos)
        }
        render() {
            ...
            this.offsetWidth = 0,
            this.lastItemY = 0,
            this.widthOption = aN(s.width, e - o),
            d = e - 2 * o - s.x,
            ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) > -1 && (d /= 2),
            this.maxLegendWidth = this.widthOption || d,
            l || (this.group = l = i.g("legend").addClass(s.className || "").attr({
                zIndex: 7
            }).add(),
            this.contentGroup = i.g().attr({
                zIndex: 1
            }).add(l),
            this.scrollGroup = i.g().add(this.contentGroup)),
            this.renderTitle(),
            aW(r, (t, e) => (t.options?.legendIndex || 0) - (e.options?.legendIndex || 0)),
            ...
            n = (s.maxWidth ? Math.min(this.widthOption || this.offsetWidth, d, aN(s.maxWidth, t.chartWidth) || 1 / 0) : this.widthOption || this.offsetWidth) + o,
            h = this.lastItemY + this.lastLineHeight + this.titleHeight,
            h = this.handleOverflow(h) + o,
            c || (this.box = c = i.rect().addClass("highcharts-legend-box").attr({
                r: s.borderRadius
            }).add(l)),
            t.styledMode || c.attr({
            ...
            n > 0 && h > 0 && c[c.placed ? "animate" : "attr"](c.crisp.call({}, {
                x: 0,
                y: 0,
                width: n,
                height: h
        ...
        handleOverflow(t) {
            ...
            this.currentPage = az(this.currentPage, 1),
            this.fullHeight = t,
            u.forEach( (t, e) => {
                ...
                y.pageIx = o - 1,
                x && b && (b.pageIx = o - 1),
                e === u.length - 1 && i + s - p[o - 1] > m && i > p[o - 1] && (p.push(i),
                y.pageIx = o),
                i !== x && (x = i),
                b = y
            }
            ),
            M || (M = e.clipRect = s.clipRect(0, n - 2, 9999, 0),
            e.contentGroup.clip(M)),
            g(m),
        ...
        setItemEvents(t, e, i) {
            ...
            for (let i of d)
                i && i.on("mouseover", function() {
                    ...
                    s.chart.styledMode || e.css(aI(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                    c(""),
                    r.removeClass(h),
                    t.setState()
                }).on("click", function(e) {
        ...
        createCheckboxForItem(t) {
            ...
            aT(t.checkbox, "click", function(e) {
                let i = e.target;
    ...
    class nx {
        ...
        constructor(t, e, i) {
            this.sharedClips = {};
            const s = [...arguments];
            (nn(t) || t.nodeName) && (this.renderTo = s.shift()),
            this.init(s[0], s[1])
        }
        setZoomOptions() {
        ...
        init(t, e) {
            ne(this, "init", {
                ...
                this.userOptions = a7({}, t),
                (this.renderTo = nn(o) ? aZ.getElementById(o) : o) || a8(13, !0, this),
                this.margin = [],
                this.spacing = [],
                ...
                this.time = new tN(a7(i.time || {}, {
                    locale: this.locale
                }),i.lang),
                i.time = this.time.options,
                this.numberFormatter = (s.numberFormatter || aV).bind(this),
                this.styledMode = s.styledMode,
                this.hasCartesianSeries = s.showAxes,
                this.index = a_.length,
                a_.push(this),
                V.chartCount++,
                a$(this, s),
                this.xAxis = [],
        ...
        orderItems(t, e=0) {
            let i = this[t]
              , s = this.options[t] = ng(this.options[t]).slice()
              , o = this.userOptions[t] = this.userOptions[t] ? ng(this.userOptions[t]).slice() : [];
            ...
            i)
                for (let t = e, r = i.length; t < r; ++t) {
                    let e = i[t];
                    e && (e.index = t,
                    e instanceof ay && (e.name = e.getName()),
        ...
        getClipBox(t, e) {
            let i = this.inverted
              , {xAxis: s, yAxis: o} = t || {}
              , {x: r, y: a, width: n, height: h} = nh(this.clipBox);
        ...
        isInsidePlot(t, e, i={}) {
            ...
            return ne(this, "afterIsInsidePlot", g),
            g.isInsidePlot
        }
        redraw(t) {
            ...
            i.forEach(function(t) {
                ...
                u = !0) : r && (r.labelFormatter || r.labelFormat) && (u = !0)),
                t.isDirtyData && ne(t, "updatedData")
            }),
            u && o && o.options.enabled && (o.render(),
            ...
            e.forEach(function(t) {
                ...
                h.push(function() {
                    ne(t, "afterSetExtremes", a7(t.eventArgs, t.getExtremes())),
                    delete t.eventArgs
                })),
                (p || d) && t.redraw()
            }),
        ...
        applyDescription(t, e) {
            let i = this
              , s = this.options[t] = nh(this.options[t], e)
              , o = this[t];
            ...
            ["title", "subtitle", "caption"].forEach(t => {
                ...
                if (i && r) {
                    ...
                    let o = s.fontMetrics(i)
                      ...
                      , x = (r.width || (g > p ? this.chartWidth : a.width) / f) + "px";
        ...
        getChartSize() {
            ...
            this.chartHeight = Math.max(0, np(i, this.chartWidth) || (o ? 400 : s.height)),
            this.containerBox = s
        }
        temporaryDisplay(t) {
            ...
            if (t)
                for (; e?.style; )
                    e.hcOrigStyle && (a3(e, e.hcOrigStyle),
                    delete e.hcOrigStyle),
                    e.hcOrigDetached && (aZ.body.removeChild(e),
                    e.hcOrigDetached = !1),
                    e = e.parentNode;
            else
                for (; e?.style && (aZ.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0,
                aZ.body.appendChild(e)),
                ("none" === ns(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
        ...
        getContainer() {
            ...
            nr(a) && a_[a] && a_[a].hasRendered && a_[a].destroy(),
            a1(r, s, this.index),
            r.innerHTML = ey.emptyHTML,
            ...
            ne(this, "afterGetContainer")
        }
        getMargins(t) {
            let {spacing: e, margin: i, titleOffset: s} = this;
            this.resetMargins(),
            s[0] && !a5(i[0]) && (this.plotTop = Math.max(this.plotTop, s[0] + e[0])),
            s[2] && !a5(i[2]) && (this.marginBottom = Math.max(this.marginBottom, s[2] + e[2])),
        ...
        reflow(t) {
            ...
            !e.exporting?.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && (tx.clearTimeout(e.reflowTimeout),
            e.reflowTimeout = nf(function() {
        ...
        drawChartBox() {
            ...
            r.animate(u)) : this.plotBGImage = e.image(h, l, d, c, p).add())),
            g ? g.animate({
                width: f.width,
                height: f.height
            ...
            y[M](y.crisp(u, -y.strokeWidth())),
            this.isDirtyBox = !1,
            ne(this, "afterDrawChartBox")
        }
        propFromSeries() {
            ...
            ["inverted", "angular", "polar"].forEach(function(a) {
                ...
                t = r?.length; !i && t--; )
                    (e = aQ[r[t].type]) && e.prototype[a] && (i = !0);
                s[a] = i
            })
        }
        linkSeries(t) {
            ...
            i.forEach(function(t) {
                let {linkedTo: s} = t.options
                  , o = nn(s) && (":previous" === s ? i[t.index - 1] : e.get(s));
                o && o.linkedParent !== t && (o.linkedSeries.push(t),
                t.linkedParent = o,
                o.enabledDataSorting && t.setDataSortingOptions(),
            ...
            t)) {
                ...
                if (this.hasCartesianSeries && e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !this.polar) {
                    ...
                    let s = new sN(e,0,"",!0)
                      , o = s.createLabel("x", i);
                    if (s.destroy(),
                    o && nd(i.reserveSpace, !nr(t.crossing)) && (r = o.getBBox().height + i.distance + Math.max(t.offset || 0, 0)),
                    r) {
                        o?.destroy();
                        break
                    }
        ...
        destroy() {
            ...
            for (ne(e, "destroy"),
            e.renderer.forExport ? a4(a_, e) : a_[e.index] = void 0,
            V.chartCount--,
        ...
        createAxis(t, e) {
            ...
            return nd(e.redraw, !0) && this.redraw(e.animation),
            i
        }
        showLoading(t) {
            let e = this
            ...
            a || (e.loadingSpan = a = a2("span", {
                className: "highcharts-loading-inner"
            }, null, r),
            a0(e, "redraw", o)),
            r.className = "highcharts-loading",
            ey.setElementHTML(a, nd(t, i.lang.loading, "")),
            !e.styledMode && (a3(r, a7(s.style, {
                zIndex: 10
            })),
            a3(a, s.labelStyle),
            e.loadingShown || (a3(r, {
        ...
        update(t, e, i, s) {
            ...
            nl(t, function(e, i) {
                n[i] && "function" == typeof n[i].update ? n[i].update(e, !1) : "function" == typeof n[h[i]] ? n[h[i]](e) : "colors" !== i && -1 === n.collectionsWithUpdate.indexOf(i) && nh(!0, n.options[i], t[i]),
            ...
            this.collectionsWithUpdate.forEach(function(e) {
                t[e] && (ng(t[e]).forEach(function(t, s) {
                    let o, r = a5(t.id);
                    r && (o = n.get(t.id)),
                    !o && n[e] && (o = n[e][nd(t.index, s)]) && (r && a5(o.options.id) || o.options.isInternal) && (o = void 0),
            ...
            let p = c?.width
              , u = c && (nn(c.height) ? np(c.height, p || n.chartWidth) : c.height);
            a || nr(p) && p !== n.chartWidth || nr(u) && u !== n.chartHeight ? n.setSize(p, u, s) : nd(e, !0) && n.redraw(s),
            ne(n, "afterUpdate", {
                options: t,
                redraw: e,
                animation: s
        ...
        transform(t) {
            let {axes: e=this.axes, event: i, from: s={}, reset: o, selection: r, to: a={}, trigger: n, allowResetButton: h=!0} = t
              , {inverted: l, time: d} = this;
            this.hoverPoints?.forEach(t => t.setState()),
            ne(this, "transform", t);
            let c = t.hasZoomed || !1, p, u;
            for (let t of e) {
                let {horiz: e, len: g, minPointOffset: f=0, options: m, reversed: x} = t
                  , y = e ? "width" : "height"
                  , b = e ? "x" : "y"
                  , v = nd(a[y], t.len)
                  , k = nd(s[y], t.len)
                ...
                if (!o && (w < 0 || w > t.len))
                    continue;
                let T = t.chart.polar || t.isOrdinal ? 0 : f * A || 0
                  , C = t.toValue(S, !0)
                  , P = t.toValue(S + g / M, !0)
                  , O = C + T
                  , E = P - T
                ...
                1 === M && !o && "yAxis" === t.coll && !L) {
                    for (let e of t.series) {
                        ...
                        nr(t.dataMin) && nr(t.dataMax) && (L.dataMin = Math.min(t.dataMin, L.dataMin),
                        L.dataMax = Math.max(t.dataMax, L.dataMax))
                    }
                    t.allExtremes = L
                }
                let {dataMin: B, dataMax: D, min: I, max: z} = a7(t.getExtremes(), L || {})
                  , R = d.parse(m.min)
                  , N = d.parse(m.max)
                  , W = B ?? R
                  , G = D ?? N
                  , X = E - O
                  , H = t.categories ? 0 : Math.min(X, G - W)
                  , F = W - H * (a5(R) ? 0 : m.minPadding)
                  , Y = G + H * (a5(N) ? 0 : m.maxPadding)
                  , j = t.allowZoomOutside || 1 === M || "zoom" !== n && M > 1
                  , U = Math.min(R ?? F, F, j ? I : F)
                  , V = Math.max(N ?? Y, Y, j ? z : Y);
                (!t.isOrdinal || 1 !== M || o) && (O < U && (O = U,
                M >= 1 && (E = O + X)),
                E > V && (E = V,
                M >= 1 && (O = E - X)),
                (o || t.series.length && (O !== I || E !== z) && O >= U && E <= V) && (r ? r[t.coll].push({
                    axis: t,
                    min: O,
                    max: E
                }) : (t.isPanning = "zoom" !== n,
                t.isPanning && "mousewheel" !== n && (u = !0),
                t.setExtremes(o ? void 0 : O, o ? void 0 : E, !1, !1, {
                    move: S,
                    trigger: n,
                    scale: M
                }),
            ...
            ) : (!p || u || this.resetZoomButton ? !p && this.resetZoomButton && (this.resetZoomButton = this.resetZoomButton.destroy()) : this.showResetZoom(),
    ...
    a7(nx.prototype, {
        callbacks: [],
        collectionsWithInit: {
            xAxis: [nx.prototype.addAxis, [!0]],
            yAxis: [nx.prototype.addAxis, [!1]],
    ...
    let ny = nx
      , {stop: nb} = eo
      , {composed: nv} = V
      , {addEvent: nk, createElement: nM, css: nw, defined: nS, erase: nA, merge: nT, pushUnique: nC} = tx;
    function nP() {
        let t = this.scrollablePlotArea;
        (this.scrollablePixelsX || this.scrollablePixelsY) && !t && (this.scrollablePlotArea = t = new nE(this)),
        t?.applyFixed()
    }
    function nO() {
    ...
    class nE {
        static compose(t, e, i) {
            nC(nv, this.compose) && (nk(t, "afterInit", nO),
            nk(e, "afterSetChartSize", t => this.afterSetSize(t.target, t)),
            nk(e, "render", nP),
            nk(i, "show", nO))
        }
        static afterSetSize(t, e) {
            ...
            if (!d.forExport)
                if (r ? (t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth),
                i && (t.scrollablePlotBox = nT(t.plotBox),
                h.width = t.plotWidth += i,
                n[l ? "height" : "width"] += i,
                o = !0)) : a && (t.scrollablePixelsY = s = Math.max(0, a - t.chartHeight),
                nS(s) && (t.scrollablePlotBox = nT(t.plotBox),
                ...
                nS(o)) {
                    ...
                    delete t.scrollablePlotBox
        }
        constructor(t) {
            let e;
            const i = t.options.chart
              , s = ez.getRendererType()
            ...
            const n = this.parentDiv = nM("div", {
              ...
              , h = this.scrollingContainer = nM("div", {
                className: "highcharts-scrolling"
            }, a, n)
              , l = this.innerContainer = nM("div", {
                className: "highcharts-inner-container"
            }, void 0, h)
              , d = this.fixedDiv = nM("div", {
            ...
            nk(t, "afterShowResetZoom", r),
            nk(t, "afterApplyDrilldown", r),
            nk(t, "afterLayOutTitles", r),
            nk(h, "scroll", () => {
        ...
        applyFixed() {
            let {chart: t, fixedRenderer: e, isDirty: i, scrollingContainer: s} = this
              , {axisOffset: o, chartWidth: r, chartHeight: a, container: n, plotHeight: h, plotLeft: l, plotTop: d, plotWidth: c, scrollablePixelsX: p=0, scrollablePixelsY: u=0} = t
              , {scrollPositionX: g=0, scrollPositionY: f=0} = t.options.chart.scrollablePlotArea || {}
              , m = r + p
              , x = a + u;
            e.setSize(r, a),
            (i ?? !0) && (this.isDirty = !1,
            ...
            let y = d - o[0] - 1
              ...
              , w = d + h - u
              , S = [["M", 0, 0]];
            p ? S = [["M", 0, y], ["L", l - 1, y], ["L", l - 1, v], ["L", 0, v], ["Z"], ["M", M, y], ["L", r, y], ["L", r, v], ["L", M, v], ["Z"]] : u && (S = [["M", b, 0], ["L", b, d - 1], ["L", k, d - 1], ["L", k, 0], ["Z"], ["M", b, w], ["L", b, a], ["L", k, a], ["L", k, w], ["Z"]]),
    ...
    let {format: nL} = eI
      , {series: nB} = r_
      , {destroyObjectProperties: nD, fireEvent: nI, getAlignFactor: nz, isNumber: nR, pick: nN} = tx
      , nW = class {
        constructor(t, e, i, s, o) {
        ...
        render(t) {
            let e = this.axis.chart
              , i = this.options
              , s = i.format
              , o = s ? nL(s, this, e) : i.formatter.call(this);
            if (this.label)
                this.label.attr({
                    text: o,
                    visibility: "hidden"
        ...
        setOffset(t, e, i, s, o, r) {
            ...
            if (h && p) {
                ...
                i && nB.prototype.justifyDataLabel.call(n, h, a, h.alignAttr, t, p),
                h.attr({
                    x: h.alignAttr.x,
                    y: h.alignAttr.y,
                    rotation: l.rotation,
                ...
                nN(!i && l.crop, !0) && (s = nR(h.x) && nR(h.y) && c.isInsidePlot(h.x - e + (h.width || 0), h.y) && c.isInsidePlot(h.x + e, h.y)),
                h[s ? "show" : "hide"]()
            }
        ...
        getStackBox(t) {
            let e = this.axis
              ...
              , h = e.stacking.usePercentage ? 100 : nN(s, this.total, 0)
              , l = e.toPixels(h)
              , d = t.xAxis || i.xAxis[0]
              , c = nN(o, d.translate(this.x)) + r
              , p = Math.abs(l - e.toPixels(n || nR(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min) || 0))
              , u = i.inverted
              , g = this.isNegative;
            return u ? {
      ...
      , {getDeferredAnimation: nG} = eo
      , {series: {prototype: nX}} = r_
      , {addEvent: nH, correctFloat: nF, defined: nY, destroyObjectProperties: nj, fireEvent: nU, isNumber: nV, objectEach: n$, pick: n_} = tx;
    function nZ() {
        let t = this.inverted;
        this.axes.forEach(t => {
        ...
        this.series.forEach(e => {
            ...
            e.options.stacking && e.reserveSpace() && (e.stackKey = [e.type, n_(e.options.stack, ""), t ? i.top : i.left, t ? i.height : i.width].join(","))
        }
        )
    }
    function nq() {
    ...
    function n2(t, e) {
        ...
        h = 0; h < u; h++) {
            ...
            M[a = (s = v && g < (m ? 0 : f)) ? b : y] || (M[a] = {}),
            M[a][e] || (w[a]?.[e] ? (M[a][e] = w[a][e],
            M[a][e].total = null) : M[a][e] = new nW(t,t.options.stackLabels,!!s,e,x)),
            o = M[a][e],
            null !== u ? (o.points[n] = o.points[this.index] = [n_(o.cumulative, m)],
            nY(o.cumulative) || (o.base = n),
            ...
            let S = o.total || 0;
            "percent" === l ? (r = s ? y : b,
            S = v && M[r]?.[e] ? (r = M[r][e]).total = Math.max(r.total || 0, S) + Math.abs(g) : nF(S + Math.abs(g))) : "group" === l ? nV(u) && S++ : S = nF(S + g),
            "group" === l ? o.cumulative = (S || 1) - 1 : o.cumulative = nF(n_(o.cumulative, m) + g),
            o.total = S,
            null !== u && (o.points[n].push(o.cumulative),
            p[h] = o.cumulative,
            o.hasValidPoints = !0)
        }
    ...
    class n3 {
        ...
        resetStacks() {
            n$(this.stacks, t => {
                n$(t, (e, i) => {
                    nV(e.touched) && e.touched < this.stacksTouched ? (e.destroy(),
        ...
        renderStackTotals() {
            let t = this.axis
              ...
              , i = e.renderer
              , s = this.stacks
              , o = nG(e, t.options.stackLabels?.animation || !1)
    ...
    (L || (L = {})).compose = function(t, e, i) {
        let s = e.prototype
          , o = i.prototype;
        s.getStacks || (nH(t, "init", nK),
        nH(t, "destroy", nq),
        s.getStacks = nZ,
        o.getStackIndicator = nJ,
        o.modifyStacks = nQ,
        o.percentStacker = n0,
        o.setGroupedPoints = n1,
        o.setStackedPoints = n2)
    }
    ;
    let n5 = L
      , {defined: n6, merge: n9, isObject: n4} = tx;
    class n8 extends ay {
        drawGraph() {
            let t = this.options
            ...
            [this, ...this.zones].forEach( (s, o) => {
                ...
                a[n](r).shadow(t.shadow && n9({
                    filterUnits: "userSpaceOnUse"
                }, n4(t.shadow) ? t.shadow : {}))),
                a && (a.startX = e.xMap,
                a.isArea = e.isArea)
            }
            )
        ...
        getGraphPath(t, e, i) {
            ...
            (t = this.getValidPoints(t, !1, o.nullInteraction || !(o.connectNulls && !e && !i))).forEach(function(l, d) {
                ...
                f && !n6(e) && d > 0 ? n = !o.connectNulls : f && !e ? n = !0 : (0 === d || n ? c = [["M", l.plotX, l.plotY]] : s.getPointSpline ? c = [s.getPointSpline(t, l, d)] : h ? (c = 1 === h ? [["L", g.plotX, u]] : 2 === h ? [["L", (g.plotX + p) / 2, g.plotY], ["L", (g.plotX + p) / 2, u]] : [["L", p, g.plotY]]).push(["L", p, u]) : c = [["L", p, u]],
                a.push(l.x),
                h && (a.push(l.x),
                2 === h && a.push(l.x)),
                r.push.apply(r, c),
    ...
    let {seriesTypes: {line: n7}} = r_
      , {extend: ht, merge: he, objectEach: hi, pick: hs} = tx;
    class ho extends n7 {
        drawGraph() {
            this.areaPath = [],
        ...
        getGraphPath(t) {
            ...
            for (let o = 0, r = t.length; o < r; ++o)
                ...
                i = t[o].isNull,
                e = hs(t[o].rectPlotX, t[o].plotX),
                s = a ? hs(t[o].yBottom, u) : u,
                (!i || g) && (g || f(o, o - 1, "left"),
                i && !a && g || (l.push(t[o]),
                h.push({
                    x: o,
                    ...
                    if (n[t] && !n[t].isNull)
                        ...
                        [-1, 1].forEach(function(i) {
                            ...
                            if (r) {
                                ...
                                for (; i >= 0 && i < l; ) {
                                    let s = h[i].index;
                                    !(f = r.points[s]) && (s === e.index ? n[t][o] = !0 : p[i] && (m = a[t].points[s]) && (g -= m[1] - m[0])),
                                    i += d
                                }
                            }
    ...
    class hh extends hr {
        getPointSpline(t, e, i) {
            ...
            let p = ["C", hn(l.rightContX, l.plotX, 0), hn(l.rightContY, l.plotY, 0), hn(s, n, 0), hn(o, h, 0), n, h];
            return l.rightContX = l.rightContY = void 0,
            p
        }
    }
    hh.defaultOptions = ha(hr.defaultOptions),
    r_.registerSeriesType("spline", hh);
    let hl = hh
      , {area: hd, area: {prototype: hc}} = r_.seriesTypes
      , {extend: hp, merge: hu} = tx;
    class hg extends hl {
    }
    hg.defaultOptions = hu(hl.defaultOptions, hd.defaultOptions),
    hp(hg.prototype, {
    ...
    let {animObject: hf} = eo
      , {parse: hm} = tJ
      , {noop: hx} = V
      , {clamp: hy, crisp: hb, defined: hv, extend: hk, fireEvent: hM, isArray: hw, isNumber: hS, merge: hA, pick: hT, objectEach: hC} = tx;
    class hP extends ay {
        animate(t) {
            ...
            t && h ? (d.scaleY = .001,
            i = hy(o.toPixels(n.threshold || 0), r, r + o.len),
        ...
        getColumnMetrics() {
            ...
            let l = Math.min(Math.abs(i.transA) * (!i.brokenAxis?.hasBreaks && i.ordinal?.slope || e.pointRange || i.closestPointRange || i.tickInterval || 1), i.len)
              , d = l * e.groupPadding
              , c = (l - 2 * d) / (h || 1)
              , p = Math.min(e.maxPointWidth || i.len, hT(e.pointWidth, c * (1 - 2 * e.pointPadding)))
              , u = (t.columnIndex || 0) + +!!r;
        ...
        crispCol(t, e, i, s) {
            ...
            return s = hb(e + s, o, r) - (e = hb(e, o, r)),
            this.options.crisp && (i = hb(t + i, o) - (t = hb(t, o))),
            {
                x: t,
                y: e,
                width: i,
        ...
        translate() {
            let t = this
              ...
              , o = t.borderWidth = hT(i.borderWidth, +!s)
              , r = t.xAxis
              , a = t.yAxis
              , n = i.threshold
              , h = hT(i.minPointLength, 5)
            ...
            ay.prototype.translate.apply(t),
            t.points.forEach(function(s) {
                ...
                hS(n) && hS(u) && s.y === n && u <= n && (a.min || 0) < n && (p !== u || (a.max || 0) <= n) && (b = !b,
                s.negative = !s.negative),
                v = Math.abs(v - g) > h ? o - h : g - (b ? h : 0)),
                hv(s.options.pointWidth) && (w -= Math.round(((M = S = Math.ceil(s.options.pointWidth)) - d) / 2)),
                i.centerInCategory && (w = t.adjustForMissingColumns(w, M, s, l)),
                s.barX = w,
                s.pointWidth = M,
                s.tooltipPos = e.inverted ? [hy(a.len + a.pos - e.plotLeft - y, a.pos - e.plotLeft, a.len + a.pos - e.plotLeft), r.len + r.pos - e.plotTop - w - S / 2, k] : [r.left - e.plotLeft + w + S / 2, hy(y + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop), k],
        ...
        pointAttribs(t, e) {
            ...
            c = n.dashStyle || c,
            p = n.borderWidth || p)),
            e && t && (h = (a = hA(i.states[e], t.options.states?.[e] || {})).brightness,
            l = a.color || void 0 !== h && hm(l).brighten(a.brightness).get() || l,
            d = a[o] || d,
            p = a[r] || p,
            c = a.dashStyle || c,
            u = hT(a.opacity, u));
        ...
        drawTracker(t=this.points) {
            ...
            t.forEach(function(t) {
                e = hw(t.dataLabels) ? t.dataLabels : t.dataLabel ? [t.dataLabel] : [],
                t.graphic && (t.graphic.element.point = t),
                e.forEach(function(e) {
                    (e.div || e.element).point = t
                })
            }),
            i._hasTracking || (i.trackerGroups?.reduce( (t, e) => ("dataLabelsGroup" === e ? t.push(...i.dataLabelsGroups || []) : t.push(i[e]),
            t), []).forEach(t => {
                t && (t.addClass("highcharts-tracker").on("mouseover", r).on("mouseout", function(t) {
                    o?.onTrackerMouseOut(t)
                }).on("touchstart", r),
                !s.styledMode && i.options.cursor && t.css({
                    cursor: i.options.cursor
                }))
            }
            ),
            i._hasTracking = !0),
            hM(this, "afterDrawTracker")
        }
        remove() {
            let t = this
              , e = t.chart;
    ...
    let hO = hP
      , {getDeferredAnimation: hE} = eo
      , {format: hL} = eI
      , {defined: hB, extend: hD, fireEvent: hI, getAlignFactor: hz, isArray: hR, isString: hN, merge: hW, objectEach: hG, pick: hX, pInt: hH, splat: hF} = tx;
    !function(t) {
        function e() {
        ...
        function i(t, e, i, s, o) {
            let {chart: r, enabledDataSorting: a} = this
              ...
              , l = t.plotY
              , d = i.rotation || 0
              , c = hB(h) && hB(l) && r.isInsidePlot(h, Math.round(l), {
                inverted: n,
                paneCoordinates: !0,
                series: this
            })
              , p = 0 === d && "justify" === hX(i.overflow, a ? "none" : "justify")
              , u = this.visible && !1 !== t.visible && hB(h) && (t.series.forceDL || a && !p || c || hX(i.inside, !!this.options.stacking) && s && r.isInsidePlot(h, n ? s.x + 1 : s.y + s.height - 1, {
                inverted: n,
                paneCoordinates: !0,
                series: this
            }))
            ...
            if (u && g) {
                ...
                e.alignAttr.x += hz(i.align) * (l.width - h.width),
                e.alignAttr.y += hz(i.verticalAlign) * (l.height - h.height),
        ...
        function s(t, e) {
            ...
            return this.dataLabelsGroups || (this.dataLabelsGroups = []),
        ...
        function o(t, e, i) {
            ...
            return !s && o && (this.visible && o.show(),
            this.options.animation ? o.animate({
                opacity: 1
            }, e) : o.attr({
                opacity: 1
            })),
        ...
        function r(t) {
            ...
            let i = this
              ...
              , d = r.getContrast(hN(l) && l || hN(a) && a || "#000000")
              , c = h(i)
            ...
            hI(this, "drawDataLabels"),
            i.hasDataLabels?.() && t.forEach(t => {
                let a = t.dataLabels || []
                  , h = t.color || i.color;
                hF(n(c, t.dlOptions || t.options?.dataLabels)).forEach( (n, l) => {
                    ...
                    c && (y = hB(x = hX(n[t.formatPrefix + "Format"], n.format)) ? hL(x, t, s) : (n[t.formatPrefix + "Formatter"] || n.formatter).call(t, n),
                    b = n.rotation,
                    !s.styledMode && (m.color = hX(n.color, m.color, hN(i.color) ? i.color : void 0, "#000000"),
                    "contrast" === m.color ? ("none" !== p && (w = p),
                    t.contrastColor = r.getContrast("auto" !== w && hN(w) && w || (hN(h) ? h : "")),
                    m.color = w || !hB(f) && n.inside || 0 > hH(f || 0) || o.stacking ? t.contrastColor : d) : delete t.contrastColor,
                    ...
                    s.styledMode || (v.fill = "auto" === p ? t.color : p,
                    v.stroke = "auto" === u ? t.color : u,
                    v["stroke-width"] = n.borderWidth),
                    hG(v, (t, e) => {
                        void 0 === t && delete v[e]
                    }
                    )),
                    !k || c && hB(y) && !!(k.div || k.text?.foreignObject) == !!n.useHTML && (k.rotation && n.rotation || k.rotation === n.rotation) || (k = void 0,
                    M = !0),
                    c && hB(y) && "" !== y && (k ? v.text = y : (k = r.label(y, 0, 0, n.shape, void 0, void 0, n.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t.colorIndex + " " + (n.className || "") + (n.useHTML ? " highcharts-tracker" : "")),
                    k && (k.options = n,
                    k.attr(v),
                    s.styledMode ? m.width && k.css({
                        width: m.width,
                        textOverflow: m.textOverflow,
                        whiteSpace: m.whiteSpace
                    }) : k.css(m).shadow(n.shadow),
                    hI(k, "beforeAddingDataLabel", {
                        labelOptions: n,
                        point: t
                    }),
                    k.added || k.add(e),
                    i.alignDataLabel(t, k, n, void 0, M),
                    k.isActive = !0,
                    a[l] && a[l] !== k && a[l].destroy(),
                    a[l] = k))
                }
                );
                let l = a.length;
        ...
        function a(t, e, i, s, o, r) {
            ...
            return (m = (i.x || 0) + l + c) < 0 && ("right" === n && g >= 0 ? (e.align = "left",
            e.inside = !0) : g -= m,
            x = !0),
            (m = (i.x || 0) + s.width - l + c) > a.plotWidth && ("left" === n && g <= 0 ? (e.align = "right",
            e.inside = !0) : g += a.plotWidth - m,
            x = !0),
            (m = i.y + l + u) < 0 && ("bottom" === h && f >= 0 ? (e.verticalAlign = "top",
            e.inside = !0) : f -= m,
            x = !0),
            (m = (i.y || 0) + s.height - l + u) > a.plotHeight && ("top" === h && f <= 0 ? (e.verticalAlign = "bottom",
    ...
    function h_(t, e, i, s, o) {
        ...
        hU.prototype.alignDataLabel.call(this, t, e, i, s, o),
    ...
    (D || (D = {})).compose = function(t) {
        hY.compose(hU),
        h$(hj, "ColumnDataLabel") && (t.prototype.alignDataLabel = h_)
    }
    ;
    let hZ = D
      , {extend: hq, merge: hK} = tx;
    class hJ extends hO {
    }
    hJ.defaultOptions = hK(hO.defaultOptions, {}),
    hq(hJ.prototype, {
        inverted: !0
    }),
    r_.registerSeriesType("bar", hJ);
    let {column: hQ, line: h0} = r_.seriesTypes
      , {addEvent: h1, extend: h2, merge: h3} = tx;
    class h5 extends h0 {
        applyJitter() {
            let t = this
    ...
    let {deg2rad: h6} = V
      , {fireEvent: h9, isNumber: h4, pick: h8, relativeLength: h7} = tx;
    (x = I || (I = {})).getCenter = function() {
        ...
        let u = [h8(r?.[0], "50%"), h8(r?.[1], "50%"), h8(l && l < 0 ? void 0 : t.size, "100%"), h8(d && d < 0 ? void 0 : t.innerSize || 0, "0%")];
        for (!e.angular || this instanceof ay || (u[3] = 0),
        c = 0; c < 4; ++c)
            p = u[c],
            h = c < 2 || 2 === c && /%$/.test(p),
            u[c] = h7(p, [s, o, a, u[2]][c]) + (h ? i : 0);
        return u[3] > u[2] && (u[3] = u[2]),
        h4(n) && 2 * n < u[2] && n > 0 && (u[3] = u[2] - 2 * n),
        h9(this, "afterGetCenter", {
            positions: u
        }),
        u
    }
    ...
    let lt = I
      , {setAnimation: le} = eo
      , {addEvent: li, defined: ls, extend: lo, isNumber: lr, pick: la, relativeLength: ln} = tx;
    class lh extends rd {
        getConnectorPath(t) {
        ...
        slice(t, e, i) {
            ...
            le(i, s.chart),
            e = la(e, !0),
            this.sliced = this.options.sliced = t = ls(t) ? t : !this.sliced,
    ...
    lo(lh.prototype, {
        connectorShapes: {
            ...
            crookedLine: function(t, e, i) {
                ...
                let x = [["M", g, f]];
                return (u ? m <= g && m >= o.x : m >= g && m <= o.x) && x.push(["L", m, f]),
                x.push(["L", o.x, o.y], ["L", r.x, r.y]),
                x
            }
        }
    });
    let {getStartAndEndRadians: ll} = lt
      , {noop: ld} = V
      , {clamp: lc, extend: lp, fireEvent: lu, merge: lg, pick: lf} = tx;
    class lm extends ay {
        animate(t) {
            let e = this
              , i = e.points
    ...
    let {composed: lx, noop: ly} = V
      , {distribute: lb} = eX
      , {series: lv} = r_
      , {arrayMax: lk, clamp: lM, defined: lw, isNumber: lS, pick: lA, pushUnique: lT, relativeLength: lC} = tx;
    !function(t) {
        let e = {
        ...
        function s() {
            let t = this, e = t.points, i = t.chart, s = i.plotWidth, o = i.plotHeight, r = i.plotLeft, a = Math.round(i.chartWidth / 3), n = t.center, h = n[2] / 2, l = n[1], d = [[], []], c = [0, 0, 0, 0], p = t.dataLabelPositioners, u, g, f, m = 0;
            ...
            lv.prototype.drawDataLabels.apply(t),
            e.forEach(t => {
                (t.dataLabels || []).forEach( (e, i) => {
                    let s = n[2] / 2
                      ...
                      , r = lC(o?.distance || 0, s);
                    0 === i && d[t.half].push(t),
                    !lw(o?.style?.width) && e.getBBox().width > a && (e.css({
                ...
                e.forEach(i => {
                    (i.dataLabels || []).forEach(l => {
                        let d = l.options || {}
                          ...
                          , S = "inherit";
                        if (x) {
                            if (u && lw(m) && x.distance > 0 && (void 0 === m.pos ? S = "hidden" : (f = m.size,
                            w = p.radialDistributionY(i, l))),
                            d.justify)
                                M = p.justify(i, l, h, n);
                            else
                                switch (d.alignTo) {
                            ...
                            lA(d.crop, !0)) {
                                let t;
                                M - (g = l.getBBox().width) < b && 1 === a ? (t = Math.round(g - M + b),
                                c[3] = Math.max(t, c[3])) : M + g > s - b && 0 === a && (t = Math.round(M + g - s + b),
                                c[1] = Math.max(t, c[1])),
                                w - f / 2 < 0 ? c[0] = Math.max(Math.round(-w + f / 2), c[0]) : w + f / 2 > o && (c[2] = Math.max(Math.round(w + f / 2 - o), c[2])),
                                x.sideOverflow = t
                            }
                        }
                    }
            ...
            (0 === lk(c) || this.verifyDataLabelOverflow(c)) && (this.placeDataLabels(),
            this.points.forEach(e => {
                e.dataLabels?.forEach( (s, o) => {
                    ...
                    if (lS(a)) {
                        ...
                        u = s.connector,
                        n && n.distance > 0 ? (h = !u,
                        u || (s.connector = u = i.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + e.colorIndex + (e.className ? " " + e.className : "")).add(t.dataLabelsGroups?.[o])),
                        i.styledMode || u.attr({
                            "stroke-width": a,
        ...
        function r(t) {
            ...
            e[0] += (t[3] - t[1]) / 2),
            null !== s[1] ? r = lM(r, o, e[2] - Math.max(t[0], t[2])) : (r = lM(r, o, e[2] - t[0] - t[2]),
            e[1] += (t[0] - t[2]) / 2),
            r < e[2] ? (e[2] = r,
            e[3] = Math.min(i.thickness ? Math.max(0, r - 2 * i.thickness) : Math.max(0, lC(i.innerSize || 0, r)), r),
            this.translate(e),
    ...
    ;
    let {pointInPolygon: lO} = R
      , {addEvent: lE, getAlignFactor: lL, fireEvent: lB, objectEach: lD, pick: lI} = tx;
    function lz(t, e) {
        let i, s = !1;
    ...
    let {defaultOptions: lR} = tY
      , {noop: lN} = V
      , {addEvent: lW, extend: lG, isObject: lX, merge: lH, relativeLength: lF} = tx
      , lY = {
        radius: 0,
        scope: "stack",
        where: void 0
    ...
    function lV(t, e, i, s, o={}) {
        ...
        let p = c - d
          , u = Math.sin(p / 2)
          , g = Math.max(Math.min(lF(o.borderRadius || 0, l - h), (l - h) / 2, l * u / (1 + u)), 0)
          , f = Math.min(g, p / Math.PI * 2 * h)
          , m = r.length - 1;
        for (; m--; )
            (a || 0 !== m && 3 !== m) && (n || 1 !== m && 2 !== m) && !function(t, e, i) {
    ...
    function l$() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let {options: t, yAxis: e} = this
              ...
              , s = lR.plotOptions?.[this.type]?.borderRadius
              , o = l_(t.borderRadius, lX(s) ? s : {})
            ...
            for (let s of this.points) {
                ...
                if ("roundedRect" === s.shapeType && a) {
                    ...
                    let p = (s.negative ? -1 : 1) * (r ? -1 : 1) == -1
                      , u = o.where;
                    !u && this.is("waterfall") && Math.abs((s.yBottom || 0) - (this.translatedThreshold || 0)) > this.borderWidth && (u = "all"),
                    u || (u = "end");
    ...
    function lq(t, e, i, s, o={}) {
        ...
        return r.length = 0,
        r.push(["M", ...f], ["L", ...m], ["A", c, c, 0, 0, 1, ...x], ["L", ...y], ["A", p, p, 0, 0, 1, ...b], ["L", ...v], ["A", p, p, 0, 0, 1, ...k], ["L", ...M], ["A", c, c, 0, 0, 1, ...f], ["Z"]),
        r
    }
    ...
    function l5(t, e) {
        ...
        o ? ((r = lK(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0,
    ...
    V.Time = tN,
    V.Tooltip = o0,
    V.animate = eo.animate,
    V.animObject = eo.animObject,
    V.chart = ny.chart,
    V.color = tJ.parse,
    V.dateFormat = eI.dateFormat,
    V.defaultOptions = tY.defaultOptions,
    V.distribute = eX.distribute,
    V.format = eI.format,
    V.getDeferredAnimation = eo.getDeferredAnimation,
    V.getOptions = tY.getOptions,
    V.numberFormat = eI.numberFormat,
    V.seriesType = r_.seriesType,
    V.setAnimation = eo.setAnimation,
    V.setOptions = tY.setOptions,
    V.stop = eo.stop,
    V.time = tY.defaultTime,
    V.timers = t3.timers,
    ({
        compose: function(t, e, i) {
            ...
            if (!e.symbolCustomAttribs.includes("borderRadius")) {
                ...
                lW(s, "afterTranslate", lZ),
                e.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY", "brEnd", "brStart"),
                lj = o.arc,
                lU = o.roundedRect,
                o.arc = lV,
                o.roundedRect = lq
        ...
        optionsToObject: l_
    }).compose(V.Series, V.SVGElement, V.SVGRenderer),
    hZ.compose(V.Series.types.column),
    hY.compose(V.Series),
    ol.compose(V.Axis),
    sx.compose(V.SVGRenderer),
    aH.compose(V.Chart),
    ou.compose(V.Axis),
    (l = (b = V.Chart).prototype).hideOverlappingLabels || (l.hideOverlappingLabels = function(t) {
    ...
    lE(b, "render", function() {
        ...
        for (let i of t.yAxis || [])
            i.stacking && i.options.stackLabels && !i.options.stackLabels.allowOverlap && lD(i.stacking.stacks, t => {
                lD(t, t => {
                ...
                let s = i => {
                    for (let s of i)
                        s.visible && (s.dataLabels || []).forEach(i => {
                            let o = i.options || {};
                            i.labelrank = lI(o.labelrank, s.labelrank, s.shapeArgs?.height),
    ...
    lP.compose(V.Series.types.pie),
    oP.compose(V.Chart, V.Axis),
    rO.compose(V.Chart),
    l6.compose(V.Chart),
    nE.compose(V.Axis, V.Chart, V.Series),
    n5.compose(V.Axis, V.Chart, V.Series),
    o0.compose(V.Pointer),
    tx.extend(V, tx);
    let {tooltipFormatter: l9} = rd.prototype
      , {addEvent: l4, arrayMax: l8, arrayMin: l7, correctFloat: dt, defined: de, isArray: di, isNumber: ds, isString: dr, pick: da} = tx;
    !function(t) {
        function e(t, e, i) {
        ...
        function i(t) {
            ...
            return de(e.change) && s("change"),
            de(e.cumulativeSum) && s("cumulativeSum"),
            l9.apply(this, [t])
        }
        function s() {
            ...
            ("percent" === s || "value" === s || this.options.cumulative) && (t = new d(this),
        ...
        function o(t) {
            ...
            if (this.dataModify && e) {
                let t;
                this.options.compare ? t = [this.dataModify.modifyValue(e.dataMin), this.dataModify.modifyValue(e.dataMax)] : this.options.cumulative && di(i) && i.length >= 2 && (t = d.getCumulativeExtremes(i)),
                t && (e.dataMin = l7(t),
                e.dataMax = l8(t))
            }
        }
        function r(t, e) {
            ...
            this.update({}, da(e, !0)),
            this.dataModify && ("value" === t || "percent" === t) ? this.dataModify.initCompare(t) : this.points.forEach(t => {
                delete t.change
            }
            )
        }
        ...
        function h(t, e) {
            ...
            this.update({}, da(e, !0)),
            this.dataModify ? this.dataModify.initCumulative() : this.points.forEach(t => {
        ...
        t.compose = function(t, d, c) {
            let p = d.prototype
              , u = c.prototype
              , g = t.prototype;
            return g.setCompare || (g.setCompare = r,
            g.setCumulative = h,
            l4(t, "afterInit", s),
            l4(t, "afterGetExtremes", o),
            l4(t, "afterProcessData", a)),
            p.setCompare || (p.setCompare = n,
            p.setModifier = e,
            p.setCumulative = l,
            ...
            initCompare(t) {
                this.modifyValue = function(e, i) {
                    ...
                    if (void 0 !== e && void 0 !== s) {
                        if ("value" === t ? e -= s : e = e / s * 100 - 100 * (100 !== this.series.options.compareBase),
                        void 0 !== i) {
            ...
            initCumulative() {
                this.modifyValue = function(t, e) {
                    ...
                    void 0 !== t && void 0 !== e) {
                        ...
                        return s && (!o || r ? s.cumulativeSum = t : s.cumulativeSum = void 0),
                        t
                    }
                    return 0
                }
    ...
    let dn = W
      , {isTouchDevice: dh} = V
      , {addEvent: dl, merge: dd, pick: dc} = tx
      , dp = [];
    function du() {
    ...
    function dg() {
        ...
        if (o) {
            ...
            this.inverted ? (o.left = o.opposite ? this.chartWidth - r - o.height : this.spacing[3] + r,
            o.top = this.plotTop + a) : (o.left = dc(e.left, this.plotLeft + a),
            o.top = o.navigatorOptions.top || this.chartHeight - o.height - r - (this.scrollbar?.options.margin || 0) - this.spacing[2] - (this.rangeSelector && this.extraBottomMargin ? this.rangeSelector.getHeight() : 0) - (t && "bottom" === t.verticalAlign && "proximate" !== t.layout && t.enabled && !t.floating ? s.legendHeight + dc(t.margin, 10) : 0) - (this.titleOffset ? this.titleOffset[2] : 0)),
            e && i && (this.inverted ? e.options.left = i.options.left = o.left : e.options.top = i.options.top = o.top,
            e.setAxisSize(),
            i.setAxisSize())
        }
    }
    function df(t) {
        !this.navigator && !this.scroller && (this.options.navigator.enabled || this.options.scrollbar.enabled) && (this.scroller = this.navigator = new i(this),
        dc(t.redraw, !0) && this.redraw(t.animation))
    }
    function dm() {
        let t = this.options;
    ...
    function dx() {
        let t = this.options
          , e = t.navigator
          , i = t.rangeSelector;
        if ((e && e.enabled || i && i.enabled) && (!dh && "x" === this.zooming.type || dh && "x" === this.zooming.pinchType))
            return !1
    }
    function dy(t) {
        let e = t.navigator;
    ...
    function db(t) {
        ...
        !this.navigator && !this.scroller && (e.enabled || i.enabled) && (dd(!0, this.options.navigator, e),
        dd(!0, this.options.scrollbar, i),
    ...
    let dv = function(t, e) {
        if (tx.pushUnique(dp, t)) {
            ...
            i = e,
            s.callbacks.push(dy),
            dl(t, "afterAddSeries", du),
            dl(t, "afterSetChartSize", dg),
            dl(t, "afterUpdate", df),
            dl(t, "beforeRender", dm),
            dl(t, "beforeShowResetZoom", dx),
            dl(t, "update", db)
        }
    }
      , {isTouchDevice: dk} = V
      , {addEvent: dM, correctFloat: dw, defined: dS, isNumber: dA, pick: dT} = tx;
    function dC() {
    ...
    function dP(t) {
        ...
        if (this.isXAxis && (o?.enabled || n?.enabled)) {
            if ("y" === h && "zoom" === t.trigger)
                e = !1;
            else if (("zoom" === t.trigger && "xy" === h || dk && "xy" === a) && this.options.range) {
                let e = r.previousZoom;
                dS(t.min) ? r.previousZoom = [this.min, this.max] : e && (t.min = e[0],
                t.max = e[1],
    ...
    class dO {
        static compose(t) {
            t.keepProps.includes("navigatorAxis") || (t.keepProps.push("navigatorAxis"),
            dM(t, "init", dC),
            dM(t, "setExtremes", dP))
        }
        constructor(t) {
        ...
        toFixedRange(t, e, i, s) {
            let o = this.axis
              , r = (o.pointRange || 0) / 2
              , a = dT(i, o.translate(t, !0, !o.horiz))
              , n = dT(s, o.translate(e, !0, !o.horiz));
            return dS(i) || (a = dw(a + r)),
            dS(s) || (n = dw(n - r)),
            dA(a) && dA(n) || (a = n = void 0),
            {
                min: a,
                max: n
            }
    ...
    let {parse: dE} = tJ
      ...
      , {relativeLength: dD} = tx
      , dI = {
        "navigator-handle": function(t, e, i, s, o={}) {
            let r = o.width ? o.width / 2 : i
              , a = dD(o.borderRadius || 0, Math.min(2 * r, s));
            return [["M", -1.5, (s = o.height || s) / 2 - 3.5], ["L", -1.5, s / 2 + 4.5], ["M", .5, s / 2 - 3.5], ["L", .5, s / 2 + 4.5], ...iC.rect(-r - 1, .5, 2 * r + 1, s, {
                r: a
            })]
        }
    }
      ...
      , {defaultOptions: dN} = tY
      , {composed: dW} = V
      , {getRendererType: dG} = ez
      , {setFixedRange: dX} = dR
      , {addEvent: dH, extend: dF, pushUnique: dY} = tx;
    function dj() {
        this.chart.navigator && !this.options.isInternal && this.chart.navigator.setBaseSeries(null, !1)
    }
    let dU = function(t, e, i) {
        dO.compose(e),
        dY(dW, "Navigator") && (t.prototype.setFixedRange = dX,
        dF(dG().prototype.symbols, dI),
        dF(dN, {
            navigator: dB
        }),
        dH(i, "afterUpdate", dj))
      ...
      , {composed: dV} = V
      , {addEvent: d$, correctFloat: d_, defined: dZ, pick: dq, pushUnique: dK} = tx;
    !function(t) {
        let e;
        function i(t) {
            let e = dq(t.options?.min, t.min)
              , i = dq(t.options?.max, t.max);
            return {
                axisMin: e,
                axisMax: i,
        ...
        function s() {
            ...
            t && (this.chart.scrollbarsOffsets = [0, 0],
            this.chart.axisOffset[i] += t.size + (t.options.margin || 0))
        }
        function o() {
            let t = this;
            t.options?.scrollbar?.enabled && (t.options.scrollbar.vertical = !t.horiz,
            t.options.startOnTick = t.options.endOnTick = !1,
            t.scrollbar = new e(t.chart.renderer,t.options.scrollbar,t.chart),
            d$(t.scrollbar, "changed", function(e) {
                let s, o, {axisMin: r, axisMax: a, scrollMin: n, scrollMax: h} = i(t), l = t.toPixels(n), d = t.toPixels(h) - l;
                if (dZ(r) && dZ(a))
                    if (t.horiz && !t.reversed || !t.horiz && t.reversed ? (s = Math.min(h, t.toValue(l + d * this.to)),
                    o = Math.max(n, t.toValue(l + d * this.from))) : (s = Math.min(h, t.toValue(l + d * (1 - this.from))),
        ...
        function r() {
            ...
            if (a && h) {
                if (this.horiz)
                    this.opposite || (h[1] += n),
                    a.position(this.left, this.top + this.height + 2 + h[1] - (this.opposite ? l : 0), this.width, this.height),
                    this.opposite || (h[1] += l),
                    t = 1;
                else {
                    let e;
                    this.opposite && (h[0] += n),
                    e = a.options.opposite ? this.left + this.width + 2 + h[0] - (this.opposite ? 0 : l) : this.opposite ? 0 : l,
                    a.position(e, this.top, this.width, this.height),
                    this.opposite && (h[0] += l),
                    t = 0
                }
                if (h[t] += a.size + (a.options.margin || 0),
                isNaN(o) || isNaN(r) || !dZ(this.min) || !dZ(this.max) || dZ(this.dataMin) && this.dataMin === this.dataMax)
                    a.setRange(0, 1);
                    ...
                    e = (this.toPixels(this.min) - this.toPixels(o)) / (this.toPixels(r) - this.toPixels(o)),
                    s = (this.toPixels(this.max) - this.toPixels(o)) / (this.toPixels(r) - this.toPixels(o)),
                    this.horiz && !this.reversed || !this.horiz && this.reversed ? a.setRange(e, s) : a.setRange(1 - s, 1 - e)
            }
        }
        t.compose = function(t, i) {
            dK(dV, "Axis.Scrollbar") && (e = i,
            d$(t, "afterGetOffset", s),
            d$(t, "afterInit", o),
            d$(t, "afterRender", r))
        }
    }(G || (G = {}));
    let dJ = G
      ...
      , {defaultOptions: d0} = tY
      , {composed: d1} = V
      , {addEvent: d2, correctFloat: d3, crisp: d5, defined: d6, destroyObjectProperties: d9, extend: d4, fireEvent: d8, merge: d7, pick: ct, pushUnique: ce, removeEvent: ci} = tx;
    class cs {
        static compose(t) {
            dJ.compose(t, cs),
            ce(d1, "Scrollbar") && d4(d0, {
                scrollbar: dQ
            })
        }
        static swapXY(t, e) {
            return e && t.forEach(t => {
                let e, i = t.length;
                for (let s = 0; s < i; s += 2)
                    "number" == typeof (e = t[s + 1]) && (t[s + 1] = t[s + 2],
                    t[s + 2] = e)
            }
            ),
            t
        ...
        addEvents() {
            let t = this.options.inverted ? [1, 0] : [0, 1]
              ...
              , n = [[e[t[0]].element, "click", this.buttonToMinClick.bind(this)], [e[t[1]].element, "click", this.buttonToMaxClick.bind(this)], [s, "click", this.trackClick.bind(this)], [i, "mousedown", o], [i.ownerDocument, "mousemove", r], [i.ownerDocument, "mouseup", a], [i, "touchstart", o], [i.ownerDocument, "touchmove", r], [i.ownerDocument, "touchend", a]];
        ...
        buttonToMinClick(t) {
            ...
            this.updatePosition(d3(this.from - e), d3(this.to - e)),
            d8(this, "changed", {
                from: this.from,
                to: this.to,
                trigger: "scrollbar",
        ...
        destroy() {
            ...
            e && t === e.scrollbar && (e.scrollbar = null,
            d9(e.scrollbarButtons))
        }
        drawScrollbarButton(t) {
            ...
            s.buttonsEnabled) {
                ...
                let n = e.path(cs.swapXY([["M", o / 2 + (t ? -1 : 1), o / 2 - 3], ["L", o / 2 + (t ? -1 : 1), o / 2 + 3], ["L", o / 2 + (t ? 2 : -2), o / 2]], s.vertical)).addClass("highcharts-scrollbar-arrow").add(i[t]);
        ...
        init(t, e, i) {
            ...
            this.renderer = t,
            this.userOptions = e,
            this.options = d7(dQ, d0.scrollbar, e),
            this.options.margin = ct(this.options.margin, 10),
            this.chart = i,
            this.size = ct(this.options.size, this.options.height),
            e.enabled && (this.render(),
            this.addEvents())
        }
        mouseDownHandler(t) {
        ...
        mouseMoveHandler(t) {
            ...
            this.grabbedCenter && (!t.touches || 0 !== t.touches[0][s]) && (e = this.cursorToScrollbarPosition(i)[s] - this[s],
            this.hasDragged = !0,
        ...
        position(t, e, i, s) {
            ...
            this.xOffset = h,
            this.yOffset = l,
            a ? (this.width = this.yOffset = i = l = this.size,
            this.xOffset = h = 0,
            this.yOffset = l = o ? this.size : 0,
            this.barWidth = s - (o ? 2 * i : 0),
            this.x = t += r) : (this.height = s = this.size,
        ...
        render() {
            ...
            this.group = o,
            this.track = t.rect().addClass("highcharts-scrollbar-track").attr({
            ...
            this.scrollbar = t.rect().addClass("highcharts-scrollbar-thumb").attr({
                height: i - r,
                width: i - r,
                r: e.barBorderRadius || 0
            }).add(this.scrollbarGroup),
            this.scrollbarRifles = t.path(cs.swapXY([["M", -3, i / 4], ["L", -3, 2 * i / 3], ["M", 0, i / 4], ["L", 0, 2 * i / 3], ["M", 3, i / 4], ["L", 3, 2 * i / 3]], e.vertical)).addClass("highcharts-scrollbar-rifles").add(this.scrollbarGroup),
            ...
            this.scrollbarGroup.translate(-d5(0, this.scrollbarStrokeWidth), -d5(0, this.scrollbarStrokeWidth)),
        ...
        trackClick(t) {
            ...
            this.options.vertical && e.chartY > s || !this.options.vertical && e.chartX > o ? this.updatePosition(this.from + i, this.to + i) : this.updatePosition(this.from - i, this.to - i),
            d8(this, "changed", {
                from: this.from,
                to: this.to,
                trigger: "scrollbar",
        ...
        update(t) {
            this.destroy(),
            this.init(this.chart.renderer, d7(!0, this.options, t), this.chart)
        }
        updatePosition(t, e) {
            e > 1 && (t = d3(1 - d3(e - t)),
            e = 1),
    ...
    let {defaultOptions: co} = tY
      , {isTouchDevice: cr} = V
      , {prototype: {symbols: ca}} = ss
      , {addEvent: cn, clamp: ch, correctFloat: cl, defined: cd, destroyObjectProperties: cc, erase: cp, extend: cu, find: cg, fireEvent: cf, isArray: cm, isNumber: cx, merge: cy, pick: cb, removeEvent: cv, splat: ck} = tx;
    function cM(t, ...e) {
        let i = [].filter.call(e, cx);
        if (i.length)
            return Math[t].apply(0, i)
    }
    class cw {
        static compose(t, e, i) {
            dv(t, cw),
        ...
        drawOutline(t, e, i, s) {
            ...
            i ? (f = d + e + n,
            e = d + t + n,
            m = [["M", g + c, d - h - n], ["L", g + c, f], ["L", g, f], ["M", g, e], ["L", g + c, e], ["L", g + c, d + l + h]],
            o && m.push(["M", g + c, f - a], ["L", g + c, e + a])) : (g -= h,
            t += g + h - n,
            e += g + h - n,
            m = [["M", g, p], ["L", t, p], ["L", t, u], ["M", e, u], ["L", e, p], ["L", g + l + 2 * h, p]],
        ...
        drawMasks(t, e, i, s) {
            ...
            n = [l, l + t, l + e],
            r = [d, d, d],
            o = [t, e - t, this.size - e]) : (a = [h, h + t, h + e],
            n = [l, l, l],
            r = [t, e - t, this.size - e],
            o = [d, d, d]),
            ...
            e.handles?.enabled) {
                ...
                [0, 1].forEach(e => {
                    ...
                    if (t.handles[e] && t.handles[e].symbolUrl === l) {
                        ...
                        t.handles[e]?.destroy(),
                        t.handles[e] = r.symbol(l, -h / 2 - 1, 0, h, o, i),
                        t.handles[e].attr({
                            zIndex: 7 - e
                        }).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][e]).add(n),
                        t.addMouseEvents();
        ...
        update(t, e=!1) {
            ...
            !1 === t.adaptToUpdatedData && this.baseSeries.forEach(t => {
                cv(t, "updatedData", this.updatedDataHandler)
            }
            , this),
            t.adaptToUpdatedData && this.baseSeries.forEach(t => {
        ...
        render(t, e, i, s) {
            ...
            !cx(t) || !cx(e))
                if (!l)
                    ...
                    i = 0,
                    s = cb(r.width, n.width);
            this.left = cb(r.left, o.plotLeft + u + (d ? o.plotWidth : 0));
            let v = this.size = y = cb(r.len, (d ? o.plotHeight : o.plotWidth) - 2 * u);
            g = d ? x : y + 2 * u,
            i = cb(i, r.toPixels(t, !0)),
            s = cb(s, r.toPixels(e, !0)),
            cx(i) && Math.abs(i) !== 1 / 0 || (i = 0,
            s = g);
            let k = r.toValue(i, !0)
              , M = r.toValue(s, !0)
              , w = Math.abs(cl(M - k));
            w < c ? this.grabbedLeft ? i = r.toPixels(M - c - a, !0) : this.grabbedRight && (s = r.toPixels(k + c + a, !0)) : cd(p) && cl(w - a) > p && (this.grabbedLeft ? i = r.toPixels(M - p - a, !0) : this.grabbedRight && (s = r.toPixels(k + p + a, !0))),
            this.zoomedMax = ch(Math.max(i, s), 0, v),
            this.zoomedMin = ch(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(i, s), 0, v),
            ...
            this.navigatorOptions.handles.enabled && (this.drawHandle(S, 0, d, b),
            this.drawHandle(v, 1, d, b))),
            this.scrollbar && (d ? (m = this.top - u,
            f = this.left - x + (h || !n.opposite ? 0 : (n.titleOffset || 0) + n.axisTitleMargin),
            x = y + 2 * u) : (m = this.top + (h ? this.height : -x),
            f = this.left - u),
            this.scrollbar.position(f, m, g, x),
        ...
        addMouseEvents() {
            ...
            ,
            (s = t.getPartsEvents("mousedown")).push(cn(e.renderTo, "mousemove", o), cn(i.ownerDocument, "mouseup", r), cn(e.renderTo, "touchmove", o), cn(i.ownerDocument, "touchend", r)),
            s.concat(t.getPartsEvents("touchstart")),
            t.eventsToUnbind = s,
            t.series && t.series[0] && s.push(cn(t.series[0].xAxis, "foundExtremes", function() {
        ...
        shadesMousedown(t, e) {
            ...
            i.inverted && (h = t.chartY,
            n = this.top),
            1 === e ? (this.grabbedCenter = h,
            this.fixedWidth = a,
            this.dragOffset = h - o) : (p = h - n - a / 2,
            0 === e ? p = Math.max(0, p) : 2 === e && p + a >= r && (p = r - a,
            this.reversedExtremes ? (p -= a,
            d = this.getUnionExtremes().dataMin) : l = this.getUnionExtremes().dataMax),
            p !== o && (this.fixedWidth = a,
            cd((c = s.navigatorAxis.toFixedRange(p, p + a, d, l)).min) && cf(this, "setRange", {
        ...
        handlesMousedown(t, e) {
            ...
            this.fixedExtreme = o ? s.min : s.max) : (this.grabbedRight = !0,
        ...
        onMouseMove(t) {
            ...
            (!t.touches || 0 !== t.touches[0].pageX) && (h = (t = i.pointer?.normalize(t) || t).chartX,
            a && (n = e.top,
            h = t.chartY),
            e.grabbedLeft ? (e.hasDragged = !0,
            e.render(0, 0, h - n, e.otherHandlePos)) : e.grabbedRight ? (e.hasDragged = !0,
            e.render(0, 0, e.otherHandlePos, h - n)) : e.grabbedCenter && (e.hasDragged = !0,
            h < r ? h = r : h > s + r - o && (h = s + r - o),
            e.render(0, 0, h - r, h - r + o)),
            e.hasDragged && e.scrollbar && cb(e.scrollbar.options.liveRedraw, !cr && !this.chart.boosted) && (t.DOMType = t.type,
            setTimeout(function() {
                e.onMouseUp(t)
            }, 0)))
        }
        onMouseUp(t) {
            ...
            (this.hasDragged && (!l || !l.hasDragged) || "scrollbar" === t.trigger) && (s = this.getUnionExtremes(),
            this.zoomedMin === this.otherHandlePos ? o = this.fixedExtreme : this.zoomedMax === this.otherHandlePos && (r = this.fixedExtreme),
            ...
            cd((a = h.navigatorAxis.toFixedRange(this.zoomedMin, this.zoomedMax, o, r)).min) && cf(this, "setRange", {
            ...
            "mousemove" !== t.DOMType && "touchmove" !== t.DOMType && (this.grabbedLeft = this.grabbedRight = this.grabbedCenter = this.fixedWidth = this.fixedExtreme = this.otherHandlePos = this.hasDragged = this.dragOffset = null),
            this.navigatorEnabled && cx(this.zoomedMin) && cx(this.zoomedMax) && (i = Math.round(this.zoomedMin),
            e = Math.round(this.zoomedMax),
            this.shades && this.drawMasks(i, e, c, p),
            this.outline && this.drawOutline(i, e, c, p),
            this.navigatorOptions.handles.enabled && Object.keys(this.handles).length === this.handles.length && (this.drawHandle(i, 0, c, p),
            this.drawHandle(e, 1, c, p)))
        }
        removeEvents() {
        ...
        removeBaseSeriesEvents() {
            ...
            t[0].xAxis && cv(t[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes))
        }
        getXAxisOffsets() {
        ...
        init(t) {
            ...
            l.navigatorEnabled) {
                ...
                d || i.series.data ? l.updateNavigatorSeries(!1) : 0 === t.series.length && (l.unbindRedraw = cn(t, "beforeRedraw", function() {
                    t.series.length > 0 && !l.series && (l.setBaseSeries(),
                    l.unbindRedraw())
                })),
                l.reversedExtremes = t.inverted && !l.xAxis.reversed || !t.inverted && l.xAxis.reversed,
                l.renderElements(),
                l.addMouseEvents()
            } else
                l.xAxis = {
                    ...
                    translate: function(e, i) {
                        let s = t.xAxis[0]
                          , o = s.getExtremes()
                          , r = s.len - 2 * h
                          , a = cM("min", s.options.min, o.dataMin)
                          , n = cM("max", s.options.max, o.dataMax) - a;
                ...
                l.xAxis.navigatorAxis.toFixedRange = dO.prototype.toFixedRange.bind(l.xAxis.navigatorAxis);
            if (t.options.scrollbar?.enabled) {
                let e = cy(t.options.scrollbar, {
                    vertical: t.inverted
                });
                cx(e.margin) || (e.margin = t.inverted ? -3 : 3),
                t.scrollbar = l.scrollbar = new cs(t.renderer,e,t),
                cn(l.scrollbar, "changed", function(t) {
                    let e = l.size
                      , i = e * this.to
                      , s = e * this.from;
                    l.hasDragged = l.scrollbar.hasDragged,
                    l.render(0, 0, s, i),
                    this.shouldUpdateExtremes(t.DOMType) && setTimeout(function() {
                        l.onMouseUp(t)
                    })
                })
            }
        ...
        setBaseSeries(t, e) {
            let i = this.chart
              , s = this.baseSeries = [];
            t = t || i.options && i.options.navigator.baseSeries || (i.series.length ? cg(i.series, t => !t.options.isInternal).index : 0),
        ...
        updateNavigatorSeries(t, e) {
            let i = this, s = i.chart, o = i.baseSeries, r = {
                ...
                let e = t.baseSeries;
                return !(0 > o.indexOf(e)) || (e && (cv(e, "updatedData", i.updatedDataHandler),
            ...
            o && o.length && o.forEach(t => {
                ...
                if (c && !1 === i.navigatorOptions.adaptToUpdatedData)
                    return;
                r.name = "Navigator " + o.length,
                d = (n = t.options || {}).navigatorOptions || {},
                p.dataLabels = ck(p.dataLabels),
                (h = cy(n, r, p, d)).pointRange = cb(p.pointRange, d.pointRange, co.plotOptions[h.type || "line"].pointRange);
                let u = d.data || p.data;
                i.hasNavigatorData = i.hasNavigatorData || !!u,
                h.data = u || n.data?.slice(0),
                c && c.options ? c.update(h, e) : (t.navigatorSeries = s.initSeries(h),
                s.setSortedData(),
                t.navigatorSeries.baseSeries = t,
                a.push(t.navigatorSeries))
            }
            ),
            (l.data && !(o && o.length) || cm(l)) && (i.hasNavigatorData = !1,
            (l = ck(l)).forEach( (t, e) => {
                r.name = "Navigator " + (a.length + 1),
                (h = cy(co.navigator.series, {
                    color: s.series[e] && !s.series[e].options.isInternal && s.series[e].color || s.options.colors[e] || s.options.colors[0]
                }, r, t)).data = t.data,
                h.data && (i.hasNavigatorData = !0,
                a.push(s.initSeries(h)))
            }
            )),
        ...
        addBaseSeriesEvents() {
            let t = this
              , e = t.baseSeries || [];
            e[0] && e[0].xAxis && e[0].eventsToUnbind.push(cn(e[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes)),
            e.forEach(i => {
                ...
                !1 !== this.navigatorOptions.adaptToUpdatedData && i.xAxis && i.eventsToUnbind.push(cn(i, "updatedData", this.updatedDataHandler)),
                i.eventsToUnbind.push(cn(i, "remove", function() {
                    e && cp(e, i),
                    this.navigatorSeries && t.series && (cp(t.series, this.navigatorSeries),
                    cd(this.navigatorSeries.options) && this.navigatorSeries.remove(!1),
        ...
        modifyNavigatorAxisExtremes() {
            ...
            if (void 0 !== t.getExtremes) {
                ...
                e && (e.dataMin !== t.min || e.dataMax !== t.max) && (t.min = e.dataMin,
                t.max = e.dataMax)
            }
        }
        modifyBaseAxisExtremes() {
            ...
            !(this.eventArgs && "rangeSelectorButton" === this.eventArgs.trigger) && (l && (t = (e = a) + h),
            d && (t = n + c,
            l || (e = Math.max(a, t - h, i.getBaseSeriesMin(p && p.xData ? p.xData[0] : -Number.MAX_VALUE)))),
            u && (l || d) && cx(e) && (this.min = this.userMin = e,
        ...
        updatedDataHandler() {
            ...
            t.stickToMax = cb(this.chart.options.navigator && this.chart.options.navigator.stickToMax, i),
            t.stickToMin = t.shouldStickToMin(this, t),
            e && !t.hasNavigatorData && (e.options.pointStart = this.getColumn("x")[0],
        ...
        addChartEvents() {
            ...
            this.eventsToUnbind.push(cn(this.chart, "redraw", function() {
                ...
                this[e] = (this[e] || 0) + (t.navigatorEnabled || !this.inverted ? t.height + (this.scrollbar?.options.margin || 0) + t.scrollbarHeight : 0) + (t.navigatorOptions.margin || 0)
        ...
        destroy() {
            this.removeEvents(),
            this.xAxis && (cp(this.chart.xAxis, this.xAxis),
            cp(this.chart.axes, this.xAxis)),
            this.yAxis && (cp(this.chart.yAxis, this.yAxis),
            cp(this.chart.axes, this.yAxis)),
            (this.series || []).forEach(t => {
                t.destroy && t.destroy()
            }
            ),
    ...
    !function(t) {
        function e(t, i, s, o, r=[], a=0, n) {
            ...
            for (p = 0; p < v; p++) {
                if (m = p && r[p - 1] > s,
                r[p] < i && (x = p),
                p === v - 1 || r[p + 1] - r[p] > 5 * a || m) {
                    if (r[p] > b) {
                        for (u = d.getTimeTicks(t, r[x], r[p], o); u.length && u[0] <= b; )
                            u.shift();
                        u.length && (b = u[u.length - 1]),
                        c.push(y.length),
                        y = y.concat(u)
                    }
                    x = p + 1
            ...
            if (u) {
                if (f = u.info,
                n && f.unitRange <= cL.hour) {
                    for (x = 1,
                    p = y.length - 1; x < p; x++)
                        d.dateFormat("%d", y[x]) !== d.dateFormat("%d", y[x - 1]) && (h[y[x]] = "day",
                        g = !0);
                    g && (h[y[0]] = "day"),
                    f.higherRanks = h
                }
            ...
            if (n && cC(l)) {
                ...
                for (; c--; )
                    r = this.translate(y[c]),
                    a && (i[c] = a - r),
                    e[c] = a = r;
                for (i.sort( (t, e) => t - e),
                (n = i[Math.floor(i.length / 2)]) < .6 * l && (n = null),
                c = y[t - 1] > s ? t - 1 : t,
                a = void 0; c--; )
                    d = Math.abs(a - (r = e[c])),
                    a && d < .8 * l && (null === n || d < .8 * n) ? (h[y[c]] && !h[y[c + 1]] ? (o = c + 1,
                    a = r) : o = c,
                    y.splice(o, 1)) : a = r
            }
            return y
        ...
        function i(t) {
            ...
            if (!e)
                return t;
            let i = e.length - 1, s;
            return (t < 0 ? t = e[0] : t > i ? t = e[i] : (i = Math.floor(t),
            s = t - i),
            void 0 !== s && void 0 !== e[i]) ? e[i] + (s ? s * (e[i + 1] - e[i]) : 0) : t
        }
        function s(t) {
            let e = this.ordinal
        ...
        function a() {
            ...
            if (this.isXAxis && cC(e.overscroll) && 0 !== e.overscroll && cO(this.max) && cO(this.min) && (this.options.ordinal && !this.ordinal.originalOrdinalRange && this.ordinal.getExtendedPositions(!1),
            this.isFullRange = cC(this.dataMin) && cC(this.dataMax) && this.max - this.min == this.dataMax - this.dataMin,
            this.max === this.dataMax && (t?.trigger !== "pan" || this.isInternal) && t?.trigger !== "navigator")) {
                let i = this.ordinal.convertOverscroll(e.overscroll);
                this.max += i,
                !this.isInternal && cC(this.userMin) && t?.trigger !== "mousewheel" && (this.min += i)
            }
        }
        function n() {
        ...
        function l(t) {
            ...
            if (o?.type !== "y" && e.options.ordinal && e.series.length && (!t.touches || t.touches.length <= 1)) {
                ...
                (o = e.navigatorAxis.toFixedRange(void 0, void 0, y.apply(x, [b.apply(x, [c, !0]) + f]), y.apply(x, [b.apply(x, [p, !0]) + f]))).min >= Math.min(a[0], c) && o.max <= Math.max(a[a.length - 1], p) + i && e.setExtremes(o.min, o.max, !0, !1, {
                    trigger: "pan"
                }),
                this.mouseDownX = s,
                cT(this.container, {
        ...
        function d() {
            let t = this.xAxis;
            t?.options.ordinal && (delete t.ordinal.index,
        ...
        t.compose = function(t, o, p) {
            let u = t.prototype;
            return u.ordinal2lin || (u.getTimeTicks = e,
            u.index2val = i,
            u.lin2val = s,
            u.val2lin = c,
            u.ordinal2lin = u.val2lin,
            cS(t, "afterInit", r),
            cS(t, "foundExtremes", a),
            cS(t, "afterSetScale", n),
            cS(t, "initialAxisTranslation", h),
            cS(p, "pan", l),
            cS(p, "touchpan", l),
            cS(o, "updatedData", d)),
            t
        ...
        t.Additions = class {
            ...
            beforeSetTickPositions() {
                ...
                if (a || r) {
                    ...
                    if (t.series.forEach(function(t, e) {
                        ...
                        if (l = [],
                        e > 0 && "highcharts-navigator-series" !== t.options.id && s.length > 1 && (y = i !== s[1] - s[0]),
                        i = s[1] - s[0],
                        t.boosted && (b = t.boosted),
                        t.reserveSpace() && (!1 !== t.takeOrdinalPosition || r) && (h = (f = f.concat(s)).length,
                        f.sort(function(t, e) {
                            return t - e
                        }),
                        m = Math.min(m, cE(t.closestPointRange, m)),
                        h)) {
                            for (e = 0; e < h - 1; )
                                f[e] !== f[e + 1] && l.push(f[e + 1]),
                                e++;
                            l[0] !== f[0] && l.unshift(f[0]),
                            f = l
                        }
                    }),
                    t.ordinal.originalOrdinalRange || (t.ordinal.originalOrdinalRange = (f.length - 1) * m),
                    y && b && (f.pop(),
                    f.shift()),
                    (h = f.length) > 2) {
                        for (d = f[1] - f[0],
                        ...
                        t.options.overscroll && (2 === h ? m = f[1] - f[0] : 1 === h ? (m = n,
                        f = [f[0], f[0] + m]) : m = e.overscrollPointsRange);
                    x || t.forceOrdinal ? (t.options.overscroll && (e.overscrollPointsRange = m,
                    f = f.concat(e.getOverscrollPositions())),
                    e.positions = f,
                    c = t.ordinal2lin(Math.max(s, f[0]), !0),
                    p = Math.max(t.ordinal2lin(Math.min(o, f[f.length - 1]), !0), 1),
                    e.slope = u = (o - s) / (p - c),
                    e.offset = s - c * u) : (e.overscrollPointsRange = cE(t.closestPointRange, e.overscrollPointsRange),
                    e.positions = t.ordinal.slope = e.offset = void 0)
                }
                t.isOrdinal = a && x,
                e.groupIntervalFactor = null
            }
            static findIndexOf(t, e, i) {
                let s = 0, o = t.length - 1, r;
                for (; s < o; )
                    t[r = Math.ceil((s + o) / 2)] <= e ? s = r : o = r - 1;
                return t[s] === e || i ? s : -1
            }
            getExtendedPositions(t=!0) {
                ...
                l?.closestPointRange !== l?.basePointRange && l.currentDataGrouping && (h.forceOrdinal = !0),
                i.ordinal.beforeSetTickPositions.apply({
                    axis: h
                }),
                !i.ordinal.originalOrdinalRange && h.ordinal.originalOrdinalRange && (i.ordinal.originalOrdinalRange = h.ordinal.originalOrdinalRange),
            ...
            convertOverscroll(t=0) {
                ...
                if (cB(t)) {
                    let e = parseInt(t, 10);
                    if (!1 === i.isFullRange && cO(i.min) && cO(i.max) && (this.originalOrdinalRange = i.max - i.min),
                    /%$/.test(t))
                        return s(e / 100);
                    if (/px/.test(t)) {
    ...
    let cD = X
      ...
      , {defaultOptions: cR} = tY
      , {composed: cN} = V
      , {addEvent: cW, defined: cG, extend: cX, isNumber: cH, merge: cF, pick: cY, pushUnique: cj} = tx
      , cU = [];
    function cV() {
        let t, e, i = this.range, s = i.type, o = this.max, r = this.chart.time, a = function(t, e) {
            ...
            let a = r.makeTime.apply(r, o)
              , n = r.toParts(a);
            return "month" === s && i[1] === n[1] && 1 === Math.abs(e) && (o[0] = i[0],
            o[1] = i[1],
            o[2] = 0),
            (a = r.makeTime.apply(r, o)) - t
        };
        cH(i) ? (t = o - i,
        e = i) : i && (t = o + a(o, -(i.count || 1)),
        this.chart && this.chart.setFixedRange(o - t));
        let n = cY(this.dataMin, 5e-324);
        return cH(t) || (t = n),
        t <= n && (t = n,
        void 0 === e && (e = a(t, i.count)),
        this.newMax = Math.min(t + e, cY(this.dataMax, Number.MAX_VALUE))),
        cH(o) ? !cH(i) && i && i._offsetMin && (t += i._offsetMin) : t = void 0,
        t
    }
    function c$() {
    ...
    function cZ() {
        ...
        if (t) {
            cH(t.deferredYTDClick) && (t.clickButton(t.deferredYTDClick),
            delete t.deferredYTDClick);
    ...
    function cq() {
        ...
        cH(i.min) && e.render(i.min, i.max),
        s.display && "top" === o && o === s.options.verticalAlign && (t = cF(this.spacingBox),
    ...
    function cQ(t) {
        ...
        if (e && e.enabled && !cG(r) && this.options.rangeSelector && (this.options.rangeSelector.enabled = !0,
        this.rangeSelector = r = new s(this)),
        this.extraBottomMargin = !1,
        this.extraTopMargin = !1,
        r) {
            let t = e && e.verticalAlign || r.options && r.options.verticalAlign;
            r.options.floating || ("bottom" === t ? this.extraBottomMargin = !0 : "middle" !== t && (this.extraTopMargin = !0)),
    ...
    let c0 = function(t, e, i) {
        ...
        cj(cN, "RangeSelector")) {
            let i = e.prototype;
            t.prototype.minFromRange = cV,
            cW(e, "afterGetContainer", c_),
            cW(e, "beforeRender", cZ),
            cW(e, "destroy", cK),
            cW(e, "getMargins", cJ),
            cW(e, "redraw", cq),
            cW(e, "update", cQ),
      ...
      , {defaultOptions: c1} = tY
      , {format: c2} = eI
      , {addEvent: c3, createElement: c5, css: c6, defined: c9, destroyObjectProperties: c4, discardElement: c8, extend: c7, fireEvent: pt, isNumber: pe, isString: pi, merge: ps, objectEach: po, pick: pr, splat: pa} = tx;
    function pn(t) {
        let e = e => RegExp(`%[[a-zA-Z]*${e}`).test(t);
        if (pi(t) ? -1 !== t.indexOf("%L") : t.fractionalSecondDigits)
            return "text";
        let i = pi(t) ? ["a", "A", "d", "e", "w", "b", "B", "m", "o", "y", "Y"].some(e) : t.dateStyle || t.day || t.month || t.year
          , s = pi(t) ? ["H", "k", "I", "l", "M", "S"].some(e) : t.timeStyle || t.hour || t.minute || t.second;
    ...
    class ph {
        ...
        clickButton(t, e) {
            ...
            if (null !== h && null !== l) {
                if (this.setSelected(t),
                n && (this.forcedDataGrouping = !0,
                oo.prototype.setDataGrouping.call(o || {
                    chart: this.chart
                }, n, !1),
                ...
                "month" === a || "year" === a)
                    ...
                    d = o.minFromRange.call(f),
                    pe(f.newMax) && (c = f.newMax),
                    x = !1) : u = s;
                else if (u)
                    pe(c) && (c = Math.min((d = Math.max(c - u, h)) + u, l),
                    x = !1);
                else if ("ytd" === a)
                    if (o)
                        !o.hasData() || pe(l) && pe(h) || (h = Number.MAX_VALUE,
                        l = -Number.MAX_VALUE,
                        i.series.forEach(t => {
                            let e = t.getColumn("x");
                            e.length && (h = Math.min(e[0], h),
                            l = Math.max(e[e.length - 1], l))
                        }
                        ),
                        e = !1),
                        pe(l) && pe(h) && (d = g = (m = this.getYTDExtremes(l, h)).min,
                        c = m.max);
                    else {
                    ...
                    "all" === a && o && (i.navigator && i.navigator.baseSeries[0] && (i.navigator.baseSeries[0].xAxis.options.range = void 0),
                    d = h,
                    c = l);
                if (x && s._offsetMin && c9(d) && (d += s._offsetMin),
                s._offsetMax && c9(c) && (c += s._offsetMax),
                this.dropdown && (this.dropdown.selectedIndex = t + 1),
                o)
                    (pe(d) || pe(c)) && (o.setExtremes(d, c, pr(e, !0), void 0, {
                    ...
                    let t = c3(i, "afterCreateAxes", function() {
                        let t = i.xAxis[0];
                        t.range = t.options.range = u,
                        t.min = t.options.min = g
                    });
                    c3(i, "load", function() {
                        let e = i.xAxis[0];
                        i.setFixedRange(s._range),
        ...
        init(t) {
            ...
            e.options = i,
            e.buttons = [],
            e.buttonOptions = o.map(t => (t.type && s.rangeSelector && (t.text ?? (t.text = s.rangeSelector[`${t.type}Text`]),
            ...
            t)),
            this.eventsToUnbind = [],
            this.eventsToUnbind.push(c3(t.container, "mousedown", a)),
            this.eventsToUnbind.push(c3(t, "resize", a)),
            o.forEach(e.computeButtonRange),
            void 0 !== r && o[r] && this.clickButton(r, !1),
            this.eventsToUnbind.push(c3(t, "load", function() {
        ...
        updateButtonStates() {
            ...
            t.buttonOptions.forEach( (e, i) => {
                ...
                o.isOrdinal && o.ordinal?.positions && s && r < s) {
                    ...
                    ("month" === h || "year" === h) && r + 36e5 >= ({
                        month: 28,
                        year: 365
                    })[h] * n * c - y && r - 36e5 <= ({
                        month: 31,
                        year: 366
                    })[h] * n * c + y ? A = !0 : "ytd" === h ? (A = u - p + y === r,
                    S = !k) : "all" === h && (A = o.max - o.min >= d - l);
            ...
            null !== v ? (m[v] = 2,
            t.setSelected(v),
            this.dropdown && (this.dropdown.selectedIndex = v + 1)) : (t.setSelected(),
        ...
        computeButtonRange(t) {
            ...
            t._offsetMin = pr(t.offsetMin, 0),
            t._offsetMax = pr(t.offsetMax, 0),
        ...
        setInputValue(t, e) {
            ...
            if (o) {
                ...
                let t = o.getAttribute("data-hc-time")
                  , a = c9(t) ? Number(t) : void 0;
                if (c9(e)) {
                    let t = a;
                    c9(t) && o.setAttribute("data-hc-time-previous", t),
        ...
        drawInput(t) {
            ...
            function d(t) {
                let {maxInput: i, minInput: s} = o
                  ...
                  , c = o.getInputValue(t);
                pe(c) && c !== d && (l && i && pe(n) ? c > Number(i.getAttribute("data-hc-time")) ? c = void 0 : c < n && (c = n) : s && pe(h) && (c < Number(s.getAttribute("data-hc-time")) ? c = void 0 : c > h && (c = h)),
                void 0 !== c && r.setExtremes(l ? c : r.min, l ? r.max : c, void 0, void 0, {
            ...
            g.setAttribute("type", pn(n.inputDateFormat || "%e %b %Y")),
            e.styledMode || (p.css(ps(r, n.labelStyle)),
            u.css(ps({
                color: "#333333"
            }, r, n.inputStyle)),
            c6(g, c7({
            ...
            g.onkeydown = e => {
                f = !0,
                ("ArrowUp" === e.key || "ArrowDown" === e.key || "Tab" === e.key) && d(t)
            }
            ,
            g.onkeyup = () => {
                f = !1
        ...
        render(t, e) {
            ...
            if (s.inputEnabled) {
                ...
                this.chart.styledMode || (this.maxLabel?.css(s.labelStyle),
                this.minLabel?.css(s.labelStyle));
                ...
                this.inputGroup && (this.inputGroup.destroy(),
        ...
        renderButtons() {
            ...
            }), a && a.hover, a && a.select, a && a.disabled).hide().add(this.group),
            c3(n, "touchstart", () => {
                n.style.fontSize = "16px"
            }
            );
            let l = V.isMS ? "mouseover" : "mouseenter"
              , d = V.isMS ? "mouseout" : "mouseleave";
            c3(n, l, () => {
            ...
            this.chart.styledMode || (this.zoomText.css(i.labelStyle),
        ...
        createButton(t, e, i, s) {
            ...
            r[e] = h.button(t.text ?? "", 0, 0, i => {
                let s, o = t.events && t.events.click;
                o && (s = o.call(t, i)),
                !1 !== s && this.clickButton(e),
                this.isActive = !0
            }
        ...
        alignElements() {
            let {buttonGroup: t, buttons: e, chart: i, group: s, inputGroup: o, options: r, zoomText: a} = this
              , n = i.options
              , h = n.exporting && !1 !== n.exporting.enabled && n.navigation && n.navigation.buttonOptions
            ...
            if (s && l && d) {
                ...
                if (t) {
                    ...
                    this.buttonGroup?.translateY && this.dropdownLabel.attr({
                        y: this.buttonGroup.translateY
                    }),
                    s.placed = t.placed = i.hasLoaded
                }
                let h = 0;
                r.inputEnabled && o && (h = p(o, d, "right" === l.align || "right" === d.align),
                "left" === d.align ? n = u : "right" === d.align && (n = -Math.max(i.axisOffset[1], -h)),
                o.align({
                    y: d.y,
                ...
                "top" === c ? (r.floating && (m = 0),
                i.titleOffset && i.titleOffset[0] && (m = i.titleOffset[0]),
                m += i.margin[0] - i.spacing[0] || 0) : "middle" === c && (d.y === l.y ? m = g : (d.y || l.y) && (d.y < 0 || l.y < 0 ? m -= Math.min(d.y, l.y) : m = g - f)),
                s.translate(r.x, r.y + Math.floor(m));
                let {minInput: x, maxInput: y, dropdown: b} = this;
                r.inputEnabled && x && y && (x.style.marginTop = s.translateY + "px",
            ...
            this.isDirty) {
                ...
                if (t.length < this.buttonOptions.length)
                    for (let e = this.buttonOptions.length - 1; e >= t.length; e--) {
                        ...
                        t?.destroy(),
                        this.dropdown?.options.remove(e + 1)
                    }
                for (let s = e - 1; s >= 0; s--) {
                    let e = t[s];
                ...
                if (t.length > this.buttonOptions.length)
                    for (let e = this.buttonOptions.length; e < t.length; e++)
                        this.createButton(t[e], e, a, r),
                        this.computeButtonRange(t[e]);
                this.buttonOptions = this.options.buttons ?? [],
                c9(this.options.selected) && this.buttons.length && this.clickButton(this.options.selected, !1)
            }
        }
        alignButtonGroup(t, e) {
            let {chart: i, options: s, buttonGroup: o, dropdown: r, dropdownLabel: a} = this
              ...
              , d = i.plotLeft;
            "right" === n.align ? (l += t - h,
            this.hasVisibleDropdown && (d = i.chartWidth + t - this.maxButtonWidth() - 20)) : "center" === n.align && (l -= h / 2,
        ...
        handleCollision(t) {
            ...
            ;
            s && i ? n.align === r.align ? (h(),
            o > e.plotWidth + t - 20 ? this.collapseButtons() : this.expandButtons()) : o - t + s.getBBox().width > e.plotWidth ? "responsive" === a || "always" === a ? this.collapseButtons() : h() : this.expandButtons() : i && "responsive" === a && (o > e.plotWidth ? this.collapseButtons() : this.expandButtons()),
            i && ("always" === a && this.collapseButtons(),
            "never" === a && this.expandButtons()),
            this.alignButtonGroup(t)
        }
        collapseButtons() {
            let {buttons: t, zoomText: e} = this;
            !0 !== this.isCollapsed && (this.isCollapsed = !0,
            e.hide(),
        ...
        expandButtons() {
            let {buttons: t, zoomText: e} = this;
            !1 !== this.isCollapsed && (this.isCollapsed = !1,
            this.hideDropdown(),
            e.show(),
        ...
        getHeight() {
            ...
            if (t.height)
                return t.height;
            this.alignElements(),
            n = e ? e.getBBox(!0).height + 13 + o : 0;
            let h = Math.min(a, r);
            return (a < 0 && r < 0 || a > 0 && r > 0) && (n += Math.abs(h)),
            n
        }
        titleCollision(t) {
        ...
        update(t, e=!0) {
            let i = this.chart;
            if (ps(!0, this.options, t),
            this.options.selected && this.options.selected >= this.options.buttons.length && (this.options.selected = void 0,
            i.options.rangeSelector.selected = void 0),
            c9(t.enabled))
                return this.destroy(),
                this.init(i);
            this.isDirty = !!t.buttons || !!t.buttonTheme,
            e && this.render()
        }
        destroy() {
            let t = this
              , e = t.minInput
              , i = t.maxInput;
            t.eventsToUnbind && (t.eventsToUnbind.forEach(t => t()),
            t.eventsToUnbind = void 0),
            c4(t.buttons),
            e && (e.onfocus = e.onblur = e.onchange = null),
            i && (i.onfocus = i.onblur = i.onchange = null),
            po(t, function(e, i) {
                e && "chart" !== i && (e instanceof ic ? e.destroy() : e instanceof window.HTMLElement && c8(e),
                delete t[i]),
                e !== ph.prototype[i] && (t[i] = null)
            }, this),
            this.buttons = []
        }
    }
    ...
    let {format: pl} = eI
      , {getOptions: pd} = tY
      , {setFixedRange: pc} = dR
      , {addEvent: pp, clamp: pu, crisp: pg, defined: pf, extend: pm, find: px, isNumber: py, isString: pb, merge: pv, pick: pk, splat: pM} = tx;
    function pw(t, e, i) {
        return "xAxis" === t ? {
            minPadding: 0,
            maxPadding: 0,
    ...
    function pS(t, e) {
        if ("xAxis" === t) {
            let t = pk(e.navigator?.enabled, dB.enabled, !0)
              , i = {
                type: "datetime",
                categories: void 0
            };
            return t && (i.startOnTick = !1,
            i.endOnTick = !1),
            i
        }
        return {}
    ...
    class pA extends ny {
        init(t, e) {
            let i = pd()
              , s = t.xAxis
              , o = t.yAxis
              , r = pk(t.navigator?.enabled, dB.enabled, !0);
            ...
            t.xAxis = s,
            t.yAxis = o,
            a.xAxis = pM(t.xAxis || {}).map(e => pv(pw("xAxis", e, i.xAxis), e, pS("xAxis", t))),
            a.yAxis = pM(t.yAxis || {}).map(t => pv(pw("yAxis", t, i.yAxis), t)),
            super.init(a, e)
        }
        createAxis(t, e) {
            return e.axis = pv(pw(t, e.axis, pd()[t]), e.axis, pS(t, this.userOptions)),
            super.createAxis(t, e)
        }
    }
    pp(ny, "update", function(t) {
        let e = t.options;
        "scrollbar"in e && this.navigator && (pv(!0, this.options.scrollbar, e.scrollbar),
    ...
    function(t) {
        function e(t) {
            if (!(this.crosshair?.label?.enabled && this.cross && py(this.min) && py(this.max)))
                return;
            ...
            i && (v = i.lin2log(this.min),
            k = i.lin2log(this.max));
            ...
            o ? (g = d ? (p.plotX || 0) + a : c.chartX,
            f = n + (r ? 0 : this.height)) : (g = a + this.offset + (r ? h : 0),
            f = d ? (p.plotY || 0) + n : c.chartY),
            m || s.formatter || (this.dateTime && (x = "%b %d, %Y"),
            m = "{value" + (x ? ":" + x : "") + "}");
            let w = d ? this.isXAxis ? p.x : p.y : this.toValue(o ? c.chartX : c.chartY)
              , S = p?.series ? p.series.isPointInside(p) : py(w) && w > v && w < k
              , A = "";
            m ? A = pl(m, {
                value: w
            }, e) : s.formatter && py(w) && (A = s.formatter.call(this, w)),
            u.attr({
                text: A,
                x: g,
                y: f,
            ...
            let T = u.getBBox();
            !py(u.x) || o || r || (g = u.x - T.width / 2),
            py(u.y) && (o ? (l && !r || !l && r) && (f = u.y - T.height) : f = u.y - T.height / 2),
            y = o ? {
                left: a,
                right: a + this.width
            } : {
            ...
            C < y.left && (b = y.left - C),
            C + T.width >= y.right && (b = -(C + T.width - y.right)),
            u.attr({
                x: Math.max(0, g + b),
                y: Math.max(0, f),
        ...
        function s(t) {
            ...
            if (e.options.isStock && "yAxis" === this.coll) {
                ...
                !s[e] && o.enabled && (15 === o.distance && 1 === this.side && (o.distance = 0),
        ...
        function r(t) {
            let e = this.isLinked && !this.series && this.linkedParent ? this.linkedParent.series : this.series
              , {chart: i, horiz: s} = this
              , o = i.renderer
              , r = []
              , {acrossPanes: a=!0, force: n, translatedValue: h, value: l} = t
              , d = (this.isXAxis ? i.yAxis : i.xAxis) || [];
            function c(t, e, i) {
                r.push(["M", s ? t : e, s ? e : t], ["L", s ? t : i, s ? i : t])
            }
            let p = [], u, g;
            if (i.options.isStock && ("xAxis" === this.coll || "yAxis" === this.coll)) {
                let f, m;
                for (let s of (t.preventDefault(),
                f = "xAxis" === this.coll ? "yAxis" : "xAxis",
                m = this.options[f],
                p = a && !this.options.isInternal ? d.filter(t => !t.options.isInternal) : py(m) ? [i[f][m]] : pb(m) ? [i.get(m)] : e.map(t => t[f]),
                d))
                    if (!s.options.isInternal) {
                        let t = s.isXAxis ? "yAxis" : "xAxis";
                        this === (pf(s.options[t]) && i[t][s.options[t]]) && p.push(s)
                    }
                for (let t of (u = p.length ? [] : [this.isXAxis ? i.yAxis[0] : i.xAxis[0]],
                p))
                    -1 !== u.indexOf(t) || px(u, e => e.pos === t.pos && e.len === t.len) || u.push(t);
                if (py(g = pk(h, this.translate(l || 0, void 0, void 0, t.old)))) {
                    let t, e = s ? g + this.pos : this.pos + this.len - g;
                    if ("pass" !== n && (e < this.pos || e > this.pos + this.len) && (n ? e = pu(e, this.pos, this.pos + this.len) : t = !0),
                    !t) {
                        let t = s ? "top" : "left"
                          , i = s ? "height" : "width";
                        if (!a && (this.options[t] || this.options[i]))
                            c(e, this[t], this[t] + this[i]);
                        else
                            for (let t of u)
                                c(e, t.pos, t.pos + t.len)
                    }
                }
        ...
        function h(t, e) {
            for (let i = 0; i < t.length; i += 2) {
                let s = t[i]
                  , o = t[i + 1];
                pf(s[1]) && s[1] === o[1] && (s[1] = o[1] = pg(s[1], e)),
                pf(s[2]) && s[2] === o[2] && (s[2] = o[2] = pg(s[2], e))
            }
            return t
        }
        t.compose = function(t, l, d, c) {
            let p = d.prototype;
            p.forceCropping || (pp(l, "afterDrawCrosshair", e),
            pp(l, "afterHideCrosshair", i),
            pp(l, "autoLabelAlign", s),
            pp(l, "destroy", o),
            pp(l, "getPlotLinePath", r),
            t.prototype.setFixedRange = pc,
            p.forceCropping = n,
            pp(d, "setOptions", a),
    ...
    let pT = pA
      , {column: {prototype: {pointClass: pC}}} = r_.seriesTypes
      , {column: pP} = r_.seriesTypes
      , {crisp: pO, extend: pE, merge: pL} = tx
      , {defaultOptions: pB} = tY;
    class pD extends pP {
        extendStem(t, e, i) {
            let s = t[0]
              , o = t[1];
        ...
        getPointPath(t, e) {
            let i = e.strokeWidth()
              ...
              , a = [["M", o, Math.round(t.yBottom)], ["L", o, Math.round(t.plotHigh)]];
            if (null !== t.close) {
                let e = pO(t.plotClose, i);
                a.push(["M", o, e], ["L", o + r, e]),
        ...
        drawSinglePoint(t) {
            ...
            void 0 !== t.plotY && (o || (t.graphic = o = i.renderer.path().add(e.group)),
            i.styledMode || o.attr(e.pointAttribs(t, t.selected && "select")),
        ...
        translate() {
            ...
            t.points.forEach(function(o) {
                i.forEach(function(i, r) {
                    let a = o[i];
                    null !== a && (t.dataModify && (a = t.dataModify.modifyValue(a)),
    ...
    let {composed: pR} = V
      , {hlc: pN} = r_.seriesTypes
      , {addEvent: pW, crisp: pG, extend: pX, merge: pH, pushUnique: pF} = tx;
    function pY(t) {
        let e = t.options
          , i = e.dataGrouping;
    ...
    class pU extends pN {
        static compose(t) {
            pF(pR, "OHLCSeries") && (pW(t, "afterSetOptions", pY),
            pW(t, "init", pj))
        }
        getPointPath(t, e) {
        ...
        pointAttribs(t, e) {
            let i = super.pointAttribs.call(this, t, e)
              , s = this.options;
            return delete i.fill,
            !t.options.color && s.upColor && t.open < t.close && (i.stroke = s.upColor),
            i
        }
        toYData(t) {
    ...
    let {column: pV, ohlc: p$} = r_.seriesTypes
      , {crisp: p_, merge: pZ} = tx;
    class pq extends p$ {
        pointAttribs(t, e) {
            let i = pV.prototype.pointAttribs.call(this, t, e)
              , s = this.options
              , o = t.open < t.close
              , r = s.lineColor || this.color
              , a = t.color || this.color;
            if (i["stroke-width"] = s.lineWidth,
        ...
        drawPoints() {
            ...
            for (let s of t) {
                ...
                if (void 0 !== s.plotY) {
                    ...
                    this.chart.styledMode || t.attr(this.pointAttribs(s, s.selected && "select")).shadow(this.options.shadow);
                    let g = t.strokeWidth();
                    d = p_(s.plotX || 0, g),
                    a = Math.min(o = s.plotOpen, r = s.plotClose),
                    n = Math.max(o, r),
                    p = Math.round(s.shapeArgs.width / 2),
                    h = i ? n !== s.yBottom : Math.round(a) !== Math.round(s.plotHigh || 0),
                    l = i ? Math.round(a) !== Math.round(s.plotHigh || 0) : n !== s.yBottom,
                    a = p_(a, g),
                    n = p_(n, g),
                    (c = []).push(["M", d - p, n], ["L", d - p, a], ["L", d + p, a], ["L", d + p, n], ["Z"], ["M", d, a], ["L", d, h ? Math.round(i ? s.yBottom : s.plotHigh) : a], ["M", d, n], ["L", d, l ? Math.round(i ? s.plotHigh : s.yBottom) : n]),
                    t[u ? "attr" : "animate"]({
                        d: c
    ...
    let {column: {prototype: {pointClass: pK}}} = r_.seriesTypes
      , {isNumber: pJ} = tx
      , pQ = class extends pK {
        constructor() {
            super(...arguments),
    ...
    !function(t) {
        ...
        function i(t, e, i, s, o) {
            ...
            return n.push(["M", r, a], ["L", t, e + s], ["L", t, e], ["L", t + i, e], ["L", t + i, e + s], ["L", t, e + s], ["Z"]),
            n
        }
        function s(t, e) {
            t[e + "pin"] = function(i, s, o, r, a) {
                let n, h = a && a.anchorX, l = a && a.anchorY;
                if ("circle" === e && r > o && (i -= Math.round((r - o) / 2),
                o = r),
                n = t[e](i, s, o, r, a),
                h && l) {
                    let a = h;
    ...
    let p0 = H
      ...
      , {prototype: p2} = hO
      , {prototype: p3} = ay
      , {defined: p5, pushUnique: p6, stableSort: p9} = tx;
    var p4 = F || (F = {});
    function p8(t) {
    ...
    function p7() {
        ...
        if (r && r.visible && f) {
            for (m = (r.pointXOffset || 0) + (r.barW || 0) / 2,
            v = r.currentDataGrouping,
            y = n[f - 1].x + (v ? v.totalRange : 0),
            p9(s, (t, e) => t.x - e.x),
            g = "plot" + g[0].toUpperCase() + g.substr(1); f-- && s[c]; )
                if (x = n[f],
                (p = s[c]).y = x.y,
                x.x <= p.x && void 0 !== x[g]) {
                    if (p.x <= y && (p.plotY = x[g],
                    x.x < p.x && !a && (b = n[f + 1])) && void 0 !== b[g])
                        if (p5(p.plotX) && r.is("spline")) {
                            let t = [x.plotX || 0, x.plotY || 0], e = [b.plotX || 0, b.plotY || 0], i = x.controlPoints?.high || t, s = b.controlPoints?.low || e, o = (o, r) => Math.pow(1 - o, 3) * t[r] + 3 * (1 - o) * (1 - o) * o * i[r] + 3 * (1 - o) * o * o * s[r] + o * o * o * e[r], r = 0, a = 1, n;
                            for (let t = 0; t < 100; t++) {
                                let t = (r + a) / 2
                                  , e = o(t, 0);
                                if (null === e)
        ...
        s.forEach( (e, i) => {
            let o;
            e.plotX += m,
            (void 0 === e.plotY || h) && (e.plotX >= 0 && e.plotX <= l.len ? h ? (e.plotY = l.translate(e.x, 0, 1, 0, 1),
            e.plotX = p5(e.y) ? d.translate(e.y, 0, 0, 0, 1) : 0) : e.plotY = (l.opposite ? 0 : t.yAxis.len) + l.offset : e.shapeArgs = {}),
            (u = s[i - 1]) && u.plotX === e.plotX && (void 0 === u.stackIndex && (u.stackIndex = 0),
            o = u.stackIndex + 1),
            e.stackIndex = o
        }
        ),
    ...
    let ut = F
      , {noop: ue} = V
      , {distribute: ui} = eX
      , {series: us, seriesTypes: {column: uo}} = r_
      , {addEvent: ur, defined: ua, extend: un, isNumber: uh, merge: ul, objectEach: ud, wrap: uc} = tx;
    class up extends uo {
        animate(t) {
            t && this.setClip()
        }
        drawPoints() {
            ...
            for (s = c.length; s--; )
                ...
                t = o.plotX,
                a = o.stackIndex,
                i = o.options.shape || f.shape,
                void 0 !== (e = o.plotY) && (e = o.plotY + m - (void 0 !== a && a * f.stackDistance)),
                o.anchorX = a ? void 0 : o.plotX,
                n = a ? void 0 : o.plotY,
                d = "flag" !== i,
                r = o.graphic,
                void 0 !== e && t >= 0 && !l ? (r && o.hasNewShapeType() && (r = r.destroy()),
                r || (r = o.graphic = u.label("", 0, void 0, i, void 0, void 0, f.useHTML).addClass(o.getClassName()).add(this.markerGroup),
                ...
                p.styledMode || r.attr(this.pointAttribs(o)).css(ul(f.style, o.style)).shadow(f.shadow),
                t > 0 && (t -= r.strokeWidth() % 2),
                h = {
                    y: e,
                    anchorY: n
                },
                f.allowOverlapX && (h.x = t,
                h.anchorX = o.anchorX),
                r.attr({
                    text: o.options.title ?? f.title ?? "A"
                })[r.isNew ? "attr" : "animate"](h),
                f.allowOverlapX || (y[o.plotX] ? y[o.plotX].size = Math.max(y[o.plotX].size, r.width || 0) : y[o.plotX] = {
                    align: .5 * !!d,
                    size: r.width || 0,
                    target: t,
                    anchorX: t
        ...
        drawTracker() {
            let t = this.points;
            for (let e of (super.drawTracker(),
            t)) {
                let i = e.graphic;
                i && (e.unbindMouseOver && e.unbindMouseOver(),
                e.unbindMouseOver = ur(i.element, "mouseover", function() {
                    for (let s of (e.stackIndex > 0 && !e.raised && (e._y = i.y,
                    i.attr({
                        y: e._y - 8
                    }),
                    e.raised = !0),
                    t))
                        s !== e && s.raised && s.graphic && (s.graphic.attr({
                            y: s._y
                        }),
                        s.raised = !1)
                }))
        ...
        pointAttribs(t, e) {
            ...
            return e && (a = i.states[e].fillColor,
    ...
    !function(t) {
        ...
        function a() {
            ...
            this.drawBreaks(this.yAxis, uy(this.pointArrayMap, ["y"]))
        }
        function n(t, e) {
            ...
            if (t?.brokenAxis?.hasBreaks) {
                ...
                e.forEach(function(e) {
                    i = n?.breakArray || [],
                    s = t.isXAxis ? t.min : uy(r.options.threshold, t.min),
                    a.forEach(function(r) {
                        o = r["stack" + e.toUpperCase()] ?? r[e],
                        i.forEach(function(e) {
                            if (ux(s) && ux(o)) {
                                let i = "";
                                s < e.from && o > e.to || s > e.from && o < e.from ? i = "pointBreak" : (s < e.from && o > e.from && o < e.to || s > e.from && o > e.to && o < e.from) && (i = "pointInBreak"),
                                i && uf(t, i, {
                                    point: r,
                                    brk: e
                                })
        ...
        function h() {
            ...
            if (o && r > 0) {
                let t, a;
                for ("value" !== this.options.gapUnit && (o *= this.basePointRange),
                e && e > o && e >= this.basePointRange && (o = e); r--; )
                    if (a && !1 !== a.visible || (a = i[r + 1]),
                    t = i[r],
        ...
        t.compose = function(t, l) {
            if (!t.keepProps.includes("brokenAxis")) {
                ...
                uu(t, "init", o),
                uu(t, "afterInit", e),
                uu(t, "afterSetTickPositions", s),
                uu(t, "afterSetOptions", i);
                let d = l.prototype;
                d.drawBreaks = n,
                d.gappedPath = h,
                uu(l, "afterGeneratePoints", r),
                uu(l, "afterRender", a)
            }
            return t
        }
        ...
        class l {
                ...
                if (t > e)
                    for (let t of s)
                        if (t.from > o)
                            ...
                            t.to <= o && t.to > e ? o += t.len : l.isInBreak(t, o) && (o += t.len);
                else if (t < e)
                    for (let t of s)
                        if (t.from > e)
                            break;
                        else
                            t.from >= o && t.from < e ? o -= t.len : l.isInBreak(t, o) && (o -= t.len);
                return o
            }
            static val2Lin(t) {
                let e = this.min || 0
            ...
            isInAnyBreak(t, e) {
                ...
                if (o && ux(t)) {
                    for (; o--; )
                        l.isInBreak(s[o], t) && (r = !0,
                        a || (a = uy(s[o].showPoints, !i.isXAxis)));
                    n = r && e ? r && !a : r
                }
                return n
            }
            setBreaks(t, e) {
                let i = this
                  , s = i.axis
                  , o = s.chart.time
                  , r = um(t) && !!Object.keys(t?.[0] || {}).length;
                s.isDirty = (i.hasBreaks ?? !1) !== r,
                i.hasBreaks = r,
                t?.forEach(t => {
                    t.from = o.parse(t.from) || 0,
                    t.to = o.parse(t.to) || 0
                }
                ),
                ...
                r || s.val2lin !== l.val2Lin || (delete s.val2lin,
                delete s.lin2val),
                r && (s.userOptions.ordinal = !1,
                s.lin2val = l.lin2Val,
                s.val2lin = l.val2Lin,
                s.setExtremes = function(t, e, o, r, a) {
                    if (i.hasBreaks && !s.treeGrid?.tree) {
                        let s, o = this.brokenAxis.breakArray || [];
                        for (; s = i.findBreakAt(t, o); )
                            t = s.to;
                        for (; s = i.findBreakAt(e, o); )
                            e = s.from;
                        e < t && (e = t)
                    }
                ...
                s.setAxisTranslation = function() {
                    if (s.constructor.prototype.setAxisTranslation.call(this),
                    i.unitLength = void 0,
                    i.hasBreaks) {
                        ...
                        ux(s.threshold) && (p = Math.min(p ?? s.threshold, s.threshold),
                        u = Math.max(u ?? s.threshold, s.threshold)),
                        s.treeGrid?.tree || t.forEach(function(t) {
                            h = t.repeat || 1 / 0,
                            ux(d) && ux(c) && (l.isInBreak(t, d) && (d += t.to % h - d % h),
                            l.isInBreak(t, c) && (c -= c % h - t.from % h))
                        }),
                        ux(p) && ux(u) && t.forEach(function(t) {
                            for (g = t.from,
                            h = t.repeat || 1 / 0; g - h > p; )
                                g -= h;
                            for (; g < p; )
                                g += h;
                            for (f = g; f < u; f += h)
                        ...
                        g = p,
                        e.forEach(t => {
                            1 === (n += "in" === t.move ? 1 : -1) && "in" === t.move && (g = t.value),
                            0 === n && ux(g) && (o.push({
                                from: g,
                                to: t.value,
                        ...
                        i.breakArray = o,
                        ux(d) && ux(c) && ux(s.min) && (i.unitLength = c - d - a + r,
                        uf(s, "afterBreaks"),
                        s.staticScale ? s.transA = s.staticScale : i.unitLength && (s.transA *= (c - s.min + r) / i.unitLength),
    ...
    let ub = Y;
    V.BrokenAxis = V.BrokenAxis || ub,
    V.BrokenAxis.compose(V.Axis, V.Series);
    let uv = {}
      , {arrayMax: uk, arrayMin: uM, correctFloat: uw, extend: uS, isNumber: uA} = tx;
    function uT(t) {
        let e = t.length
          , i = uC(t);
        return uA(i) && e && (i = uw(i / e)),
        i
    }
    function uC(t) {
        let e = t.length, i;
    ...
    let uP = {
        ...
        range: function(t, e) {
            return (t = uv.low(t),
            e = uv.high(e),
            uA(t) || uA(e)) ? [t, e] : null === t && null === e ? null : void 0
        },
        sum: uC
    };
    uS(uv, uP);
    ...
    function uN() {
        ...
        for (; e--; )
            (r = t[e].options.dataGrouping) && (i = Math.max(i, uz(r.groupPixelWidth, uO.groupPixelWidth)),
    ...
    let uX = function(t) {
        o = t;
        let e = t.prototype;
        e.applyGrouping || (uB(t, "afterSetScale", uW),
        uB(t, "postProcessData", uR),
        uD(e, {
            applyGrouping: uR,
      ...
      , {series: {prototype: uH}} = r_
      , {addEvent: uF, defined: uY, error: uj, extend: uU, isNumber: uV, merge: u$, pick: u_, splat: uZ} = tx
      , uq = uH.generatePoints;
    function uK(t) {
        var e, i, s;
        ...
        if (u && (this.requireSorting = !1),
        g)
            return;
        this.destroyGroupedData();
        let f = n.groupAll ? this.dataTable : this.dataTable.getModified() || this.dataTable
        ...
        if (k && m && f.rowCount && x && uV(b.min)) {
            ...
            let t = b.min
              ...
              , h = k * (e - t) / x * i
              , d = y.getTimeTicks(ol.Additions.prototype.normalizeTimeTickInterval(h, n.units || uL), Math.min(t, m[0]), Math.max(e, m[m.length - 1]), y.options.startOfWeek, m, this.closestPointRange)
              , u = uH.groupData.apply(this, [f, d, n.approximation])
              , g = u.modified
              , M = g.getColumn("x", !0)
              , w = 0;
            for (n?.smoothed && g.rowCount && (n.firstAnchor = "firstPoint",
            n.anchor = "middle",
            ...
            o = 1; o < d.length; o++)
                d.info.segmentStarts && -1 !== d.info.segmentStarts.indexOf(o) || (w = Math.max(d[o] - d[o - 1], w));
            (c = d.info).gapSize = w,
            ...
            l && M && (uY((s = M)[0]) && uV(y.min) && uV(y.dataMin) && s[0] < y.min && ((!uY(y.options.min) && y.min <= y.dataMin || y.min === y.dataMin) && (y.min = Math.min(s[0], y.min)),
            y.dataMin = Math.min(s[0], y.dataMin)),
            uY(s[s.length - 1]) && uV(y.max) && uV(y.dataMax) && s[s.length - 1] > y.max && ((!uY(y.options.max) && uV(y.dataMax) && y.max >= y.dataMax || y.max === y.dataMax) && (y.max = Math.max(s[s.length - 1], y.max)),
            y.dataMax = Math.max(s[s.length - 1], y.dataMax))),
            n.groupAll && (this.allGroupedTable = g,
            M = (g = (p = this.cropData(g, y.min || 0, y.max || 0)).modified).getColumn("x"),
            this.cropStart = p.start),
            this.dataTable.modified = g
        } else
            this.groupMap = void 0,
            this.currentDataGrouping = void 0;
    ...
    function u1(t, e, i) {
        let s = t.getColumn("x", !0) || [], o = t.getColumn("y", !0), r = this, a = r.data, n = r.options && r.options.data, h = [], l = new rz, d = [], c = t.rowCount, p = !!o, u = [], g = r.pointArrayMap, f = g && g.length, m = ["x"].concat(g || ["y"]), x = (g || ["y"]).map( () => []), y = this.options.dataGrouping && this.options.dataGrouping.groupAll, b, v, k, M = 0, w = 0, S = "function" == typeof i ? i : i && uv[i] ? uv[i] : uv[r.getDGApproximation && r.getDGApproximation() || "average"];
        if (f) {
            let t = g.length;
            for (; t--; )
                u.push([])
        ...
        for (let t = 0; t <= c; t++)
            if (!(s[t] < e[0])) {
                for (; void 0 !== e[M + 1] && s[t] >= e[M + 1] || t === c; ) {
                    ...
                    k = S.apply(r, u),
                    r.pointClass && !uY(r.dataGroupInfo.options) && (r.dataGroupInfo.options = u$(r.pointClass.prototype.optionsToObject.call({
                        series: r
                    }, r.options.data[r.cropStart + w])),
                ...
                if (g) {
                    ...
                    for (let t = 0; t < f; t++)
                        uV(e = s[g[t]]) ? u[t].push(e) : null === e && (u[t].hasNulls = !0)
                } else
                    uV(v = p ? o[t] : null) ? u[0].push(v) : null === v && (u[0].hasNulls = !0)
            }
        let T = {
            x: h
        };
    ...
    function u2(t) {
        let e = t.options
          ...
          , o = this.useCommonDataGrouping && uO
          , r = tY.defaultOptions.plotOptions[i].dataGrouping;
        if (s && (uE[i] || o)) {
            let t = this.chart.rangeSelector;
            r || (r = u$(uO, uE[i])),
            e.dataGrouping = u$(o, r, s.series && s.series.dataGrouping, s[i].dataGrouping, this.userOptions.dataGrouping, !e.isInternal && t && uV(t.selected) && t.buttonOptions[t.selected].dataGrouping)
        }
    }
    let u3 = function(t) {
        let e = t.prototype;
        e.applyGrouping || (uF(t.prototype.pointClass, "update", function() {
            if (this.dataGroup)
                return uj(24, !1, this.series.chart),
                !1
        }),
        uF(t, "afterSetOptions", u2),
        uF(t, "destroy", uJ),
        uU(e, {
            applyGrouping: uK,
      ...
      , {format: u5} = eI
      , {composed: u6} = V
      , {addEvent: u9, extend: u4, isNumber: u8, pick: u7, pushUnique: gt} = tx;
    function ge(t) {
        ...
        if (h && "datetime" === h.options.type && n && u8(s.key)) {
            ...
            p = n.dateTimeLabelFormats || uO.dateTimeLabelFormats,
            c ? (u = p[c.unitName],
            1 === c.count ? l = u[0] : (l = u[1],
            d = u[2])) : !l && p && h.dateTime && (l = h.dateTime.getXDateFormat(s.x, a.dateTimeLabelFormats));
            let r = u7(o.groupMap?.[s.index].groupStart, s.key)
              , m = r + (c?.totalRange || 0) - 1;
            g = i.dateFormat(l, r),
            d && (g += i.dateFormat(d, m)),
            o.chart.styledMode && (f = this.styledModeFormat(f)),
            t.text = u5(f, {
                point: u4(s, {
                    key: g
                }),
    ...
    V.dataGrouping = V.dataGrouping || {},
    V.dataGrouping.approximationDefaults = V.dataGrouping.approximationDefaults || uP,
    V.dataGrouping.approximations = V.dataGrouping.approximations || uv,
    ({
        compose: function(t, e, i) {
            uX(t),
            u3(e),
            i && gt(u6, "DataGrouping") && u9(i, "headerFormatter", ge)
        },
        groupData: u1
    }).compose(V.Axis, V.Series, V.Tooltip);
    let {defined: gi, isNumber: gs, pick: go} = tx
      , gr = {
      ...
      , {addEvent: ga, isObject: gn, pick: gh, defined: gl, merge: gd} = tx
      , {getAssignedAxis: gc} = {
      ...
      , gg = function(t, e, i, s, o, a, n) {
        let h = gh(n.type, t.zooming.type, "")
          , l = [];
        ...
        e.enabled && ga(this.container, "wheel", t => {
            ...
            if (this.isInsidePlot(t.chartX - this.plotLeft, t.chartY - this.plotTop) && s) {
                let s = e.sensitivity || 1.1
                  ...
                  , r = gc(i.getCoordinates(t).xAxis)
                  , a = gc(i.getCoordinates(t).yAxis);
                gg(this, Math.pow(s, o), r ? [r.axis] : this.xAxis, a ? [a.axis] : this.yAxis, t.chartX, t.chartY, e) && t.preventDefault?.()
            }
        }
        )
    }
    V.MouseWheelZoom = V.MouseWheelZoom || {
        compose: function(t) {
            -1 === gp.indexOf(t) && (gp.push(t),
            ga(t, "afterGetContainer", gf))
        }
    },
    V.MouseWheelZoom.compose(V.Chart),
    V.Navigator = V.Navigator || cw,
    V.OrdinalAxis = V.OrdinalAxis || cD,
    V.RangeSelector = V.RangeSelector || ph,
    V.Scrollbar = V.Scrollbar || cs,
    V.stockChart = V.stockChart || pT.stockChart,
    V.StockChart = V.StockChart || V.stockChart,
    V.extend(V.StockChart, pT),
    dn.compose(V.Series, V.Axis, V.Point),
    up.compose(V.Renderer),
    pU.compose(V.Series),
    V.Navigator.compose(V.Chart, V.Axis, V.Series),
    V.OrdinalAxis.compose(V.Axis, V.Series, V.Chart),
    V.RangeSelector.compose(V.Axis, V.Chart),
    V.Scrollbar.compose(V.Axis),
    V.StockChart.compose(V.Chart, V.Axis, V.Series, V.SVGRenderer),
    V.product = "Highstock";
    let gm = V;
    return U.default
}
